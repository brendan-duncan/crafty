var F=Object.defineProperty;var C=(p,u,s)=>u in p?F(p,u,{enumerable:!0,configurable:!0,writable:!0,value:s}):p[u]=s;var a=(p,u,s)=>C(p,typeof u!="symbol"?u+"":u,s);import{a as H}from"./mesh-DyFEfNnf.js";const O=`// Deferred PBR lighting pass — fullscreen triangle, reads GBuffer + shadow maps + IBL.
...
`,w="rgba16float",E=64*4+16+16,N=368;class P extends H{constructor(s,n,e,o,i,d,c,f,t,h,l,r,m,b,v,_,x,g){super();a(this,"name","DeferredLightingPass");a(this,"outputTexture");a(this,"outputView");a(this,"cameraBuffer");a(this,"lightBuffer");a(this,"_pipeline");a(this,"_sceneBindGroup");a(this,"_gbufferBindGroup");a(this,"_aoBindGroup");a(this,"_iblBindGroup");a(this,"_defaultCloudShadow");a(this,"_defaultSsgi");a(this,"_defaultIblCube");a(this,"_defaultBrdfLut");a(this,"_device");a(this,"_aoBGL");a(this,"_aoView");a(this,"_aoSampler");a(this,"_ssgiSampler");a(this,"_cameraScratch",new Float32Array(E/4));a(this,"_lightScratch",new Float32Array(N/4));a(this,"_lightScratchU",new Uint32Array(this._lightScratch.buffer));a(this,"_cloudShadowScratch",new Float32Array(3));this.outputTexture=s,this.outputView=n,this._pipeline=e,this._sceneBindGroup=o,this._gbufferBindGroup=i,this._aoBindGroup=d,this._iblBindGroup=c,this.cameraBuffer=f,this.lightBuffer=t,this._defaultCloudShadow=h,this._defaultSsgi=l,this._defaultIblCube=r,this._defaultBrdfLut=m,this._device=b,this._aoBGL=v,this._aoView=_,this._aoSampler=x,this._ssgiSampler=g}static create(s,n){var L,B,R;const{device:e,width:o,height:i}=s;let d=null,c;n.outputView?c=n.outputView:(d=e.createTexture({label:"HDR Texture",size:{width:o,height:i},format:w,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),c=d.createView());const f=e.createBuffer({label:"LightCameraBuffer",size:E,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),t=e.createBuffer({label:"LightBuffer",size:N,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),h=e.createSampler({label:"ShadowSampler",compare:"less-equal",magFilter:"linear",minFilter:"linear"}),l=e.createSampler({label:"GBufferLinearSampler",magFilter:"linear",minFilter:"linear"}),r=e.createSampler({label:"AoSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),m=e.createSampler({label:"SsgiSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),b=e.createBindGroupLayout({label:"LightSceneBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),v=e.createBindGroupLayout({label:"LightGBufferBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth",viewDimension:"2d-array"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"comparison"}},{binding:5,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:6,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}}]}),_=e.createTexture({label:"DefaultCloudShadow",size:{width:1,height:1},format:"r8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});e.queue.writeTexture({texture:_},new Uint8Array([255]),{bytesPerRow:1},{width:1,height:1});const x=n.cloudShadowView??_.createView(),g=e.createBindGroupLayout({label:"LightAoBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),y=e.createTexture({label:"DefaultSsgi",size:{width:1,height:1},format:w,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),S=e.createBindGroupLayout({label:"LightIblBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),U=e.createSampler({label:"IblSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge"}),T=e.createTexture({label:"DefaultIblCube",size:{width:1,height:1,depthOrArrayLayers:6},format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),M=T.createView({dimension:"cube"}),G=e.createTexture({label:"DefaultBrdfLut",size:{width:1,height:1},format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),z=e.createBindGroup({label:"LightIblBG",layout:S,entries:[{binding:0,resource:((L=n.iblTextures)==null?void 0:L.irradianceView)??M},{binding:1,resource:((B=n.iblTextures)==null?void 0:B.prefilteredView)??M},{binding:2,resource:((R=n.iblTextures)==null?void 0:R.brdfLutView)??G.createView()},{binding:3,resource:U}]}),I=e.createBindGroup({layout:b,entries:[{binding:0,resource:{buffer:f}},{binding:1,resource:{buffer:t}}]}),V=e.createBindGroup({layout:v,entries:[{binding:0,resource:n.gbuffer.albedoRoughnessView},{binding:1,resource:n.gbuffer.normalMetallicView},{binding:2,resource:n.gbuffer.depthView},{binding:3,resource:n.shadowPass.shadowMapView},{binding:4,resource:h},{binding:5,resource:l},{binding:6,resource:x??_}]}),k=e.createBindGroup({label:"LightAoBG",layout:g,entries:[{binding:0,resource:n.aoView},{binding:1,resource:r},{binding:2,resource:y.createView()},{binding:3,resource:m}]}),A=e.createShaderModule({label:"LightingShader",code:O}),D=e.createRenderPipeline({label:"LightingPipeline",layout:e.createPipelineLayout({bindGroupLayouts:[b,v,g,S]}),vertex:{module:A,entryPoint:"vs_main"},fragment:{module:A,entryPoint:"fs_main",targets:[{format:w}]},primitive:{topology:"triangle-list"}});return new P(d,c,D,I,V,k,z,f,t,x?null:_,y,n.iblTextures?null:T,n.iblTextures?null:G,e,g,n.aoView,r,m)}updateSSGI(s){this._aoBindGroup=this._device.createBindGroup({label:"LightAoBG",layout:this._aoBGL,entries:[{binding:0,resource:this._aoView},{binding:1,resource:this._aoSampler},{binding:2,resource:s},{binding:3,resource:this._ssgiSampler}]})}updateCamera(s,n,e,o,i,d,c,f){const t=this._cameraScratch;t.set(n.data,0),t.set(e.data,16),t.set(o.data,32),t.set(i.data,48),t[64]=d.x,t[65]=d.y,t[66]=d.z,t[67]=c,t[68]=f,s.queue.writeBuffer(this.cameraBuffer,0,t.buffer)}updateLight(s,n,e,o,i,d=!0,c=!1,f=.02){const t=this._lightScratch,h=this._lightScratchU;let l=0;t[l++]=n.x,t[l++]=n.y,t[l++]=n.z,t[l++]=o,t[l++]=e.x,t[l++]=e.y,t[l++]=e.z,h[l++]=i.length;for(let r=0;r<4;r++)r<i.length&&t.set(i[r].lightViewProj.data,l),l+=16;for(let r=0;r<4;r++)t[l++]=r<i.length?i[r].splitFar:1e9;h[l]=d?1:0,h[l+1]=c?1:0,t[81]=f;for(let r=0;r<4;r++)t[84+r]=r<i.length?i[r].depthRange:1;for(let r=0;r<4;r++)t[88+r]=r<i.length?i[r].texelWorldSize:1;s.queue.writeBuffer(this.lightBuffer,0,t.buffer)}updateCloudShadow(s,n,e,o){const i=this._cloudShadowScratch;i[0]=n,i[1]=e,i[2]=o,s.queue.writeBuffer(this.lightBuffer,312,i.buffer)}execute(s,n){const e=s.beginRenderPass({label:"DeferredLightingPass",colorAttachments:[{view:this.outputView,loadOp:"load",storeOp:"store"}]});e.setPipeline(this._pipeline),e.setBindGroup(0,this._sceneBindGroup),e.setBindGroup(1,this._gbufferBindGroup),e.setBindGroup(2,this._aoBindGroup),e.setBindGroup(3,this._iblBindGroup),e.draw(3),e.end()}destroy(){var s,n,e,o,i;(s=this.outputTexture)==null||s.destroy(),this.cameraBuffer.destroy(),this.lightBuffer.destroy(),(n=this._defaultCloudShadow)==null||n.destroy(),(e=this._defaultSsgi)==null||e.destroy(),(o=this._defaultIblCube)==null||o.destroy(),(i=this._defaultBrdfLut)==null||i.destroy()}}export{P as D,w as H};
