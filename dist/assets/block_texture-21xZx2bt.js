var De=Object.defineProperty;var ze=(f,c,r)=>c in f?De(f,c,{enumerable:!0,configurable:!0,writable:!0,value:r}):f[c]=r;var t=(f,c,r)=>ze(f,typeof c!="symbol"?c+"":c,r);import{c as U,M as ie,V as He,a as qe}from"./mesh-IAKLP_IY.js";import{a as ye}from"./camera-xUoxN29j.js";import{R as q}from"./render_pass-BouxMEb8.js";import{H as T}from"./deferred_lighting_pass-DzAeDZen.js";import{t as ke,s as je,a as We}from"./ssao_blur-R4q1jzyk.js";import{d as $e}from"./dof-CuVb6Jys.js";import{T as K}from"./hdr_loader-BebuUkhF.js";const Ot=""+new URL("simple_block_atlas-B-7juoTN.png",import.meta.url).href,It=""+new URL("simple_block_atlas_normal-BdCvGD-K.png",import.meta.url).href,Ft=""+new URL("simple_block_atlas_mer-C_Oa_Ink.png",import.meta.url).href,Ct=""+new URL("simple_block_atlas_heightmap-BOV6qQJl.png",import.meta.url).href,Xe=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],Ye=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)];class Dt extends ye{constructor(){super(...arguments);t(this,"color",U.one());t(this,"intensity",1);t(this,"radius",10);t(this,"castShadow",!1)}worldPosition(){return this.gameObject.localToWorld().transformPoint(U.ZERO)}cubeFaceViewProjs(r=.05){const n=this.worldPosition(),e=ie.perspective(Math.PI/2,1,r,this.radius),a=new Array(6);for(let i=0;i<6;i++)a[i]=e.multiply(ie.lookAt(n,n.add(Xe[i]),Ye[i]));return a}}class zt extends ye{constructor(){super(...arguments);t(this,"color",U.one());t(this,"intensity",1);t(this,"range",20);t(this,"innerAngle",15);t(this,"outerAngle",30);t(this,"castShadow",!1);t(this,"projectionTexture",null)}worldPosition(){return this.gameObject.localToWorld().transformPoint(U.ZERO)}worldDirection(){return this.gameObject.localToWorld().transformDirection(U.FORWARD).normalize()}lightViewProj(r=.1){const n=this.worldPosition(),e=this.worldDirection(),a=Math.abs(e.y)>.99?U.RIGHT:U.UP,i=ie.lookAt(n,n.add(e),a);return ie.perspective(this.outerAngle*2*Math.PI/180,1,r,this.range).multiply(i)}}const ue=128;class we extends q{constructor(r,n,e,a,i,o,u,s,d,m){super();t(this,"name","TAAPass");t(this,"_resolved");t(this,"resolvedView");t(this,"_history");t(this,"_historyView");t(this,"_pipeline");t(this,"_uniformBuffer");t(this,"_uniformBG");t(this,"_textureBG");t(this,"_width");t(this,"_height");t(this,"_scratch",new Float32Array(ue/4));this._resolved=r,this.resolvedView=n,this._history=e,this._historyView=a,this._pipeline=i,this._uniformBuffer=o,this._uniformBG=u,this._textureBG=s,this._width=d,this._height=m}get historyView(){return this._historyView}static create(r,n,e){const{device:a,width:i,height:o}=r,u=a.createTexture({label:"TAA Resolved",size:{width:i,height:o},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),s=a.createTexture({label:"TAA History",size:{width:i,height:o},format:T,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),d=u.createView(),m=s.createView(),l=a.createBuffer({label:"TAAUniformBuffer",size:ue,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),p=a.createBindGroupLayout({label:"TAAUniformBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),g=a.createBindGroupLayout({label:"TAATextureBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),h=a.createSampler({label:"TAALinearSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),v=a.createBindGroup({layout:p,entries:[{binding:0,resource:{buffer:l}}]}),_=a.createBindGroup({layout:g,entries:[{binding:0,resource:n.outputView},{binding:1,resource:m},{binding:2,resource:e.depthView},{binding:3,resource:h}]}),y=r.createShaderModule(ke,"TAAShader"),b=a.createRenderPipeline({label:"TAAPipeline",layout:a.createPipelineLayout({bindGroupLayouts:[p,g]}),vertex:{module:y,entryPoint:"vs_main"},fragment:{module:y,entryPoint:"fs_main",targets:[{format:T}]},primitive:{topology:"triangle-list"}});return new we(u,d,s,m,b,l,v,_,i,o)}updateCamera(r,n,e){const a=this._scratch;a.set(n.data,0),a.set(e.data,16),r.queue.writeBuffer(this._uniformBuffer,0,a.buffer)}execute(r,n){const e=r.beginRenderPass({label:"TAAPass",colorAttachments:[{view:this.resolvedView,clearValue:[0,0,0,1],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._pipeline),e.setBindGroup(0,this._uniformBG),e.setBindGroup(1,this._textureBG),e.draw(3),e.end(),r.copyTextureToTexture({texture:this._resolved},{texture:this._history},{width:this._width,height:this._height})}destroy(){this._resolved.destroy(),this._history.destroy(),this._uniformBuffer.destroy()}}const Ze=`// Bloom: prefilter (downsample + threshold) and separable Gaussian blur.
...
`,Je=16;class Pe extends q{constructor(r,n,e,a,i,o,u,s,d,m,l,p,g,h,v){super();t(this,"name","BloomPass");t(this,"resultView");t(this,"_result");t(this,"_half1");t(this,"_half2");t(this,"_half1View");t(this,"_half2View");t(this,"_prefilterPipeline");t(this,"_blurHPipeline");t(this,"_blurVPipeline");t(this,"_compositePipeline");t(this,"_uniformBuffer");t(this,"_scratch",new Float32Array(4));t(this,"_prefilterBG");t(this,"_blurHBG");t(this,"_blurVBG");t(this,"_compositeBG");this._result=r,this.resultView=n,this._half1=e,this._half1View=a,this._half2=i,this._half2View=o,this._prefilterPipeline=u,this._blurHPipeline=s,this._blurVPipeline=d,this._compositePipeline=m,this._uniformBuffer=l,this._prefilterBG=p,this._blurHBG=g,this._blurVBG=h,this._compositeBG=v}static create(r,n){const{device:e,width:a,height:i}=r,o=Math.max(1,a>>1),u=Math.max(1,i>>1),s=e.createTexture({label:"BloomHalf1",size:{width:o,height:u},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),d=e.createTexture({label:"BloomHalf2",size:{width:o,height:u},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),m=e.createTexture({label:"BloomResult",size:{width:a,height:i},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),l=s.createView(),p=d.createView(),g=m.createView(),h=e.createBuffer({label:"BloomUniforms",size:Je,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(h,0,new Float32Array([1,.5,.3,0]).buffer);const v=e.createSampler({label:"BloomSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),_=e.createBindGroupLayout({label:"BloomSingleBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),y=e.createBindGroupLayout({label:"BloomCompositeBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),b=e.createShaderModule({label:"BloomShader",code:Ze}),P=e.createShaderModule({label:"BloomComposite",code:Ke}),B=e.createPipelineLayout({bindGroupLayouts:[_]}),G=e.createPipelineLayout({bindGroupLayouts:[y]});function x(F,z){return e.createRenderPipeline({label:z,layout:B,vertex:{module:b,entryPoint:"vs_main"},fragment:{module:b,entryPoint:F,targets:[{format:T}]},primitive:{topology:"triangle-list"}})}const S=x("fs_prefilter","BloomPrefilterPipeline"),V=x("fs_blur_h","BloomBlurHPipeline"),M=x("fs_blur_v","BloomBlurVPipeline"),E=e.createRenderPipeline({label:"BloomCompositePipeline",layout:G,vertex:{module:P,entryPoint:"vs_main"},fragment:{module:P,entryPoint:"fs_main",targets:[{format:T}]},primitive:{topology:"triangle-list"}});function L(F){return e.createBindGroup({layout:_,entries:[{binding:0,resource:{buffer:h}},{binding:1,resource:F},{binding:2,resource:v}]})}const N=L(n),C=L(l),O=L(p),I=e.createBindGroup({layout:y,entries:[{binding:0,resource:{buffer:h}},{binding:1,resource:n},{binding:2,resource:l},{binding:3,resource:v}]});return new Pe(m,g,s,l,d,p,S,V,M,E,h,N,C,O,I)}updateParams(r,n=1,e=.5,a=.3){this._scratch[0]=n,this._scratch[1]=e,this._scratch[2]=a,this._scratch[3]=0,r.queue.writeBuffer(this._uniformBuffer,0,this._scratch.buffer)}execute(r,n){const e=(a,i,o,u)=>{const s=r.beginRenderPass({label:a,colorAttachments:[{view:i,clearValue:[0,0,0,1],loadOp:"clear",storeOp:"store"}]});s.setPipeline(o),s.setBindGroup(0,u),s.draw(3),s.end()};e("BloomPrefilter",this._half1View,this._prefilterPipeline,this._prefilterBG);for(let a=0;a<2;a++)e("BloomBlurH",this._half2View,this._blurHPipeline,this._blurHBG),e("BloomBlurV",this._half1View,this._blurVPipeline,this._blurVBG);e("BloomComposite",this.resultView,this._compositePipeline,this._compositeBG)}destroy(){this._result.destroy(),this._half1.destroy(),this._half2.destroy(),this._uniformBuffer.destroy()}}const Qe=32;class Be extends q{constructor(r,n,e,a,i,o,u,s,d,m){super();t(this,"name","DofPass");t(this,"resultView");t(this,"_result");t(this,"_half");t(this,"_halfView");t(this,"_prefilterPipeline");t(this,"_compositePipeline");t(this,"_uniformBuffer");t(this,"_scratch",new Float32Array(8));t(this,"_prefilterBG");t(this,"_compBG0");t(this,"_compBG1");this._result=r,this.resultView=n,this._half=e,this._halfView=a,this._prefilterPipeline=i,this._compositePipeline=o,this._uniformBuffer=u,this._prefilterBG=s,this._compBG0=d,this._compBG1=m}static create(r,n,e){const{device:a,width:i,height:o}=r,u=Math.max(1,i>>1),s=Math.max(1,o>>1),d=a.createTexture({label:"DofHalf",size:{width:u,height:s},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),m=a.createTexture({label:"DofResult",size:{width:i,height:o},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),l=d.createView(),p=m.createView(),g=a.createBuffer({label:"DofUniforms",size:Qe,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});a.queue.writeBuffer(g,0,new Float32Array([30,60,6,.1,1e3,0,0,0]).buffer);const h=a.createSampler({label:"DofSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),v=a.createBindGroupLayout({label:"DofBGL0Prefilter",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),_=a.createBindGroupLayout({label:"DofBGL0Composite",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),y=a.createBindGroupLayout({label:"DofBGL1",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}}]}),b=a.createShaderModule({label:"DofShader",code:$e}),P=a.createRenderPipeline({label:"DofPrefilterPipeline",layout:a.createPipelineLayout({bindGroupLayouts:[v]}),vertex:{module:b,entryPoint:"vs_main"},fragment:{module:b,entryPoint:"fs_prefilter",targets:[{format:T}]},primitive:{topology:"triangle-list"}}),B=a.createRenderPipeline({label:"DofCompositePipeline",layout:a.createPipelineLayout({bindGroupLayouts:[_,y]}),vertex:{module:b,entryPoint:"vs_main"},fragment:{module:b,entryPoint:"fs_composite",targets:[{format:T}]},primitive:{topology:"triangle-list"}}),G=a.createBindGroup({label:"DofPrefilterBG",layout:v,entries:[{binding:0,resource:{buffer:g}},{binding:1,resource:n},{binding:2,resource:e},{binding:3,resource:h}]}),x=a.createBindGroup({label:"DofCompBG0",layout:_,entries:[{binding:0,resource:{buffer:g}},{binding:1,resource:n},{binding:3,resource:h}]}),S=a.createBindGroup({label:"DofCompBG1",layout:y,entries:[{binding:0,resource:l}]});return new Be(m,p,d,l,P,B,g,G,x,S)}updateParams(r,n=30,e=60,a=6,i=.1,o=1e3,u=1){this._scratch[0]=n,this._scratch[1]=e,this._scratch[2]=a,this._scratch[3]=i,this._scratch[4]=o,this._scratch[5]=u,this._scratch[6]=0,this._scratch[7]=0,r.device.queue.writeBuffer(this._uniformBuffer,0,this._scratch.buffer)}execute(r,n){{const e=r.beginRenderPass({label:"DofPrefilter",colorAttachments:[{view:this._halfView,clearValue:[0,0,0,0],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._prefilterPipeline),e.setBindGroup(0,this._prefilterBG),e.draw(3),e.end()}{const e=r.beginRenderPass({label:"DofComposite",colorAttachments:[{view:this.resultView,clearValue:[0,0,0,1],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._compositePipeline),e.setBindGroup(0,this._compBG0),e.setBindGroup(1,this._compBG1),e.draw(3),e.end()}}destroy(){this._result.destroy(),this._half.destroy(),this._uniformBuffer.destroy()}}const J="r8unorm",se=16,et=464;function tt(){const f=new Float32Array(se*4);for(let c=0;c<se;c++){const r=Math.random(),n=Math.random()*Math.PI*2,e=Math.sqrt(1-r*r),a=.1+.9*(c/se)**2;f[c*4+0]=e*Math.cos(n)*a,f[c*4+1]=e*Math.sin(n)*a,f[c*4+2]=r*a,f[c*4+3]=0}return f}function rt(){const f=new Uint8Array(64);for(let c=0;c<16;c++){const r=Math.random()*Math.PI*2;f[c*4+0]=Math.round((Math.cos(r)*.5+.5)*255),f[c*4+1]=Math.round((Math.sin(r)*.5+.5)*255),f[c*4+2]=128,f[c*4+3]=255}return f}class Ge extends q{constructor(r,n,e,a,i,o,u,s,d,m,l){super();t(this,"name","SSAOPass");t(this,"aoView");t(this,"_raw");t(this,"_blurred");t(this,"_rawView");t(this,"_ssaoPipeline");t(this,"_blurPipeline");t(this,"_uniformBuffer");t(this,"_noiseTex");t(this,"_cameraScratch",new Float32Array(48));t(this,"_paramsScratch",new Float32Array(4));t(this,"_ssaoBG0");t(this,"_ssaoBG1");t(this,"_blurBG");this._raw=r,this._rawView=n,this._blurred=e,this.aoView=a,this._ssaoPipeline=i,this._blurPipeline=o,this._uniformBuffer=u,this._noiseTex=s,this._ssaoBG0=d,this._ssaoBG1=m,this._blurBG=l}static create(r,n){const{device:e,width:a,height:i}=r,o=Math.max(1,a>>1),u=Math.max(1,i>>1),s=e.createTexture({label:"SsaoRaw",size:{width:o,height:u},format:J,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),d=e.createTexture({label:"SsaoBlurred",size:{width:o,height:u},format:J,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),m=s.createView(),l=d.createView(),p=e.createTexture({label:"SsaoNoise",size:{width:4,height:4},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});e.queue.writeTexture({texture:p},rt().buffer,{bytesPerRow:4*4,rowsPerImage:4},{width:4,height:4});const g=p.createView(),h=e.createBuffer({label:"SsaoUniforms",size:et,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(h,208,tt().buffer),e.queue.writeBuffer(h,192,new Float32Array([1,.005,2,0]).buffer);const v=e.createSampler({label:"SsaoBlurSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),_=e.createBindGroupLayout({label:"SsaoBGL0",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),y=e.createBindGroupLayout({label:"SsaoBGL1",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}}]}),b=e.createBindGroupLayout({label:"SsaoBlurBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),P=r.createShaderModule(je,"SsaoShader"),B=r.createShaderModule(We,"SsaoBlurShader"),G=e.createRenderPipeline({label:"SsaoPipeline",layout:e.createPipelineLayout({bindGroupLayouts:[_,y]}),vertex:{module:P,entryPoint:"vs_main"},fragment:{module:P,entryPoint:"fs_ssao",targets:[{format:J}]},primitive:{topology:"triangle-list"}}),x=e.createRenderPipeline({label:"SsaoBlurPipeline",layout:e.createPipelineLayout({bindGroupLayouts:[b]}),vertex:{module:B,entryPoint:"vs_main"},fragment:{module:B,entryPoint:"fs_blur",targets:[{format:J}]},primitive:{topology:"triangle-list"}}),S=e.createBindGroup({label:"SsaoBG0",layout:_,entries:[{binding:0,resource:{buffer:h}}]}),V=e.createBindGroup({label:"SsaoBG1",layout:y,entries:[{binding:0,resource:n.normalMetallicView},{binding:1,resource:n.depthView},{binding:2,resource:g}]}),M=e.createBindGroup({label:"SsaoBlurBG",layout:b,entries:[{binding:0,resource:m},{binding:1,resource:v}]});return new Ge(s,m,d,l,G,x,h,p,S,V,M)}updateCamera(r,n,e,a){const i=this._cameraScratch;i.set(n.data,0),i.set(e.data,16),i.set(a.data,32),r.device.queue.writeBuffer(this._uniformBuffer,0,i.buffer)}updateParams(r,n=1,e=.005,a=2){this._paramsScratch[0]=n,this._paramsScratch[1]=e,this._paramsScratch[2]=a,this._paramsScratch[3]=0,r.device.queue.writeBuffer(this._uniformBuffer,192,this._paramsScratch.buffer)}execute(r,n){{const e=r.beginRenderPass({label:"SSAOPass",colorAttachments:[{view:this._rawView,clearValue:[1,0,0,1],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._ssaoPipeline),e.setBindGroup(0,this._ssaoBG0),e.setBindGroup(1,this._ssaoBG1),e.draw(3),e.end()}{const e=r.beginRenderPass({label:"SSAOBlur",colorAttachments:[{view:this.aoView,clearValue:[1,0,0,1],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._blurPipeline),e.setBindGroup(0,this._blurBG),e.draw(3),e.end()}}destroy(){this._raw.destroy(),this._blurred.destroy(),this._uniformBuffer.destroy(),this._noiseTex.destroy()}}const it=`// Screen-Space Global Illumination — ray march pass.
...
`;function ft(f){switch(f.kind){case"sphere":{const c=Math.cos(f.solidAngle).toFixed(6),r=f.radius.toFixed(6);return`{
  ...
  p.velocity = up * speed;
}`}}}function Me(f){switch(f.type){case"gravity":return`p.velocity.y -= ${f.strength.toFixed(6)} * uniforms.dt;`;case"drag":return`p.velocity -= p.velocity * ${f.coefficient.toFixed(6)} * uniforms.dt;`;case"force":{const[c,r,n]=f.direction.map(e=>e.toFixed(6));return`p.velocity += vec3<f32>(${c}, ${r}, ${n}) * ${f.strength.toFixed(6)} * uniforms.dt;`}case"swirl_force":{const c=f.speed.toFixed(6),r=f.strength.toFixed(6);return`{
...
}`}}function Ee(f,c){return f?f.filter(r=>r.trigger===c).flatMap(r=>r.actions.map(Me)).join(`
...
`;function gt(f){const c=f.modifiers.some(e=>e.type==="block_collision"),r=f.modifiers.map(Me).join(`
...
`,me=64,_e=80,yt=16,wt=16,ge=288,be=16,oe=128;class Ve extends q{constructor(r,n,e,a,i,o,u,s,d,m,l,p,g,h,v,_,y,b,P,B,G,x,S,V,M,E,L){super();t(this,"name","ParticlePass");t(this,"_gbuffer");t(this,"_hdrView");t(this,"_isForward");t(this,"_maxParticles");t(this,"_config");t(this,"_particleBuffer");t(this,"_aliveList");t(this,"_counterBuffer");t(this,"_indirectBuffer");t(this,"_computeUniforms");t(this,"_renderUniforms");t(this,"_cameraBuffer");t(this,"_spawnPipeline");t(this,"_updatePipeline");t(this,"_compactPipeline");t(this,"_indirectPipeline");t(this,"_renderPipeline");t(this,"_computeDataBG");t(this,"_computeUniBG");t(this,"_compactDataBG");t(this,"_compactUniBG");t(this,"_renderDataBG");t(this,"_cameraRenderBG");t(this,"_renderParamsBG");t(this,"_heightmapDataBuf");t(this,"_heightmapUniBuf");t(this,"_heightmapBG");t(this,"_spawnAccum",0);t(this,"_spawnOffset",0);t(this,"_spawnCount",0);t(this,"_pendingBurst",null);t(this,"_time",0);t(this,"_frameSeed",0);t(this,"_cuBuf",new Float32Array(_e/4));t(this,"_cuiView",new Uint32Array(this._cuBuf.buffer));t(this,"_camBuf",new Float32Array(ge/4));t(this,"_hmUniBuf",new Float32Array(be/4));t(this,"_hmRes",new Uint32Array([oe]));t(this,"_resetArr",new Uint32Array(1));this._gbuffer=r,this._hdrView=n,this._isForward=e,this._config=a,this._maxParticles=i,this._particleBuffer=o,this._aliveList=u,this._counterBuffer=s,this._indirectBuffer=d,this._computeUniforms=m,this._renderUniforms=l,this._cameraBuffer=p,this._spawnPipeline=g,this._updatePipeline=h,this._compactPipeline=v,this._indirectPipeline=_,this._renderPipeline=y,this._computeDataBG=b,this._computeUniBG=P,this._compactDataBG=B,this._compactUniBG=G,this._renderDataBG=x,this._cameraRenderBG=S,this._renderParamsBG=V,this._heightmapDataBuf=M,this._heightmapUniBuf=E,this._heightmapBG=L}setSpawnRate(r){this._config.emitter.spawnRate=r}burst(r,n,e){if(e<=0)return;const a=Math.min(e,this._maxParticles);this._pendingBurst={px:r.x,py:r.y,pz:r.z,r:n[0],g:n[1],b:n[2],a:n[3],count:a}}static create(r,n,e,a){const{device:i}=r,o=n.renderer.type==="sprites"&&n.renderer.renderTarget==="hdr",u=n.emitter.maxParticles,s=i.createBuffer({label:"ParticleBuffer",size:u*me,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),d=new Float32Array(u*(me/4));for(let H=0;H<u;H++)d[H*16+3]=-1;i.queue.writeBuffer(s,0,d.buffer);const m=i.createBuffer({label:"ParticleAliveList",size:u*4,usage:GPUBufferUsage.STORAGE}),l=i.createBuffer({label:"ParticleCounter",size:4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),p=i.createBuffer({label:"ParticleIndirect",size:16,usage:GPUBufferUsage.INDIRECT|GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});i.queue.writeBuffer(p,0,new Uint32Array([6,0,0,0]));const g=i.createBuffer({label:"ParticleComputeUniforms",size:_e,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),h=i.createBuffer({label:"ParticleCompactUniforms",size:yt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});i.queue.writeBuffer(h,0,new Uint32Array([u,0,0,0]));const v=i.createBuffer({label:"ParticleRenderUniforms",size:wt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});i.queue.writeBuffer(v,0,new Float32Array([n.emitter.roughness,n.emitter.metallic,0,0]));const _=i.createBuffer({label:"ParticleCameraBuffer",size:ge,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),y=i.createBindGroupLayout({label:"ParticleComputeDataBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),b=i.createBindGroupLayout({label:"ParticleCompactDataBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),P=i.createBindGroupLayout({label:"ParticleComputeUniBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),B=i.createBindGroupLayout({label:"ParticleRenderDataBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}}]}),G=i.createBindGroupLayout({label:"ParticleCameraRenderBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),x=i.createBindGroupLayout({label:"ParticleRenderParamsBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),S=i.createBindGroup({label:"ParticleComputeDataBG",layout:y,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:m}},{binding:2,resource:{buffer:l}},{binding:3,resource:{buffer:p}}]}),V=i.createBindGroup({label:"ParticleCompactDataBG",layout:b,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:m}},{binding:2,resource:{buffer:l}},{binding:3,resource:{buffer:p}}]}),M=i.createBindGroup({label:"ParticleComputeUniBG",layout:P,entries:[{binding:0,resource:{buffer:g}}]}),E=i.createBindGroup({label:"ParticleCompactUniBG",layout:P,entries:[{binding:0,resource:{buffer:h}}]}),L=i.createBindGroup({label:"ParticleRenderDataBG",layout:B,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:m}}]}),N=i.createBindGroup({label:"ParticleCameraRenderBG",layout:G,entries:[{binding:0,resource:{buffer:_}}]}),C=i.createBindGroup({label:"ParticleRenderParamsBG",layout:x,entries:[{binding:0,resource:{buffer:v}}]});let O,I,F,z;mt(n)&&(O=i.createBuffer({label:"ParticleHeightmapData",size:oe*oe*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),I=i.createBuffer({label:"ParticleHeightmapUniforms",size:be,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),z=i.createBindGroupLayout({label:"ParticleHeightmapBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),F=i.createBindGroup({label:"ParticleHeightmapBG",layout:z,entries:[{binding:0,resource:{buffer:O}},{binding:1,resource:{buffer:I}}]}));const Y=i.createPipelineLayout({bindGroupLayouts:[y,P]}),Z=z?i.createPipelineLayout({bindGroupLayouts:[y,P,z]}):i.createPipelineLayout({bindGroupLayouts:[y,P]}),X=i.createPipelineLayout({bindGroupLayouts:[b,P]}),A=i.createShaderModule({label:"ParticleSpawn",code:ht(n)}),j=i.createShaderModule({label:"ParticleUpdate",code:gt(n)}),R=i.createShaderModule({label:"ParticleCompact",code:bt}),w=i.createComputePipeline({label:"ParticleSpawnPipeline",layout:Y,compute:{module:A,entryPoint:"cs_main"}}),Le=i.createComputePipeline({label:"ParticleUpdatePipeline",layout:Z,compute:{module:j,entryPoint:"cs_main"}}),Ne=i.createComputePipeline({label:"ParticleCompactPipeline",layout:X,compute:{module:R,entryPoint:"cs_compact"}}),Oe=i.createComputePipeline({label:"ParticleIndirectPipeline",layout:X,compute:{module:R,entryPoint:"cs_write_indirect"}});let ne;if(o){const H=n.renderer.type==="sprites"?n.renderer.billboard:"camera",ae=n.renderer.type==="sprites"?n.renderer.shape??"soft":"soft",Ie=H==="camera"?"vs_camera":"vs_main",Fe=H==="velocity"?"fs_main":ae==="pixel"?"fs_pixel":"fs_snow",le=r.createShaderModule(xt,"ParticleRenderForward"),Ce=i.createPipelineLayout({bindGroupLayouts:[B,G]});ne=i.createRenderPipeline({label:"ParticleForwardPipeline",layout:Ce,vertex:{module:le,entryPoint:Ie},fragment:{module:le,entryPoint:Fe,targets:[{format:T,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha",operation:"add"}}}]},depthStencil:{format:"depth32float",depthWriteEnabled:!1,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"none"}})}else{const H=r.createShaderModule(vt,"ParticleRender"),ae=i.createPipelineLayout({bindGroupLayouts:[B,G,x]});ne=i.createRenderPipeline({label:"ParticleRenderPipeline",layout:ae,vertex:{module:H,entryPoint:"vs_main"},fragment:{module:H,entryPoint:"fs_main",targets:[{format:"rgba8unorm"},{format:"rgba16float"}]},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"none"}})}return new Ve(e,a,o,n,u,s,m,l,p,g,v,_,w,Le,Ne,Oe,ne,S,M,V,E,L,N,o?void 0:C,O,I,F)}updateHeightmap(r,n,e,a,i){if(!this._heightmapDataBuf||!this._heightmapUniBuf)return;r.queue.writeBuffer(this._heightmapDataBuf,0,n.buffer);const o=this._hmUniBuf;o[0]=e,o[1]=a,o[2]=i,r.queue.writeBuffer(this._heightmapUniBuf,0,o.buffer,0,12),r.queue.writeBuffer(this._heightmapUniBuf,12,this._hmRes)}update(r,n,e,a,i,o,u,s,d){const m=r.deltaTime;this._time+=m,this._frameSeed=this._frameSeed+1&4294967295,this._spawnAccum+=this._config.emitter.spawnRate*m,this._spawnCount=Math.min(Math.floor(this._spawnAccum),this._maxParticles),this._spawnAccum-=this._spawnCount;const l=d.data;let p=l[12],g=l[13],h=l[14];const v=Math.hypot(l[0],l[1],l[2]),_=Math.hypot(l[4],l[5],l[6]),y=Math.hypot(l[8],l[9],l[10]),b=l[0]/v,P=l[1]/v,B=l[2]/v,G=l[4]/_,x=l[5]/_,S=l[6]/_,V=l[8]/y,M=l[9]/y,E=l[10]/y,L=b+x+E;let N,C,O,I;if(L>0){const w=.5/Math.sqrt(L+1);I=.25/w,N=(S-M)*w,C=(V-B)*w,O=(P-G)*w}else if(b>x&&b>E){const w=2*Math.sqrt(1+b-x-E);I=(S-M)/w,N=.25*w,C=(G+P)/w,O=(V+B)/w}else if(x>E){const w=2*Math.sqrt(1+x-b-E);I=(V-B)/w,N=(G+P)/w,C=.25*w,O=(M+S)/w}else{const w=2*Math.sqrt(1+E-b-x);I=(P-G)/w,N=(V+B)/w,C=(M+S)/w,O=.25*w}const F=this._config.emitter.initialColor;let z=F[0],Y=F[1],Z=F[2],X=F[3];if(this._pendingBurst){const w=this._pendingBurst;p=w.px,g=w.py,h=w.pz,N=0,C=0,O=0,I=1,this._spawnCount=w.count,z=w.r,Y=w.g,Z=w.b,X=w.a,this._pendingBurst=null}const A=this._cuBuf,j=this._cuiView;A[0]=p,A[1]=g,A[2]=h,j[3]=this._spawnCount,A[4]=N,A[5]=C,A[6]=O,A[7]=I,j[8]=this._spawnOffset,j[9]=this._maxParticles,j[10]=this._frameSeed,j[11]=0,A[12]=m,A[13]=this._time,A[16]=z,A[17]=Y,A[18]=Z,A[19]=X,r.queue.writeBuffer(this._computeUniforms,0,A.buffer),r.queue.writeBuffer(this._counterBuffer,0,this._resetArr),this._spawnOffset=(this._spawnOffset+this._spawnCount)%this._maxParticles;const R=this._camBuf;R.set(n.data,0),R.set(e.data,16),R.set(a.data,32),R.set(i.data,48),R[64]=o.x,R[65]=o.y,R[66]=o.z,R[67]=u,R[68]=s,r.queue.writeBuffer(this._cameraBuffer,0,R.buffer)}execute(r,n){const e=r.beginComputePass({label:"ParticleCompute"});if(this._spawnCount>0&&(e.setPipeline(this._spawnPipeline),e.setBindGroup(0,this._computeDataBG),e.setBindGroup(1,this._computeUniBG),e.dispatchWorkgroups(Math.ceil(this._spawnCount/64))),e.setPipeline(this._updatePipeline),e.setBindGroup(0,this._computeDataBG),e.setBindGroup(1,this._computeUniBG),this._heightmapBG&&e.setBindGroup(2,this._heightmapBG),e.dispatchWorkgroups(Math.ceil(this._maxParticles/64)),e.setPipeline(this._compactPipeline),e.setBindGroup(0,this._compactDataBG),e.setBindGroup(1,this._compactUniBG),e.dispatchWorkgroups(Math.ceil(this._maxParticles/64)),e.setPipeline(this._indirectPipeline),e.dispatchWorkgroups(1),e.end(),this._isForward){const a=r.beginRenderPass({label:"ParticleForwardPass",colorAttachments:[{view:this._hdrView,loadOp:"load",storeOp:"store"}],depthStencilAttachment:{view:this._gbuffer.depthView,depthReadOnly:!0}});a.setPipeline(this._renderPipeline),a.setBindGroup(0,this._renderDataBG),a.setBindGroup(1,this._cameraRenderBG),a.drawIndirect(this._indirectBuffer,0),a.end()}else{const a=r.beginRenderPass({label:"ParticleGBufferPass",colorAttachments:[{view:this._gbuffer.albedoRoughnessView,loadOp:"load",storeOp:"store"},{view:this._gbuffer.normalMetallicView,loadOp:"load",storeOp:"store"}],depthStencilAttachment:{view:this._gbuffer.depthView,depthLoadOp:"load",depthStoreOp:"store"}});a.setPipeline(this._renderPipeline),a.setBindGroup(0,this._renderDataBG),a.setBindGroup(1,this._cameraRenderBG),a.setBindGroup(2,this._renderParamsBG),a.drawIndirect(this._indirectBuffer,0),a.end()}}destroy(){var r,n;this._particleBuffer.destroy(),this._aliveList.destroy(),this._counterBuffer.destroy(),this._indirectBuffer.destroy(),this._computeUniforms.destroy(),this._renderUniforms.destroy(),this._cameraBuffer.destroy(),(r=this._heightmapDataBuf)==null||r.destroy(),(n=this._heightmapUniBuf)==null||n.destroy()}}const Pt=`// Auto-exposure — two-pass histogram approach.
//
