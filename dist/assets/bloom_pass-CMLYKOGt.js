var ve=Object.defineProperty;var xe=(n,i,t)=>i in n?ve(n,i,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[i]=t;var s=(n,i,t)=>xe(n,typeof i!="symbol"?i+"":i,t);import{a as H}from"./dof_pass-C8Ll8rwi.js";import{P as K}from"./pass-CMGsmZgn.js";import{H as F}from"./deferred_lighting_pass-Do7ylKDD.js";import{a as J,b as be,c as ye}from"./geometry_pass-B7ItFcmn.js";const et=""+new URL("simple_block_atlas-B-7juoTN.png",import.meta.url).href,tt=""+new URL("simple_block_atlas_normal-BdCvGD-K.png",import.meta.url).href,rt=""+new URL("simple_block_atlas_mer-C_Oa_Ink.png",import.meta.url).href,nt=""+new URL("simple_block_atlas_heightmap-BOV6qQJl.png",import.meta.url).href,Pe=`// Bloom: prefilter (downsample + threshold) and separable Gaussian blur.
...
`,Be=`// Bloom composite: adds the blurred bright regions back to the source HDR.
...
`,we=`// Screen-Space Global Illumination — ray march pass.
...
`,Se=`// Screen-Space Global Illumination — temporal accumulation pass.
...
`;function Ge(n){switch(n.kind){case"sphere":{const i=Math.cos(n.solidAngle).toFixed(6),t=n.radius.toFixed(6);return`{
...
}`}}function le(n,i){return n?n.filter(t=>t.trigger===i).flatMap(t=>t.actions.map(ce)).join(`
  `):""}function Ue(n){const{emitter:i,events:t}=n,[e,r]=i.lifetime.map(c=>c.toFixed(6)),[o,u]=i.initialSpeed.map(c=>c.toFixed(6)),[l,f]=i.initialSize.map(c=>c.toFixed(6));return`
${oe}
...
`}function Te(n){return n.modifiers.some(i=>i.type==="block_collision")}const Me=`
...
`;function Ee(n){const i=n.modifiers.some(r=>r.type==="block_collision"),t=n.modifiers.map(ce).join(`
  `),e=le(n.events,"on_death");return`
${oe}
${i?Me:""}
...
`}const Ce=`// Compact pass — rebuilds alive_list and writes indirect draw instance count.
...
`,Le=`// Particle GBuffer render pass — camera-facing billboard quads.
...
`,Ie=`// Particle forward HDR render pass — velocity-aligned billboard quads.
...
`,Re=`// IBL baking — two compute entry points share the same bind group layout.
//
