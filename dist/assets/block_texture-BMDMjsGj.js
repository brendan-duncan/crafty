var De=Object.defineProperty;var ze=(f,c,n)=>c in f?De(f,c,{enumerable:!0,configurable:!0,writable:!0,value:n}):f[c]=n;var r=(f,c,n)=>ze(f,typeof c!="symbol"?c+"":c,n);import{c as U,f as ne,a as H,V as ke,b as He}from"./shadow-CGnDmh2T.js";import{e as ye,H as T}from"./geometry_pass-w1L8P7ny.js";import{T as K}from"./hdr_loader-lV1Mfgiy.js";const Lr=""+new URL("simple_block_atlas-B-7juoTN.png",import.meta.url).href,Rr=""+new URL("simple_block_atlas_normal-BdCvGD-K.png",import.meta.url).href,Mr=""+new URL("simple_block_atlas_mer-C_Oa_Ink.png",import.meta.url).href,Nr=""+new URL("simple_block_atlas_heightmap-BOV6qQJl.png",import.meta.url).href,je=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],qe=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)];class Or extends ye{constructor(){super(...arguments);r(this,"color",U.one());r(this,"intensity",1);r(this,"radius",10);r(this,"castShadow",!1)}worldPosition(){return this.gameObject.localToWorld().transformPoint(U.ZERO)}cubeFaceViewProjs(n=.05){const i=this.worldPosition(),e=ne.perspective(Math.PI/2,1,n,this.radius),a=new Array(6);for(let t=0;t<6;t++)a[t]=e.multiply(ne.lookAt(i,i.add(je[t]),qe[t]));return a}}class Ir extends ye{constructor(){super(...arguments);r(this,"color",U.one());r(this,"intensity",1);r(this,"range",20);r(this,"innerAngle",15);r(this,"outerAngle",30);r(this,"castShadow",!1);r(this,"projectionTexture",null)}worldPosition(){return this.gameObject.localToWorld().transformPoint(U.ZERO)}worldDirection(){return this.gameObject.localToWorld().transformDirection(U.FORWARD).normalize()}lightViewProj(n=.1){const i=this.worldPosition(),e=this.worldDirection(),a=Math.abs(e.y)>.99?U.RIGHT:U.UP,t=ne.lookAt(i,i.add(e),a);return ne.perspective(this.outerAngle*2*Math.PI/180,1,n,this.range).multiply(t)}}const We=`// TAA resolve pass — fullscreen triangle, blends current HDR with reprojected history.\r
\r
...
`,ue=128;class we extends H{constructor(n,i,e,a,t,o,u,s,d,m){super();r(this,"name","TAAPass");r(this,"_resolved");r(this,"resolvedView");r(this,"_history");r(this,"_historyView");r(this,"_pipeline");r(this,"_uniformBuffer");r(this,"_uniformBG");r(this,"_textureBG");r(this,"_width");r(this,"_height");r(this,"_scratch",new Float32Array(ue/4));this._resolved=n,this.resolvedView=i,this._history=e,this._historyView=a,this._pipeline=t,this._uniformBuffer=o,this._uniformBG=u,this._textureBG=s,this._width=d,this._height=m}get historyView(){return this._historyView}static create(n,i,e){const{device:a,width:t,height:o}=n,u=a.createTexture({label:"TAA Resolved",size:{width:t,height:o},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),s=a.createTexture({label:"TAA History",size:{width:t,height:o},format:T,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),d=u.createView(),m=s.createView(),l=a.createBuffer({label:"TAAUniformBuffer",size:ue,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),p=a.createBindGroupLayout({label:"TAAUniformBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),g=a.createBindGroupLayout({label:"TAATextureBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),h=a.createSampler({label:"TAALinearSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),b=a.createBindGroup({layout:p,entries:[{binding:0,resource:{buffer:l}}]}),_=a.createBindGroup({layout:g,entries:[{binding:0,resource:i.hdrView},{binding:1,resource:m},{binding:2,resource:e.depthView},{binding:3,resource:h}]}),y=a.createShaderModule({label:"TAAShader",code:We}),v=a.createRenderPipeline({label:"TAAPipeline",layout:a.createPipelineLayout({bindGroupLayouts:[p,g]}),vertex:{module:y,entryPoint:"vs_main"},fragment:{module:y,entryPoint:"fs_main",targets:[{format:T}]},primitive:{topology:"triangle-list"}});return new we(u,d,s,m,v,l,b,_,t,o)}updateCamera(n,i,e){const a=this._scratch;a.set(i.data,0),a.set(e.data,16),n.queue.writeBuffer(this._uniformBuffer,0,a.buffer)}execute(n,i){const e=n.beginRenderPass({label:"TAAPass",colorAttachments:[{view:this.resolvedView,clearValue:[0,0,0,1],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._pipeline),e.setBindGroup(0,this._uniformBG),e.setBindGroup(1,this._textureBG),e.draw(3),e.end(),n.copyTextureToTexture({texture:this._resolved},{texture:this._history},{width:this._width,height:this._height})}destroy(){this._resolved.destroy(),this._history.destroy(),this._uniformBuffer.destroy()}}const $e=`// Bloom: prefilter (downsample + threshold) and separable Gaussian blur.\r
...
`,Xe=`// Bloom composite: adds the blurred bright regions back to the source HDR.\r
\r
struct BloomUniforms {\r
  threshold: f32,\r
  knee     : f32,\r
...
`,Ye=16;class Pe extends H{constructor(n,i,e,a,t,o,u,s,d,m,l,p,g,h,b){super();r(this,"name","BloomPass");r(this,"resultView");r(this,"_result");r(this,"_half1");r(this,"_half2");r(this,"_half1View");r(this,"_half2View");r(this,"_prefilterPipeline");r(this,"_blurHPipeline");r(this,"_blurVPipeline");r(this,"_compositePipeline");r(this,"_uniformBuffer");r(this,"_scratch",new Float32Array(4));r(this,"_prefilterBG");r(this,"_blurHBG");r(this,"_blurVBG");r(this,"_compositeBG");this._result=n,this.resultView=i,this._half1=e,this._half1View=a,this._half2=t,this._half2View=o,this._prefilterPipeline=u,this._blurHPipeline=s,this._blurVPipeline=d,this._compositePipeline=m,this._uniformBuffer=l,this._prefilterBG=p,this._blurHBG=g,this._blurVBG=h,this._compositeBG=b}static create(n,i){const{device:e,width:a,height:t}=n,o=Math.max(1,a>>1),u=Math.max(1,t>>1),s=e.createTexture({label:"BloomHalf1",size:{width:o,height:u},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),d=e.createTexture({label:"BloomHalf2",size:{width:o,height:u},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),m=e.createTexture({label:"BloomResult",size:{width:a,height:t},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),l=s.createView(),p=d.createView(),g=m.createView(),h=e.createBuffer({label:"BloomUniforms",size:Ye,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(h,0,new Float32Array([1,.5,.3,0]).buffer);const b=e.createSampler({label:"BloomSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),_=e.createBindGroupLayout({label:"BloomSingleBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),y=e.createBindGroupLayout({label:"BloomCompositeBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),v=e.createShaderModule({label:"BloomShader",code:$e}),P=e.createShaderModule({label:"BloomComposite",code:Xe}),B=e.createPipelineLayout({bindGroupLayouts:[_]}),G=e.createPipelineLayout({bindGroupLayouts:[y]});function x(C,z){return e.createRenderPipeline({label:z,layout:B,vertex:{module:v,entryPoint:"vs_main"},fragment:{module:v,entryPoint:C,targets:[{format:T}]},primitive:{topology:"triangle-list"}})}const S=x("fs_prefilter","BloomPrefilterPipeline"),L=x("fs_blur_h","BloomBlurHPipeline"),V=x("fs_blur_v","BloomBlurVPipeline"),E=e.createRenderPipeline({label:"BloomCompositePipeline",layout:G,vertex:{module:P,entryPoint:"vs_main"},fragment:{module:P,entryPoint:"fs_main",targets:[{format:T}]},primitive:{topology:"triangle-list"}});function M(C){return e.createBindGroup({layout:_,entries:[{binding:0,resource:{buffer:h}},{binding:1,resource:C},{binding:2,resource:b}]})}const N=M(i),F=M(l),O=M(p),I=e.createBindGroup({layout:y,entries:[{binding:0,resource:{buffer:h}},{binding:1,resource:i},{binding:2,resource:l},{binding:3,resource:b}]});return new Pe(m,g,s,l,d,p,S,L,V,E,h,N,F,O,I)}updateParams(n,i=1,e=.5,a=.3){this._scratch[0]=i,this._scratch[1]=e,this._scratch[2]=a,this._scratch[3]=0,n.queue.writeBuffer(this._uniformBuffer,0,this._scratch.buffer)}execute(n,i){const e=(a,t,o,u)=>{const s=n.beginRenderPass({label:a,colorAttachments:[{view:t,clearValue:[0,0,0,1],loadOp:"clear",storeOp:"store"}]});s.setPipeline(o),s.setBindGroup(0,u),s.draw(3),s.end()};e("BloomPrefilter",this._half1View,this._prefilterPipeline,this._prefilterBG);for(let a=0;a<2;a++)e("BloomBlurH",this._half2View,this._blurHPipeline,this._blurHBG),e("BloomBlurV",this._half1View,this._blurVPipeline,this._blurVBG);e("BloomComposite",this.resultView,this._compositePipeline,this._compositeBG)}destroy(){this._result.destroy(),this._half1.destroy(),this._half2.destroy(),this._uniformBuffer.destroy()}}const Ze=`// Depth of Field: prefilter (CoC + 2x downsample) then fused disc-blur + composite.\r
\r
...
\r
// Prefilter: 4-tap 2x downsample; RGB = color, A = signed CoC (texels, half-res).\r
...
`,Qe=`// SSAO blur: 4×4 box blur to smooth raw SSAO output.\r
\r
...
`,J="r8unorm",se=16,er=464;function rr(){const f=new Float32Array(se*4);for(let c=0;c<se;c++){const n=Math.random(),i=Math.random()*Math.PI*2,e=Math.sqrt(1-n*n),a=.1+.9*(c/se)**2;f[c*4+0]=e*Math.cos(i)*a,f[c*4+1]=e*Math.sin(i)*a,f[c*4+2]=n*a,f[c*4+3]=0}return f}function tr(){const f=new Uint8Array(64);for(let c=0;c<16;c++){const n=Math.random()*Math.PI*2;f[c*4+0]=Math.round((Math.cos(n)*.5+.5)*255),f[c*4+1]=Math.round((Math.sin(n)*.5+.5)*255),f[c*4+2]=128,f[c*4+3]=255}return f}class Ge extends H{constructor(n,i,e,a,t,o,u,s,d,m,l){super();r(this,"name","SSAOPass");r(this,"aoView");r(this,"_raw");r(this,"_blurred");r(this,"_rawView");r(this,"_ssaoPipeline");r(this,"_blurPipeline");r(this,"_uniformBuffer");r(this,"_noiseTex");r(this,"_cameraScratch",new Float32Array(48));r(this,"_paramsScratch",new Float32Array(4));r(this,"_ssaoBG0");r(this,"_ssaoBG1");r(this,"_blurBG");this._raw=n,this._rawView=i,this._blurred=e,this.aoView=a,this._ssaoPipeline=t,this._blurPipeline=o,this._uniformBuffer=u,this._noiseTex=s,this._ssaoBG0=d,this._ssaoBG1=m,this._blurBG=l}static create(n,i){const{device:e,width:a,height:t}=n,o=Math.max(1,a>>1),u=Math.max(1,t>>1),s=e.createTexture({label:"SsaoRaw",size:{width:o,height:u},format:J,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),d=e.createTexture({label:"SsaoBlurred",size:{width:o,height:u},format:J,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),m=s.createView(),l=d.createView(),p=e.createTexture({label:"SsaoNoise",size:{width:4,height:4},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});e.queue.writeTexture({texture:p},tr().buffer,{bytesPerRow:4*4,rowsPerImage:4},{width:4,height:4});const g=p.createView(),h=e.createBuffer({label:"SsaoUniforms",size:er,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(h,208,rr().buffer),e.queue.writeBuffer(h,192,new Float32Array([1,.005,2,0]).buffer);const b=e.createSampler({label:"SsaoBlurSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),_=e.createBindGroupLayout({label:"SsaoBGL0",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),y=e.createBindGroupLayout({label:"SsaoBGL1",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}}]}),v=e.createBindGroupLayout({label:"SsaoBlurBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),P=e.createShaderModule({label:"SsaoShader",code:Je}),B=e.createShaderModule({label:"SsaoBlurShader",code:Qe}),G=e.createRenderPipeline({label:"SsaoPipeline",layout:e.createPipelineLayout({bindGroupLayouts:[_,y]}),vertex:{module:P,entryPoint:"vs_main"},fragment:{module:P,entryPoint:"fs_ssao",targets:[{format:J}]},primitive:{topology:"triangle-list"}}),x=e.createRenderPipeline({label:"SsaoBlurPipeline",layout:e.createPipelineLayout({bindGroupLayouts:[v]}),vertex:{module:B,entryPoint:"vs_main"},fragment:{module:B,entryPoint:"fs_blur",targets:[{format:J}]},primitive:{topology:"triangle-list"}}),S=e.createBindGroup({label:"SsaoBG0",layout:_,entries:[{binding:0,resource:{buffer:h}}]}),L=e.createBindGroup({label:"SsaoBG1",layout:y,entries:[{binding:0,resource:i.normalMetallicView},{binding:1,resource:i.depthView},{binding:2,resource:g}]}),V=e.createBindGroup({label:"SsaoBlurBG",layout:v,entries:[{binding:0,resource:m},{binding:1,resource:b}]});return new Ge(s,m,d,l,G,x,h,p,S,L,V)}updateCamera(n,i,e,a){const t=this._cameraScratch;t.set(i.data,0),t.set(e.data,16),t.set(a.data,32),n.device.queue.writeBuffer(this._uniformBuffer,0,t.buffer)}updateParams(n,i=1,e=.005,a=2){this._paramsScratch[0]=i,this._paramsScratch[1]=e,this._paramsScratch[2]=a,this._paramsScratch[3]=0,n.device.queue.writeBuffer(this._uniformBuffer,192,this._paramsScratch.buffer)}execute(n,i){{const e=n.beginRenderPass({label:"SSAOPass",colorAttachments:[{view:this._rawView,clearValue:[1,0,0,1],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._ssaoPipeline),e.setBindGroup(0,this._ssaoBG0),e.setBindGroup(1,this._ssaoBG1),e.draw(3),e.end()}{const e=n.beginRenderPass({label:"SSAOBlur",colorAttachments:[{view:this.aoView,clearValue:[1,0,0,1],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._blurPipeline),e.setBindGroup(0,this._blurBG),e.draw(3),e.end()}}destroy(){this._raw.destroy(),this._blurred.destroy(),this._uniformBuffer.destroy(),this._noiseTex.destroy()}}const nr=`// Screen-Space Global Illumination — ray march pass.\r
...
`,ir=`// Screen-Space Global Illumination — temporal accumulation pass.\r
...
`,ce=368,ar={numRays:4,numSteps:16,radius:3,thickness:.5,strength:1};function sr(){const f=new Uint8Array(new ArrayBuffer(64));for(let c=0;c<16;c++){const n=Math.random()*Math.PI*2;f[c*4+0]=Math.round((Math.cos(n)*.5+.5)*255),f[c*4+1]=Math.round((Math.sin(n)*.5+.5)*255),f[c*4+2]=128,f[c*4+3]=255}return f}class Se extends H{constructor(n,i,e,a,t,o,u,s,d,m,l,p,g,h,b,_){super();r(this,"name","SSGIPass");r(this,"resultView");r(this,"_uniformBuffer");r(this,"_noiseTexture");r(this,"_rawTexture");r(this,"_rawView");r(this,"_historyTexture");r(this,"_resultTexture");r(this,"_ssgiPipeline");r(this,"_temporalPipeline");r(this,"_ssgiBG0");r(this,"_ssgiBG1");r(this,"_tempBG0");r(this,"_tempBG1");r(this,"_settings");r(this,"_frameIndex",0);r(this,"_scratch",new Float32Array(ce/4));r(this,"_scratchU32",new Uint32Array(this._scratch.buffer));r(this,"_width");r(this,"_height");this._uniformBuffer=n,this._noiseTexture=i,this._rawTexture=e,this._rawView=a,this._historyTexture=t,this._resultTexture=o,this.resultView=u,this._ssgiPipeline=s,this._temporalPipeline=d,this._ssgiBG0=m,this._ssgiBG1=l,this._tempBG0=p,this._tempBG1=g,this._settings=h,this._width=b,this._height=_}static create(n,i,e,a=ar){const{device:t,width:o,height:u}=n,s=t.createBuffer({label:"SSGIUniforms",size:ce,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),d=t.createTexture({label:"SSGINoise",size:{width:4,height:4},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});t.queue.writeTexture({texture:d},sr(),{bytesPerRow:4*4,rowsPerImage:4},{width:4,height:4});const m=d.createView(),l=t.createTexture({label:"SSGIRaw",size:{width:o,height:u},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),p=l.createView(),g=t.createTexture({label:"SSGIHistory",size:{width:o,height:u},format:T,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),h=g.createView(),b=t.createTexture({label:"SSGIResult",size:{width:o,height:u},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),_=b.createView(),y=t.createSampler({label:"SSGILinearSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),v=t.createBindGroupLayout({label:"SSGIUniformBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),P=t.createBindGroupLayout({label:"SSGITexBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),B=t.createBindGroupLayout({label:"SSGITempTexBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),G=t.createBindGroup({label:"SSGIUniformBG",layout:v,entries:[{binding:0,resource:{buffer:s}}]}),x=t.createBindGroup({label:"SSGITexBG",layout:P,entries:[{binding:0,resource:i.depthView},{binding:1,resource:i.normalMetallicView},{binding:2,resource:e},{binding:3,resource:m},{binding:4,resource:y}]}),S=t.createBindGroup({label:"SSGITempUniformBG",layout:v,entries:[{binding:0,resource:{buffer:s}}]}),L=t.createBindGroup({label:"SSGITempTexBG",layout:B,entries:[{binding:0,resource:p},{binding:1,resource:h},{binding:2,resource:i.depthView},{binding:3,resource:y}]}),V=t.createShaderModule({label:"SSGIShader",code:nr}),E=t.createShaderModule({label:"SSGITempShader",code:ir}),M=t.createRenderPipeline({label:"SSGIPipeline",layout:t.createPipelineLayout({bindGroupLayouts:[v,P]}),vertex:{module:V,entryPoint:"vs_main"},fragment:{module:V,entryPoint:"fs_ssgi",targets:[{format:T}]},primitive:{topology:"triangle-list"}}),N=t.createRenderPipeline({label:"SSGITempPipeline",layout:t.createPipelineLayout({bindGroupLayouts:[v,B]}),vertex:{module:E,entryPoint:"vs_main"},fragment:{module:E,entryPoint:"fs_temporal",targets:[{format:T}]},primitive:{topology:"triangle-list"}});return new Se(s,d,l,p,g,b,_,M,N,G,x,S,L,a,o,u)}updateCamera(n,i,e,a,t,o,u){const s=this._scratch;s.set(i.data,0),s.set(e.data,16),s.set(a.data,32),s.set(t.data,48),s.set(o.data,64),s[80]=u.x,s[81]=u.y,s[82]=u.z;const d=this._scratchU32;d[83]=this._settings.numRays,d[84]=this._settings.numSteps,s[85]=this._settings.radius,s[86]=this._settings.thickness,s[87]=this._settings.strength,d[88]=this._frameIndex++,n.queue.writeBuffer(this._uniformBuffer,0,s.buffer)}updateSettings(n){this._settings={...this._settings,...n}}execute(n,i){{const e=n.beginRenderPass({label:"SSGIRayMarch",colorAttachments:[{view:this._rawView,clearValue:[0,0,0,0],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._ssgiPipeline),e.setBindGroup(0,this._ssgiBG0),e.setBindGroup(1,this._ssgiBG1),e.draw(3),e.end()}{const e=n.beginRenderPass({label:"SSGITemporal",colorAttachments:[{view:this.resultView,clearValue:[0,0,0,0],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._temporalPipeline),e.setBindGroup(0,this._tempBG0),e.setBindGroup(1,this._tempBG1),e.draw(3),e.end()}n.copyTextureToTexture({texture:this._resultTexture},{texture:this._historyTexture},{width:this._width,height:this._height})}destroy(){this._uniformBuffer.destroy(),this._noiseTexture.destroy(),this._rawTexture.destroy(),this._historyTexture.destroy(),this._resultTexture.destroy()}}const or=`// VSM shadow map generation for point and spot lights.\r
//\r
...
`,Q=32,ee=32,$=4,j=8,re=256,te=512,D=256,de=80,lr=64,ur=6*$,cr=ur+j;class Ue extends H{constructor(n,i,e,a,t,o,u,s,d,m,l,p,g,h){super();r(this,"name","PointSpotShadowPass");r(this,"pointVsmView");r(this,"spotVsmView");r(this,"projTexView");r(this,"_pointVsmTex");r(this,"_spotVsmTex");r(this,"_projTexArray");r(this,"_pointDepth");r(this,"_spotDepth");r(this,"_pointFaceViews");r(this,"_spotFaceViews");r(this,"_pointDepthView");r(this,"_spotDepthView");r(this,"_pointPipeline");r(this,"_spotPipeline");r(this,"_shadowBufs");r(this,"_shadowBGs");r(this,"_modelBufs",[]);r(this,"_modelBGs",[]);r(this,"_modelBGL");r(this,"_shadowScratch",new Float32Array(de/4));r(this,"_snapshot",[]);r(this,"_pointLights",[]);r(this,"_spotLights",[]);this._pointVsmTex=n,this._spotVsmTex=i,this._projTexArray=e,this._pointDepth=a,this._spotDepth=t,this._pointFaceViews=o,this._spotFaceViews=u,this._pointDepthView=s,this._spotDepthView=d,this._pointPipeline=m,this._spotPipeline=l,this._shadowBufs=p,this._shadowBGs=g,this._modelBGL=h,this.pointVsmView=n.createView({dimension:"cube-array",arrayLayerCount:$*6}),this.spotVsmView=i.createView({dimension:"2d-array"}),this.projTexView=e.createView({dimension:"2d-array"})}static create(n){const{device:i}=n,e=i.createTexture({label:"PointVSM",size:{width:re,height:re,depthOrArrayLayers:$*6},format:"rgba16float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),a=i.createTexture({label:"SpotVSM",size:{width:te,height:te,depthOrArrayLayers:j},format:"rgba16float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),t=i.createTexture({label:"ProjTexArray",size:{width:D,height:D,depthOrArrayLayers:j},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),o=new Uint8Array(D*D*4).fill(255);for(let x=0;x<j;x++)i.queue.writeTexture({texture:t,origin:{x:0,y:0,z:x}},o,{bytesPerRow:D*4,rowsPerImage:D},{width:D,height:D,depthOrArrayLayers:1});const u=i.createTexture({label:"PointShadowDepth",size:{width:re,height:re},format:"depth32float",usage:GPUTextureUsage.RENDER_ATTACHMENT}),s=i.createTexture({label:"SpotShadowDepth",size:{width:te,height:te},format:"depth32float",usage:GPUTextureUsage.RENDER_ATTACHMENT}),d=Array.from({length:$*6},(x,S)=>e.createView({dimension:"2d",baseArrayLayer:S,arrayLayerCount:1})),m=Array.from({length:j},(x,S)=>a.createView({dimension:"2d",baseArrayLayer:S,arrayLayerCount:1})),l=u.createView(),p=s.createView(),g=i.createBindGroupLayout({label:"PSShadowBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),h=i.createBindGroupLayout({label:"PSModelBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),b=[],_=[];for(let x=0;x<cr;x++){const S=i.createBuffer({label:`PSShadowUniform ${x}`,size:de,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});b.push(S),_.push(i.createBindGroup({label:`PSShadowBG ${x}`,layout:g,entries:[{binding:0,resource:{buffer:S}}]}))}const y=i.createPipelineLayout({bindGroupLayouts:[g,h]}),v=i.createShaderModule({label:"PointSpotShadowShader",code:or}),P={module:v,buffers:[{arrayStride:He,attributes:[ke[0]]}]},B=i.createRenderPipeline({label:"PointShadowPipeline",layout:y,vertex:{...P,entryPoint:"vs_point"},fragment:{module:v,entryPoint:"fs_point",targets:[{format:"rgba16float"}]},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"back"}}),G=i.createRenderPipeline({label:"SpotShadowPipeline",layout:y,vertex:{...P,entryPoint:"vs_spot"},fragment:{module:v,entryPoint:"fs_spot",targets:[{format:"rgba16float"}]},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"back"}});return new Ue(e,a,t,u,s,d,m,l,p,B,G,b,_,h)}update(n,i,e){this._pointLights=n,this._spotLights=i,this._snapshot=e}setProjectionTexture(n,i,e){n.copyTextureToTexture({texture:e},{texture:this._projTexArray,origin:{x:0,y:0,z:i}},{width:D,height:D,depthOrArrayLayers:1})}execute(n,i){const{device:e}=i,a=this._snapshot;this._ensureModelBuffers(e,a.length);for(let s=0;s<this._spotLights.length&&s<j;s++){const d=this._spotLights[s];d.projectionTexture&&this.setProjectionTexture(n,s,d.projectionTexture)}for(let s=0;s<a.length;s++)i.queue.writeBuffer(this._modelBufs[s],0,a[s].modelMatrix.data.buffer);let t=0,o=0;for(const s of this._pointLights){if(!s.castShadow||o>=$)continue;const d=s.worldPosition(),m=s.cubeFaceViewProjs(),l=this._shadowScratch;l[16]=d.x,l[17]=d.y,l[18]=d.z,l[19]=s.radius;for(let p=0;p<6;p++){l.set(m[p].data,0),i.queue.writeBuffer(this._shadowBufs[t],0,l.buffer);const g=o*6+p,h=n.beginRenderPass({label:`PointShadow light${o} face${p}`,colorAttachments:[{view:this._pointFaceViews[g],clearValue:{r:1,g:1,b:0,a:1},loadOp:"clear",storeOp:"store"}],depthStencilAttachment:{view:this._pointDepthView,depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"discard"}});h.setPipeline(this._pointPipeline),h.setBindGroup(0,this._shadowBGs[t]),this._drawItems(h,a),h.end(),t++}o++}let u=0;for(const s of this._spotLights){if(!s.castShadow||u>=j)continue;const d=s.lightViewProj(),m=s.worldPosition(),l=this._shadowScratch;l.set(d.data,0),l[16]=m.x,l[17]=m.y,l[18]=m.z,l[19]=s.range,i.queue.writeBuffer(this._shadowBufs[t],0,l.buffer);const p=n.beginRenderPass({label:`SpotShadow light${u}`,colorAttachments:[{view:this._spotFaceViews[u],clearValue:{r:1,g:1,b:0,a:1},loadOp:"clear",storeOp:"store"}],depthStencilAttachment:{view:this._spotDepthView,depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"discard"}});p.setPipeline(this._spotPipeline),p.setBindGroup(0,this._shadowBGs[t]),this._drawItems(p,a),p.end(),t++,u++}}_drawItems(n,i){for(let e=0;e<i.length;e++){const{mesh:a}=i[e];n.setBindGroup(1,this._modelBGs[e]),n.setVertexBuffer(0,a.vertexBuffer),n.setIndexBuffer(a.indexBuffer,"uint32"),n.drawIndexed(a.indexCount)}}_ensureModelBuffers(n,i){for(;this._modelBufs.length<i;){const e=n.createBuffer({label:`PSModelUniform ${this._modelBufs.length}`,size:lr,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});this._modelBufs.push(e),this._modelBGs.push(n.createBindGroup({layout:this._modelBGL,entries:[{binding:0,resource:{buffer:e}}]}))}}destroy(){this._pointVsmTex.destroy(),this._spotVsmTex.destroy(),this._projTexArray.destroy(),this._pointDepth.destroy(),this._spotDepth.destroy();for(const n of this._shadowBufs)n.destroy();for(const n of this._modelBufs)n.destroy()}}const dr=`// Additive deferred pass for point and spot lights.\r
// Runs after DeferredLightingPass (which handles directional + IBL) with loadOp:'load'\r
...
`,pe=64*4+16+16,pr=8,fe=48,he=128;class Te extends H{constructor(n,i,e,a,t,o,u,s,d,m){super();r(this,"name","PointSpotLightPass");r(this,"_pipeline");r(this,"_cameraBG");r(this,"_gbufferBG");r(this,"_lightBG");r(this,"_shadowBG");r(this,"_cameraBuffer");r(this,"_lightCountsBuffer");r(this,"_pointBuffer");r(this,"_spotBuffer");r(this,"_hdrView");r(this,"_cameraData",new Float32Array(pe/4));r(this,"_lightCountsArr",new Uint32Array(2));r(this,"_pointBuf",new ArrayBuffer(Q*fe));r(this,"_pointF32",new Float32Array(this._pointBuf));r(this,"_pointI32",new Int32Array(this._pointBuf));r(this,"_spotBuf",new ArrayBuffer(ee*he));r(this,"_spotF32",new Float32Array(this._spotBuf));r(this,"_spotI32",new Int32Array(this._spotBuf));this._pipeline=n,this._cameraBG=i,this._gbufferBG=e,this._lightBG=a,this._shadowBG=t,this._cameraBuffer=o,this._lightCountsBuffer=u,this._pointBuffer=s,this._spotBuffer=d,this._hdrView=m}static create(n,i,e,a){const{device:t}=n,o=t.createBuffer({label:"PSLCameraBuffer",size:pe,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),u=t.createBuffer({label:"PSLLightCounts",size:pr,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),s=t.createBuffer({label:"PSLPointBuffer",size:Q*fe,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),d=t.createBuffer({label:"PSLSpotBuffer",size:ee*he,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),m=t.createSampler({label:"PSLLinearSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),l=t.createSampler({label:"PSLVsmSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge"}),p=t.createSampler({label:"PSLProjSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),g=t.createBindGroupLayout({label:"PSLCameraBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),h=t.createBindGroupLayout({label:"PSLGBufferBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),b=t.createBindGroupLayout({label:"PSLLightBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}}]}),_=t.createBindGroupLayout({label:"PSLShadowBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube-array"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),y=t.createBindGroup({label:"PSLCameraBG",layout:g,entries:[{binding:0,resource:{buffer:o}}]}),v=t.createBindGroup({label:"PSLGBufferBG",layout:h,entries:[{binding:0,resource:i.albedoRoughnessView},{binding:1,resource:i.normalMetallicView},{binding:2,resource:i.depthView},{binding:3,resource:m}]}),P=t.createBindGroup({label:"PSLLightBG",layout:b,entries:[{binding:0,resource:{buffer:u}},{binding:1,resource:{buffer:s}},{binding:2,resource:{buffer:d}}]}),B=t.createBindGroup({label:"PSLShadowBG",layout:_,entries:[{binding:0,resource:e.pointVsmView},{binding:1,resource:e.spotVsmView},{binding:2,resource:e.projTexView},{binding:3,resource:l},{binding:4,resource:p}]}),G=t.createShaderModule({label:"PointSpotLightShader",code:dr}),x=t.createRenderPipeline({label:"PointSpotLightPipeline",layout:t.createPipelineLayout({bindGroupLayouts:[g,h,b,_]}),vertex:{module:G,entryPoint:"vs_main"},fragment:{module:G,entryPoint:"fs_main",targets:[{format:T,blend:{color:{srcFactor:"one",dstFactor:"one",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one",operation:"add"}}}]},primitive:{topology:"triangle-list"}});return new Te(x,y,v,P,B,o,u,s,d,a)}updateCamera(n,i,e,a,t,o,u,s){const d=this._cameraData;d.set(i.data,0),d.set(e.data,16),d.set(a.data,32),d.set(t.data,48),d[64]=o.x,d[65]=o.y,d[66]=o.z,d[67]=u,d[68]=s,n.queue.writeBuffer(this._cameraBuffer,0,d.buffer)}updateLights(n,i,e){const a=this._lightCountsArr;a[0]=Math.min(i.length,Q),a[1]=Math.min(e.length,ee),n.queue.writeBuffer(this._lightCountsBuffer,0,a.buffer);const t=this._pointF32,o=this._pointI32;let u=0;for(let l=0;l<Math.min(i.length,Q);l++){const p=i[l],g=p.worldPosition(),h=l*12;t[h+0]=g.x,t[h+1]=g.y,t[h+2]=g.z,t[h+3]=p.radius,t[h+4]=p.color.x,t[h+5]=p.color.y,t[h+6]=p.color.z,t[h+7]=p.intensity,p.castShadow&&u<$?o[h+8]=u++:o[h+8]=-1,o[h+9]=0,o[h+10]=0,o[h+11]=0}n.queue.writeBuffer(this._pointBuffer,0,this._pointBuf);const s=this._spotF32,d=this._spotI32;let m=0;for(let l=0;l<Math.min(e.length,ee);l++){const p=e[l],g=p.worldPosition(),h=p.worldDirection(),b=p.lightViewProj(),_=l*32;s[_+0]=g.x,s[_+1]=g.y,s[_+2]=g.z,s[_+3]=p.range,s[_+4]=h.x,s[_+5]=h.y,s[_+6]=h.z,s[_+7]=Math.cos(p.innerAngle*Math.PI/180),s[_+8]=p.color.x,s[_+9]=p.color.y,s[_+10]=p.color.z,s[_+11]=Math.cos(p.outerAngle*Math.PI/180),s[_+12]=p.intensity,p.castShadow&&m<j?d[_+13]=m++:d[_+13]=-1,d[_+14]=p.projectionTexture!==null?l:-1,d[_+15]=0,s.set(b.data,_+16)}n.queue.writeBuffer(this._spotBuffer,0,this._spotBuf)}updateLight(n){n.computeLightViewProj()}execute(n,i){const e=n.beginRenderPass({label:"PointSpotLightPass",colorAttachments:[{view:this._hdrView,loadOp:"load",storeOp:"store"}]});e.setPipeline(this._pipeline),e.setBindGroup(0,this._cameraBG),e.setBindGroup(1,this._gbufferBG),e.setBindGroup(2,this._lightBG),e.setBindGroup(3,this._shadowBG),e.draw(3),e.end()}destroy(){this._cameraBuffer.destroy(),this._lightCountsBuffer.destroy(),this._pointBuffer.destroy(),this._spotBuffer.destroy()}}const Ae=`
struct Particle {
...
`;function fr(f){switch(f.kind){case"sphere":{const c=Math.cos(f.solidAngle).toFixed(6),n=f.radius.toFixed(6);return`{
...
}`}case"size_random":return`p.size = rand_range(${f.min.toFixed(6)}, ${f.max.toFixed(6)}, pcg_hash(idx * 2654435761u));`;case"size_over_lifetime":return`p.size = mix(${f.start.toFixed(6)}, ${f.end.toFixed(6)}, t);`;case"color_over_lifetime":{const[c,n,i,e]=f.startColor.map(s=>s.toFixed(6)),[a,t,o,u]=f.endColor.map(s=>s.toFixed(6));return`p.color = mix(vec4<f32>(${c}, ${n}, ${i}, ${e}), vec4<f32>(${a}, ${t}, ${o}, ${u}), t);`}case"block_collision":return`{
...
}`}}function Ee(f,c){return f?f.filter(n=>n.trigger===c).flatMap(n=>n.actions.map(Ve)).join(`
  `):""}function hr(f){const{emitter:c,events:n}=f,[i,e]=c.lifetime.map(s=>s.toFixed(6)),[a,t]=c.initialSpeed.map(s=>s.toFixed(6)),[o,u]=c.initialSize.map(s=>s.toFixed(6));return`
${Ae}
...
fn cs_main(@builtin(global_invocation_id) gid: vec3<u32>) {
  ...
  let speed = rand_range(${a}, ${t}, seed + 1u);
...
`}function mr(f){return f.modifiers.some(c=>c.type==="block_collision")}const _r=`
...
`;function gr(f){const c=f.modifiers.some(e=>e.type==="block_collision"),n=f.modifiers.map(Ve).join(`
  `),i=Ee(f.events,"on_death");return`
${Ae}
${c?_r:""}
...
`}const vr=`// Compact pass — rebuilds alive_list and writes indirect draw instance count.\r
...
`,br=`// Particle GBuffer render pass — camera-facing billboard quads.\r
...
`,xr=`// Particle forward HDR render pass — velocity-aligned billboard quads.\r
...
// should read as a solid colored pixel rather than a soft glow. Skips\r
// EMIT_SCALE so the output matches the source color after tonemapping.\r
@fragment\r
fn fs_pixel(in: VertexOutput) -> @location(0) vec4<f32> {\r
  return vec4<f32>(in.color.rgb, in.color.a);\r
}\r
`,me=64,_e=80,yr=16,wr=16,ge=288,ve=16,oe=128;class Le extends H{constructor(n,i,e,a,t,o,u,s,d,m,l,p,g,h,b,_,y,v,P,B,G,x,S,L,V,E,M){super();r(this,"name","ParticlePass");r(this,"_gbuffer");r(this,"_hdrView");r(this,"_isForward");r(this,"_maxParticles");r(this,"_config");r(this,"_particleBuffer");r(this,"_aliveList");r(this,"_counterBuffer");r(this,"_indirectBuffer");r(this,"_computeUniforms");r(this,"_renderUniforms");r(this,"_cameraBuffer");r(this,"_spawnPipeline");r(this,"_updatePipeline");r(this,"_compactPipeline");r(this,"_indirectPipeline");r(this,"_renderPipeline");r(this,"_computeDataBG");r(this,"_computeUniBG");r(this,"_compactDataBG");r(this,"_compactUniBG");r(this,"_renderDataBG");r(this,"_cameraRenderBG");r(this,"_renderParamsBG");r(this,"_heightmapDataBuf");r(this,"_heightmapUniBuf");r(this,"_heightmapBG");r(this,"_spawnAccum",0);r(this,"_spawnOffset",0);r(this,"_spawnCount",0);r(this,"_pendingBurst",null);r(this,"_time",0);r(this,"_frameSeed",0);r(this,"_cuBuf",new Float32Array(_e/4));r(this,"_cuiView",new Uint32Array(this._cuBuf.buffer));r(this,"_camBuf",new Float32Array(ge/4));r(this,"_hmUniBuf",new Float32Array(ve/4));r(this,"_hmRes",new Uint32Array([oe]));r(this,"_resetArr",new Uint32Array(1));this._gbuffer=n,this._hdrView=i,this._isForward=e,this._config=a,this._maxParticles=t,this._particleBuffer=o,this._aliveList=u,this._counterBuffer=s,this._indirectBuffer=d,this._computeUniforms=m,this._renderUniforms=l,this._cameraBuffer=p,this._spawnPipeline=g,this._updatePipeline=h,this._compactPipeline=b,this._indirectPipeline=_,this._renderPipeline=y,this._computeDataBG=v,this._computeUniBG=P,this._compactDataBG=B,this._compactUniBG=G,this._renderDataBG=x,this._cameraRenderBG=S,this._renderParamsBG=L,this._heightmapDataBuf=V,this._heightmapUniBuf=E,this._heightmapBG=M}setSpawnRate(n){this._config.emitter.spawnRate=n}burst(n,i,e){if(e<=0)return;const a=Math.min(e,this._maxParticles);this._pendingBurst={px:n.x,py:n.y,pz:n.z,r:i[0],g:i[1],b:i[2],a:i[3],count:a}}static create(n,i,e,a){const{device:t}=n,o=i.renderer.type==="sprites"&&i.renderer.renderTarget==="hdr",u=i.emitter.maxParticles,s=t.createBuffer({label:"ParticleBuffer",size:u*me,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),d=new Float32Array(u*(me/4));for(let k=0;k<u;k++)d[k*16+3]=-1;t.queue.writeBuffer(s,0,d.buffer);const m=t.createBuffer({label:"ParticleAliveList",size:u*4,usage:GPUBufferUsage.STORAGE}),l=t.createBuffer({label:"ParticleCounter",size:4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),p=t.createBuffer({label:"ParticleIndirect",size:16,usage:GPUBufferUsage.INDIRECT|GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});t.queue.writeBuffer(p,0,new Uint32Array([6,0,0,0]));const g=t.createBuffer({label:"ParticleComputeUniforms",size:_e,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),h=t.createBuffer({label:"ParticleCompactUniforms",size:yr,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});t.queue.writeBuffer(h,0,new Uint32Array([u,0,0,0]));const b=t.createBuffer({label:"ParticleRenderUniforms",size:wr,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});t.queue.writeBuffer(b,0,new Float32Array([i.emitter.roughness,i.emitter.metallic,0,0]));const _=t.createBuffer({label:"ParticleCameraBuffer",size:ge,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),y=t.createBindGroupLayout({label:"ParticleComputeDataBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),v=t.createBindGroupLayout({label:"ParticleCompactDataBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),P=t.createBindGroupLayout({label:"ParticleComputeUniBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),B=t.createBindGroupLayout({label:"ParticleRenderDataBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}}]}),G=t.createBindGroupLayout({label:"ParticleCameraRenderBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),x=t.createBindGroupLayout({label:"ParticleRenderParamsBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),S=t.createBindGroup({label:"ParticleComputeDataBG",layout:y,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:m}},{binding:2,resource:{buffer:l}},{binding:3,resource:{buffer:p}}]}),L=t.createBindGroup({label:"ParticleCompactDataBG",layout:v,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:m}},{binding:2,resource:{buffer:l}},{binding:3,resource:{buffer:p}}]}),V=t.createBindGroup({label:"ParticleComputeUniBG",layout:P,entries:[{binding:0,resource:{buffer:g}}]}),E=t.createBindGroup({label:"ParticleCompactUniBG",layout:P,entries:[{binding:0,resource:{buffer:h}}]}),M=t.createBindGroup({label:"ParticleRenderDataBG",layout:B,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:m}}]}),N=t.createBindGroup({label:"ParticleCameraRenderBG",layout:G,entries:[{binding:0,resource:{buffer:_}}]}),F=t.createBindGroup({label:"ParticleRenderParamsBG",layout:x,entries:[{binding:0,resource:{buffer:b}}]});let O,I,C,z;mr(i)&&(O=t.createBuffer({label:"ParticleHeightmapData",size:oe*oe*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),I=t.createBuffer({label:"ParticleHeightmapUniforms",size:ve,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),z=t.createBindGroupLayout({label:"ParticleHeightmapBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),C=t.createBindGroup({label:"ParticleHeightmapBG",layout:z,entries:[{binding:0,resource:{buffer:O}},{binding:1,resource:{buffer:I}}]}));const Y=t.createPipelineLayout({bindGroupLayouts:[y,P]}),Z=z?t.createPipelineLayout({bindGroupLayouts:[y,P,z]}):t.createPipelineLayout({bindGroupLayouts:[y,P]}),X=t.createPipelineLayout({bindGroupLayouts:[v,P]}),A=t.createShaderModule({label:"ParticleSpawn",code:hr(i)}),q=t.createShaderModule({label:"ParticleUpdate",code:gr(i)}),R=t.createShaderModule({label:"ParticleCompact",code:vr}),w=t.createComputePipeline({label:"ParticleSpawnPipeline",layout:Y,compute:{module:A,entryPoint:"cs_main"}}),Me=t.createComputePipeline({label:"ParticleUpdatePipeline",layout:Z,compute:{module:q,entryPoint:"cs_main"}}),Ne=t.createComputePipeline({label:"ParticleCompactPipeline",layout:X,compute:{module:R,entryPoint:"cs_compact"}}),Oe=t.createComputePipeline({label:"ParticleIndirectPipeline",layout:X,compute:{module:R,entryPoint:"cs_write_indirect"}});let ie;if(o){const k=i.renderer.type==="sprites"?i.renderer.billboard:"camera",ae=i.renderer.type==="sprites"?i.renderer.shape??"soft":"soft",Ie=k==="camera"?"vs_camera":"vs_main",Ce=k==="velocity"?"fs_main":ae==="pixel"?"fs_pixel":"fs_snow",le=t.createShaderModule({label:"ParticleRenderForward",code:xr}),Fe=t.createPipelineLayout({bindGroupLayouts:[B,G]});ie=t.createRenderPipeline({label:"ParticleForwardPipeline",layout:Fe,vertex:{module:le,entryPoint:Ie},fragment:{module:le,entryPoint:Ce,targets:[{format:T,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha",operation:"add"}}}]},depthStencil:{format:"depth32float",depthWriteEnabled:!1,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"none"}})}else{const k=t.createShaderModule({label:"ParticleRender",code:br}),ae=t.createPipelineLayout({bindGroupLayouts:[B,G,x]});ie=t.createRenderPipeline({label:"ParticleRenderPipeline",layout:ae,vertex:{module:k,entryPoint:"vs_main"},fragment:{module:k,entryPoint:"fs_main",targets:[{format:"rgba8unorm"},{format:"rgba16float"}]},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"none"}})}return new Le(e,a,o,i,u,s,m,l,p,g,b,_,w,Me,Ne,Oe,ie,S,V,L,E,M,N,o?void 0:F,O,I,C)}updateHeightmap(n,i,e,a,t){if(!this._heightmapDataBuf||!this._heightmapUniBuf)return;n.queue.writeBuffer(this._heightmapDataBuf,0,i.buffer);const o=this._hmUniBuf;o[0]=e,o[1]=a,o[2]=t,n.queue.writeBuffer(this._heightmapUniBuf,0,o.buffer,0,12),n.queue.writeBuffer(this._heightmapUniBuf,12,this._hmRes)}update(n,i,e,a,t,o,u,s,d,m){this._time+=i,this._frameSeed=this._frameSeed+1&4294967295,this._spawnAccum+=this._config.emitter.spawnRate*i,this._spawnCount=Math.min(Math.floor(this._spawnAccum),this._maxParticles),this._spawnAccum-=this._spawnCount;const l=m.data;let p=l[12],g=l[13],h=l[14];const b=Math.hypot(l[0],l[1],l[2]),_=Math.hypot(l[4],l[5],l[6]),y=Math.hypot(l[8],l[9],l[10]),v=l[0]/b,P=l[1]/b,B=l[2]/b,G=l[4]/_,x=l[5]/_,S=l[6]/_,L=l[8]/y,V=l[9]/y,E=l[10]/y,M=v+x+E;let N,F,O,I;if(M>0){const w=.5/Math.sqrt(M+1);I=.25/w,N=(S-V)*w,F=(L-B)*w,O=(P-G)*w}else if(v>x&&v>E){const w=2*Math.sqrt(1+v-x-E);I=(S-V)/w,N=.25*w,F=(G+P)/w,O=(L+B)/w}else if(x>E){const w=2*Math.sqrt(1+x-v-E);I=(L-B)/w,N=(G+P)/w,F=.25*w,O=(V+S)/w}else{const w=2*Math.sqrt(1+E-v-x);I=(P-G)/w,N=(L+B)/w,F=(V+S)/w,O=.25*w}const C=this._config.emitter.initialColor;let z=C[0],Y=C[1],Z=C[2],X=C[3];if(this._pendingBurst){const w=this._pendingBurst;p=w.px,g=w.py,h=w.pz,N=0,F=0,O=0,I=1,this._spawnCount=w.count,z=w.r,Y=w.g,Z=w.b,X=w.a,this._pendingBurst=null}const A=this._cuBuf,q=this._cuiView;A[0]=p,A[1]=g,A[2]=h,q[3]=this._spawnCount,A[4]=N,A[5]=F,A[6]=O,A[7]=I,q[8]=this._spawnOffset,q[9]=this._maxParticles,q[10]=this._frameSeed,q[11]=0,A[12]=i,A[13]=this._time,A[16]=z,A[17]=Y,A[18]=Z,A[19]=X,n.queue.writeBuffer(this._computeUniforms,0,A.buffer),n.queue.writeBuffer(this._counterBuffer,0,this._resetArr),this._spawnOffset=(this._spawnOffset+this._spawnCount)%this._maxParticles;const R=this._camBuf;R.set(e.data,0),R.set(a.data,16),R.set(t.data,32),R.set(o.data,48),R[64]=u.x,R[65]=u.y,R[66]=u.z,R[67]=s,R[68]=d,n.queue.writeBuffer(this._cameraBuffer,0,R.buffer)}execute(n,i){const e=n.beginComputePass({label:"ParticleCompute"});if(this._spawnCount>0&&(e.setPipeline(this._spawnPipeline),e.setBindGroup(0,this._computeDataBG),e.setBindGroup(1,this._computeUniBG),e.dispatchWorkgroups(Math.ceil(this._spawnCount/64))),e.setPipeline(this._updatePipeline),e.setBindGroup(0,this._computeDataBG),e.setBindGroup(1,this._computeUniBG),this._heightmapBG&&e.setBindGroup(2,this._heightmapBG),e.dispatchWorkgroups(Math.ceil(this._maxParticles/64)),e.setPipeline(this._compactPipeline),e.setBindGroup(0,this._compactDataBG),e.setBindGroup(1,this._compactUniBG),e.dispatchWorkgroups(Math.ceil(this._maxParticles/64)),e.setPipeline(this._indirectPipeline),e.dispatchWorkgroups(1),e.end(),this._isForward){const a=n.beginRenderPass({label:"ParticleForwardPass",colorAttachments:[{view:this._hdrView,loadOp:"load",storeOp:"store"}],depthStencilAttachment:{view:this._gbuffer.depthView,depthReadOnly:!0}});a.setPipeline(this._renderPipeline),a.setBindGroup(0,this._renderDataBG),a.setBindGroup(1,this._cameraRenderBG),a.drawIndirect(this._indirectBuffer,0),a.end()}else{const a=n.beginRenderPass({label:"ParticleGBufferPass",colorAttachments:[{view:this._gbuffer.albedoRoughnessView,loadOp:"load",storeOp:"store"},{view:this._gbuffer.normalMetallicView,loadOp:"load",storeOp:"store"}],depthStencilAttachment:{view:this._gbuffer.depthView,depthLoadOp:"load",depthStoreOp:"store"}});a.setPipeline(this._renderPipeline),a.setBindGroup(0,this._renderDataBG),a.setBindGroup(1,this._cameraRenderBG),a.setBindGroup(2,this._renderParamsBG),a.drawIndirect(this._indirectBuffer,0),a.end()}}destroy(){var n,i;this._particleBuffer.destroy(),this._aliveList.destroy(),this._counterBuffer.destroy(),this._indirectBuffer.destroy(),this._computeUniforms.destroy(),this._renderUniforms.destroy(),this._cameraBuffer.destroy(),(n=this._heightmapDataBuf)==null||n.destroy(),(i=this._heightmapUniBuf)==null||i.destroy()}}const Pr=`// Auto-exposure — two-pass histogram approach.\r
//\r
...
`,Br=64,Gr=32,Sr=16,Ur=Br*4,be={adaptSpeed:1.5,minExposure:.1,maxExposure:10,lowPct:.05,highPct:.02},W=class W extends H{constructor(n,i,e,a,t,o,u,s){super();r(this,"name","AutoExposurePass");r(this,"exposureBuffer");r(this,"_histogramPipeline");r(this,"_adaptPipeline");r(this,"_bindGroup");r(this,"_paramsBuffer");r(this,"_histogramBuffer");r(this,"_hdrWidth");r(this,"_hdrHeight");r(this,"enabled",!0);r(this,"_resetScratch",new Float32Array([1,0,0,0]));this._histogramPipeline=n,this._adaptPipeline=i,this._bindGroup=e,this._paramsBuffer=a,this._histogramBuffer=t,this.exposureBuffer=o,this._hdrWidth=u,this._hdrHeight=s}static create(n,i,e=be){const{device:a}=n,t=a.createBindGroupLayout({label:"AutoExposureBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),o=a.createBuffer({label:"AutoExposureHistogram",size:Ur,usage:GPUBufferUsage.STORAGE}),u=a.createBuffer({label:"AutoExposureValue",size:Sr,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});a.queue.writeBuffer(u,0,new Float32Array([1,0,0,0]));const s=a.createBuffer({label:"AutoExposureParams",size:Gr,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});W._writeParams(a,s,0,e);const d=a.createBindGroup({label:"AutoExposureBG",layout:t,entries:[{binding:0,resource:i.createView()},{binding:1,resource:{buffer:o}},{binding:2,resource:{buffer:u}},{binding:3,resource:{buffer:s}}]}),m=a.createPipelineLayout({bindGroupLayouts:[t]}),l=a.createShaderModule({label:"AutoExposure",code:Pr}),p=a.createComputePipeline({label:"AutoExposureHistogramPipeline",layout:m,compute:{module:l,entryPoint:"cs_histogram"}}),g=a.createComputePipeline({label:"AutoExposureAdaptPipeline",layout:m,compute:{module:l,entryPoint:"cs_adapt"}});return new W(p,g,d,s,o,u,i.width,i.height)}update(n,i,e=be){if(!this.enabled){n.device.queue.writeBuffer(this.exposureBuffer,0,this._resetScratch);return}W._writeParams(n.device,this._paramsBuffer,i,e)}execute(n,i){if(!this.enabled)return;const e=n.beginComputePass({label:"AutoExposurePass"});e.setPipeline(this._histogramPipeline),e.setBindGroup(0,this._bindGroup),e.dispatchWorkgroups(Math.ceil(this._hdrWidth/32),Math.ceil(this._hdrHeight/32)),e.setPipeline(this._adaptPipeline),e.dispatchWorkgroups(1),e.end()}destroy(){this._paramsBuffer.destroy(),this._histogramBuffer.destroy(),this.exposureBuffer.destroy()}static _writeParams(n,i,e,a){const t=W._paramsScratch;t[0]=e,t[1]=a.adaptSpeed,t[2]=a.minExposure,t[3]=a.maxExposure,t[4]=a.lowPct,t[5]=a.highPct,t[6]=0,t[7]=0,n.queue.writeBuffer(i,0,t)}};r(W,"_paramsScratch",new Float32Array(8));let xe=W;class Re{constructor(c,n,i,e,a,t,o){r(this,"colorAtlas");r(this,"normalAtlas");r(this,"merAtlas");r(this,"heightAtlas");r(this,"blockSize");r(this,"blockCount");r(this,"_atlasWidth");r(this,"_atlasHeight");this.colorAtlas=c,this.normalAtlas=n,this.merAtlas=i,this.heightAtlas=e,this.blockSize=a,this._atlasWidth=t,this._atlasHeight=o,this.blockCount=Math.floor(t/a)}static async load(c,n,i,e,a,t=16){async function o(y){const v=await(await fetch(y)).blob();return createImageBitmap(v,{colorSpaceConversion:"none"})}const[u,s,d,m]=await Promise.all([o(n),o(i),o(e),o(a)]),l=u.width,p=u.height,g=K.fromBitmap(c,u,{srgb:!0}),h=K.fromBitmap(c,s,{srgb:!1}),b=K.fromBitmap(c,d,{srgb:!1}),_=K.fromBitmap(c,m,{srgb:!1});return new Re(g,h,b,_,t,l,p)}uvTransform(c){const n=this.blockSize/this._atlasWidth,i=this.blockSize/this._atlasHeight;return[c*n,0,n,i]}destroy(){this.colorAtlas.destroy(),this.normalAtlas.destroy(),this.merAtlas.destroy(),this.heightAtlas.destroy()}}export{xe as A,Pe as B,Be as D,Le as P,Ge as S,we as T,Te as a,Ue as b,Se as c,Re as d,Lr as e,Or as f,Ir as g,Nr as h,Mr as m,Rr as n};
