var $=Object.defineProperty;var K=(g,f,t)=>f in g?$(g,f,{enumerable:!0,configurable:!0,writable:!0,value:t}):g[f]=t;var a=(g,f,t)=>K(g,typeof f!="symbol"?f+"":f,t);import{a as G,V as D,b as C}from"./mesh-BZCnqQH3.js";import{s as J,M as Q}from"./shadow-BSGgysNj.js";class z{constructor(f,t,r,e,i){a(this,"albedoRoughness");a(this,"normalMetallic");a(this,"depth");a(this,"albedoRoughnessView");a(this,"normalMetallicView");a(this,"depthView");a(this,"width");a(this,"height");this.albedoRoughness=f,this.normalMetallic=t,this.depth=r,this.width=e,this.height=i,this.albedoRoughnessView=f.createView(),this.normalMetallicView=t.createView(),this.depthView=r.createView()}static create(f){const{device:t,width:r,height:e}=f,i=t.createTexture({label:"GBuffer AlbedoRoughness",size:{width:r,height:e},format:"rgba8unorm",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),o=t.createTexture({label:"GBuffer NormalMetallic",size:{width:r,height:e},format:"rgba16float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),l=t.createTexture({label:"GBuffer Depth",size:{width:r,height:e},format:"depth32float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING});return new z(i,o,l,r,e)}destroy(){this.albedoRoughness.destroy(),this.normalMetallic.destroy(),this.depth.destroy()}}const P=2048,w=4;class F extends G{constructor(t,r,e,i,o,l,n,d){super();a(this,"name","ShadowPass");a(this,"shadowMap");a(this,"shadowMapView");a(this,"shadowMapArrayViews");a(this,"_pipeline");a(this,"_shadowBindGroups");a(this,"_shadowUniformBuffers");a(this,"_modelUniformBuffers",[]);a(this,"_modelBindGroups",[]);a(this,"_cascadeCount");a(this,"_cascades",[]);a(this,"_modelBGL");a(this,"_sceneSnapshot",[]);this.shadowMap=t,this.shadowMapView=r,this.shadowMapArrayViews=e,this._pipeline=i,this._shadowBindGroups=o,this._shadowUniformBuffers=l,this._modelBGL=n,this._cascadeCount=d}static create(t,r=3){const{device:e}=t,i=e.createTexture({label:"ShadowMap",size:{width:P,height:P,depthOrArrayLayers:w},format:"depth32float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),o=i.createView({dimension:"2d-array"}),l=Array.from({length:w},(p,_)=>i.createView({dimension:"2d",baseArrayLayer:_,arrayLayerCount:1})),n=e.createBindGroupLayout({label:"ShadowBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),d=e.createBindGroupLayout({label:"ModelBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),s=[],h=[];for(let p=0;p<w;p++){const _=e.createBuffer({label:`ShadowUniformBuffer ${p}`,size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});s.push(_),h.push(e.createBindGroup({label:`ShadowBindGroup ${p}`,layout:n,entries:[{binding:0,resource:{buffer:_}}]}))}const u=e.createShaderModule({label:"ShadowShader",code:J}),c=e.createRenderPipeline({label:"ShadowPipeline",layout:e.createPipelineLayout({bindGroupLayouts:[n,d]}),vertex:{module:u,entryPoint:"vs_main",buffers:[{arrayStride:C,attributes:[D[0]]}]},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less",depthBias:2,depthBiasSlopeScale:2.5,depthBiasClamp:0},primitive:{topology:"triangle-list",cullMode:"back"}});return new F(i,o,l,c,h,s,d,r)}updateScene(t,r,e,i){this._cascades=e.computeCascadeMatrices(r,i),this._cascadeCount=Math.min(this._cascades.length,w)}execute(t,r){const{device:e}=r,i=this._getMeshRenderers(r);this._ensureModelBuffers(e,i.length);for(let o=0;o<this._cascadeCount&&!(o>=this._cascades.length);o++){const l=this._cascades[o];r.queue.writeBuffer(this._shadowUniformBuffers[o],0,l.lightViewProj.data.buffer);const n=t.beginRenderPass({label:`ShadowPass cascade ${o}`,colorAttachments:[],depthStencilAttachment:{view:this.shadowMapArrayViews[o],depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"store"}});n.setPipeline(this._pipeline),n.setBindGroup(0,this._shadowBindGroups[o]);for(let d=0;d<i.length;d++){const{mesh:s,modelMatrix:h}=i[d],u=this._modelUniformBuffers[d];r.queue.writeBuffer(u,0,h.data.buffer),n.setBindGroup(1,this._modelBindGroups[d]),n.setVertexBuffer(0,s.vertexBuffer),n.setIndexBuffer(s.indexBuffer,"uint32"),n.drawIndexed(s.indexCount)}n.end()}}_getMeshRenderers(t){return this._sceneSnapshot??[]}setSceneSnapshot(t){this._sceneSnapshot=t}_ensureModelBuffers(t,r){for(;this._modelUniformBuffers.length<r;){const e=t.createBuffer({label:`ModelUniform ${this._modelUniformBuffers.length}`,size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),i=t.createBindGroup({layout:this._modelBGL,entries:[{binding:0,resource:{buffer:e}}]});this._modelUniformBuffers.push(e),this._modelBindGroups.push(i)}}destroy(){this.shadowMap.destroy();for(const t of this._shadowUniformBuffers)t.destroy();for(const t of this._modelUniformBuffers)t.destroy()}}const ee=`// Deferred PBR lighting pass — fullscreen triangle, reads GBuffer + shadow maps + IBL.
...
`,B="rgba16float",N=64*4+16+16,I=368;class O extends G{constructor(t,r,e,i,o,l,n,d,s,h,u,c,p,_,y,m,b,v){super();a(this,"name","DeferredLightingPass");a(this,"hdrTexture");a(this,"hdrView");a(this,"cameraBuffer");a(this,"lightBuffer");a(this,"_pipeline");a(this,"_sceneBindGroup");a(this,"_gbufferBindGroup");a(this,"_aoBindGroup");a(this,"_iblBindGroup");a(this,"_defaultCloudShadow");a(this,"_defaultSsgi");a(this,"_defaultIblCube");a(this,"_defaultBrdfLut");a(this,"_device");a(this,"_aoBGL");a(this,"_aoView");a(this,"_aoSampler");a(this,"_ssgiSampler");a(this,"_cameraScratch",new Float32Array(N/4));a(this,"_lightScratch",new Float32Array(I/4));a(this,"_lightScratchU",new Uint32Array(this._lightScratch.buffer));a(this,"_cloudShadowScratch",new Float32Array(3));this.hdrTexture=t,this.hdrView=r,this._pipeline=e,this._sceneBindGroup=i,this._gbufferBindGroup=o,this._aoBindGroup=l,this._iblBindGroup=n,this.cameraBuffer=d,this.lightBuffer=s,this._defaultCloudShadow=h,this._defaultSsgi=u,this._defaultIblCube=c,this._defaultBrdfLut=p,this._device=_,this._aoBGL=y,this._aoView=m,this._aoSampler=b,this._ssgiSampler=v}static create(t,r,e,i,o,l){const{device:n,width:d,height:s}=t,h=n.createTexture({label:"HDR Texture",size:{width:d,height:s},format:B,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),u=h.createView(),c=n.createBuffer({label:"LightCameraBuffer",size:N,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),p=n.createBuffer({label:"LightBuffer",size:I,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),_=n.createSampler({label:"ShadowSampler",compare:"less-equal",magFilter:"linear",minFilter:"linear"}),y=n.createSampler({label:"GBufferLinearSampler",magFilter:"linear",minFilter:"linear"}),m=n.createSampler({label:"AoSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),b=n.createSampler({label:"SsgiSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),v=n.createBindGroupLayout({label:"LightSceneBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),M=n.createBindGroupLayout({label:"LightGBufferBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth",viewDimension:"2d-array"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"comparison"}},{binding:5,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:6,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}}]}),x=n.createTexture({label:"DefaultCloudShadow",size:{width:1,height:1},format:"r8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});n.queue.writeTexture({texture:x},new Uint8Array([255]),{bytesPerRow:1},{width:1,height:1});const H=o??x.createView(),S=n.createBindGroupLayout({label:"LightAoBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),T=n.createTexture({label:"DefaultSsgi",size:{width:1,height:1},format:B,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),R=n.createBindGroupLayout({label:"LightIblBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),X=n.createSampler({label:"IblSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge"}),L=n.createTexture({label:"DefaultIblCube",size:{width:1,height:1,depthOrArrayLayers:6},format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),A=L.createView({dimension:"cube"}),U=n.createTexture({label:"DefaultBrdfLut",size:{width:1,height:1},format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),W=n.createBindGroup({label:"LightIblBG",layout:R,entries:[{binding:0,resource:(l==null?void 0:l.irradianceView)??A},{binding:1,resource:(l==null?void 0:l.prefilteredView)??A},{binding:2,resource:(l==null?void 0:l.brdfLutView)??U.createView()},{binding:3,resource:X}]}),q=n.createBindGroup({layout:v,entries:[{binding:0,resource:{buffer:c}},{binding:1,resource:{buffer:p}}]}),Z=n.createBindGroup({layout:M,entries:[{binding:0,resource:r.albedoRoughnessView},{binding:1,resource:r.normalMetallicView},{binding:2,resource:r.depthView},{binding:3,resource:e.shadowMapView},{binding:4,resource:_},{binding:5,resource:y},{binding:6,resource:H}]}),Y=n.createBindGroup({label:"LightAoBG",layout:S,entries:[{binding:0,resource:i},{binding:1,resource:m},{binding:2,resource:T.createView()},{binding:3,resource:b}]}),E=n.createShaderModule({label:"LightingShader",code:ee}),j=n.createRenderPipeline({label:"LightingPipeline",layout:n.createPipelineLayout({bindGroupLayouts:[v,M,S,R]}),vertex:{module:E,entryPoint:"vs_main"},fragment:{module:E,entryPoint:"fs_main",targets:[{format:B}]},primitive:{topology:"triangle-list"}});return new O(h,u,j,q,Z,Y,W,c,p,o?null:x,T,l?null:L,l?null:U,n,S,i,m,b)}updateSSGI(t){this._aoBindGroup=this._device.createBindGroup({label:"LightAoBG",layout:this._aoBGL,entries:[{binding:0,resource:this._aoView},{binding:1,resource:this._aoSampler},{binding:2,resource:t},{binding:3,resource:this._ssgiSampler}]})}updateCamera(t,r,e,i,o,l,n,d){const s=this._cameraScratch;s.set(r.data,0),s.set(e.data,16),s.set(i.data,32),s.set(o.data,48),s[64]=l.x,s[65]=l.y,s[66]=l.z,s[67]=n,s[68]=d,t.queue.writeBuffer(this.cameraBuffer,0,s.buffer)}updateLight(t,r,e,i,o,l=!0,n=!1,d=.02){const s=this._lightScratch,h=this._lightScratchU;let u=0;s[u++]=r.x,s[u++]=r.y,s[u++]=r.z,s[u++]=i,s[u++]=e.x,s[u++]=e.y,s[u++]=e.z,h[u++]=o.length;for(let c=0;c<4;c++)c<o.length&&s.set(o[c].lightViewProj.data,u),u+=16;for(let c=0;c<4;c++)s[u++]=c<o.length?o[c].splitFar:1e9;h[u]=l?1:0,h[u+1]=n?1:0,s[81]=d;for(let c=0;c<4;c++)s[84+c]=c<o.length?o[c].depthRange:1;for(let c=0;c<4;c++)s[88+c]=c<o.length?o[c].texelWorldSize:1;t.queue.writeBuffer(this.lightBuffer,0,s.buffer)}updateCloudShadow(t,r,e,i){const o=this._cloudShadowScratch;o[0]=r,o[1]=e,o[2]=i,t.queue.writeBuffer(this.lightBuffer,312,o.buffer)}execute(t,r){const e=t.beginRenderPass({label:"DeferredLightingPass",colorAttachments:[{view:this.hdrView,loadOp:"load",storeOp:"store"}]});e.setPipeline(this._pipeline),e.setBindGroup(0,this._sceneBindGroup),e.setBindGroup(1,this._gbufferBindGroup),e.setBindGroup(2,this._aoBindGroup),e.setBindGroup(3,this._iblBindGroup),e.draw(3),e.end()}destroy(){var t,r,e,i;this.hdrTexture.destroy(),this.cameraBuffer.destroy(),this.lightBuffer.destroy(),(t=this._defaultCloudShadow)==null||t.destroy(),(r=this._defaultSsgi)==null||r.destroy(),(e=this._defaultIblCube)==null||e.destroy(),(i=this._defaultBrdfLut)==null||i.destroy()}}const V=64*4+16+16,te=128;class k extends G{constructor(t,r,e,i,o){super();a(this,"name","GeometryPass");a(this,"_gbuffer");a(this,"_cameraBGL");a(this,"_modelBGL");a(this,"_pipelineCache",new Map);a(this,"_cameraBuffer");a(this,"_cameraBindGroup");a(this,"_modelBuffers",[]);a(this,"_modelBindGroups",[]);a(this,"_drawItems",[]);a(this,"_modelData",new Float32Array(32));a(this,"_cameraScratch",new Float32Array(V/4));this._gbuffer=t,this._cameraBGL=r,this._modelBGL=e,this._cameraBuffer=i,this._cameraBindGroup=o}static create(t,r){const{device:e}=t,i=e.createBindGroupLayout({label:"GeomCameraBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),o=e.createBindGroupLayout({label:"GeomModelBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),l=e.createBuffer({label:"GeomCameraBuffer",size:V,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),n=e.createBindGroup({label:"GeomCameraBindGroup",layout:i,entries:[{binding:0,resource:{buffer:l}}]});return new k(r,i,o,l,n)}setDrawItems(t){this._drawItems=t}updateCamera(t,r,e,i,o,l,n,d){const s=this._cameraScratch;s.set(r.data,0),s.set(e.data,16),s.set(i.data,32),s.set(o.data,48),s[64]=l.x,s[65]=l.y,s[66]=l.z,s[67]=n,s[68]=d,t.queue.writeBuffer(this._cameraBuffer,0,s.buffer)}execute(t,r){var o,l;const{device:e}=r;this._ensurePerDrawBuffers(e,this._drawItems.length);for(let n=0;n<this._drawItems.length;n++){const d=this._drawItems[n],s=this._modelData;s.set(d.modelMatrix.data,0),s.set(d.normalMatrix.data,16),r.queue.writeBuffer(this._modelBuffers[n],0,s.buffer),(l=(o=d.material).update)==null||l.call(o,r.queue)}const i=t.beginRenderPass({label:"GeometryPass",colorAttachments:[{view:this._gbuffer.albedoRoughnessView,clearValue:[0,0,0,1],loadOp:"clear",storeOp:"store"},{view:this._gbuffer.normalMetallicView,clearValue:[0,0,0,0],loadOp:"clear",storeOp:"store"}],depthStencilAttachment:{view:this._gbuffer.depthView,depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"store"}});i.setBindGroup(0,this._cameraBindGroup);for(let n=0;n<this._drawItems.length;n++){const d=this._drawItems[n];i.setPipeline(this._getPipeline(e,d.material)),i.setBindGroup(1,this._modelBindGroups[n]),i.setBindGroup(2,d.material.getBindGroup(e)),i.setVertexBuffer(0,d.mesh.vertexBuffer),i.setIndexBuffer(d.mesh.indexBuffer,"uint32"),i.drawIndexed(d.mesh.indexCount)}i.end()}_getPipeline(t,r){let e=this._pipelineCache.get(r.shaderId);if(e)return e;const i=t.createShaderModule({label:`GeometryShader[${r.shaderId}]`,code:r.getShaderCode(Q.Geometry)});return e=t.createRenderPipeline({label:`GeometryPipeline[${r.shaderId}]`,layout:t.createPipelineLayout({bindGroupLayouts:[this._cameraBGL,this._modelBGL,r.getBindGroupLayout(t)]}),vertex:{module:i,entryPoint:"vs_main",buffers:[{arrayStride:C,attributes:D}]},fragment:{module:i,entryPoint:"fs_main",targets:[{format:"rgba8unorm"},{format:"rgba16float"}]},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"back"}}),this._pipelineCache.set(r.shaderId,e),e}_ensurePerDrawBuffers(t,r){for(;this._modelBuffers.length<r;){const e=t.createBuffer({size:te,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});this._modelBuffers.push(e),this._modelBindGroups.push(t.createBindGroup({layout:this._modelBGL,entries:[{binding:0,resource:{buffer:e}}]}))}}destroy(){this._cameraBuffer.destroy();for(const t of this._modelBuffers)t.destroy()}}export{O as D,z as G,B as H,F as S,k as a};
