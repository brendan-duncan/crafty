var De=Object.defineProperty;var ze=(f,c,n)=>c in f?De(f,c,{enumerable:!0,configurable:!0,writable:!0,value:n}):f[c]=n;var t=(f,c,n)=>ze(f,typeof c!="symbol"?c+"":c,n);import{V as U,M as ne,a as H}from"./render_pass-Cg-XJLDQ.js";import{a as ye}from"./scene-hNLTj1EZ.js";import{H as T}from"./geometry_pass-BTG59YKQ.js";import{V as ke,a as He}from"./shadow-MUNhI2K-.js";import{T as K}from"./hdr_loader-BeqhBAdi.js";const Rt=""+new URL("simple_block_atlas-B-7juoTN.png",import.meta.url).href,Nt=""+new URL("simple_block_atlas_normal-BdCvGD-K.png",import.meta.url).href,Ot=""+new URL("simple_block_atlas_mer-C_Oa_Ink.png",import.meta.url).href,It=""+new URL("simple_block_atlas_heightmap-BOV6qQJl.png",import.meta.url).href,je=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],qe=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)];class Ct extends ye{constructor(){super(...arguments);t(this,"color",U.one());t(this,"intensity",1);t(this,"radius",10);t(this,"castShadow",!1)}worldPosition(){return this.gameObject.localToWorld().transformPoint(U.ZERO)}cubeFaceViewProjs(n=.05){const i=this.worldPosition(),e=ne.perspective(Math.PI/2,1,n,this.radius),a=new Array(6);for(let r=0;r<6;r++)a[r]=e.multiply(ne.lookAt(i,i.add(je[r]),qe[r]));return a}}class Ft extends ye{constructor(){super(...arguments);t(this,"color",U.one());t(this,"intensity",1);t(this,"range",20);t(this,"innerAngle",15);t(this,"outerAngle",30);t(this,"castShadow",!1);t(this,"projectionTexture",null)}worldPosition(){return this.gameObject.localToWorld().transformPoint(U.ZERO)}worldDirection(){return this.gameObject.localToWorld().transformDirection(U.FORWARD).normalize()}lightViewProj(n=.1){const i=this.worldPosition(),e=this.worldDirection(),a=Math.abs(e.y)>.99?U.RIGHT:U.UP,r=ne.lookAt(i,i.add(e),a);return ne.perspective(this.outerAngle*2*Math.PI/180,1,n,this.range).multiply(r)}}const We=`// TAA resolve pass — fullscreen triangle, blends current HDR with reprojected history.
