...
`,B="rgba16float",N=64*4+16+16,I=368;class O extends G{constructor(t,a,e,i,o,l,n,d,s,h,u,c,p,_,y,m,b,v){super();r(this,"name","DeferredLightingPass");r(this,"hdrTexture");r(this,"hdrView");r(this,"cameraBuffer");r(this,"lightBuffer");r(this,"_pipeline");r(this,"_sceneBindGroup");r(this,"_gbufferBindGroup");r(this,"_aoBindGroup");r(this,"_iblBindGroup");r(this,"_defaultCloudShadow");r(this,"_defaultSsgi");r(this,"_defaultIblCube");r(this,"_defaultBrdfLut");r(this,"_device");r(this,"_aoBGL");r(this,"_aoView");r(this,"_aoSampler");r(this,"_ssgiSampler");r(this,"_cameraScratch",new Float32Array(N/4));r(this,"_lightScratch",new Float32Array(I/4));r(this,"_lightScratchU",new Uint32Array(this._lightScratch.buffer));r(this,"_cloudShadowScratch",new Float32Array(3));this.hdrTexture=t,this.hdrView=a,this._pipeline=e,this._sceneBindGroup=i,this._gbufferBindGroup=o,this._aoBindGroup=l,this._iblBindGroup=n,this.cameraBuffer=d,this.lightBuffer=s,this._defaultCloudShadow=h,this._defaultSsgi=u,this._defaultIblCube=c,this._defaultBrdfLut=p,this._device=_,this._aoBGL=y,this._aoView=m,this._aoSampler=b,this._ssgiSampler=v}static create(t,a,e,i,o,l){const{device:n,width:d,height:s}=t,h=n.createTexture({label:"HDR Texture",size:{width:d,height:s},format:B,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),u=h.createView(),c=n.createBuffer({label:"LightCameraBuffer",size:N,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),p=n.createBuffer({label:"LightBuffer",size:I,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),_=n.createSampler({label:"ShadowSampler",compare:"less-equal",magFilter:"linear",minFilter:"linear"}),y=n.createSampler({label:"GBufferLinearSampler",magFilter:"linear",minFilter:"linear"}),m=n.createSampler({label:"AoSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),b=n.createSampler({label:"SsgiSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),v=n.createBindGroupLayout({label:"LightSceneBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),M=n.createBindGroupLayout({label:"LightGBufferBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth",viewDimension:"2d-array"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"comparison"}},{binding:5,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:6,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}}]}),x=n.createTexture({label:"DefaultCloudShadow",size:{width:1,height:1},format:"r8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});n.queue.writeTexture({texture:x},new Uint8Array([255]),{bytesPerRow:1},{width:1,height:1});const H=o??x.createView(),S=n.createBindGroupLayout({label:"LightAoBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),T=n.createTexture({label:"DefaultSsgi",size:{width:1,height:1},format:B,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),R=n.createBindGroupLayout({label:"LightIblBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),X=n.createSampler({label:"IblSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge"}),L=n.createTexture({label:"DefaultIblCube",size:{width:1,height:1,depthOrArrayLayers:6},format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),A=L.createView({dimension:"cube"}),U=n.createTexture({label:"DefaultBrdfLut",size:{width:1,height:1},format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),W=n.createBindGroup({label:"LightIblBG",layout:R,entries:[{binding:0,resource:(l==null?void 0:l.irradianceView)??A},{binding:1,resource:(l==null?void 0:l.prefilteredView)??A},{binding:2,resource:(l==null?void 0:l.brdfLutView)??U.createView()},{binding:3,resource:X}]}),q=n.createBindGroup({layout:v,entries:[{binding:0,resource:{buffer:c}},{binding:1,resource:{buffer:p}}]}),Z=n.createBindGroup({layout:M,entries:[{binding:0,resource:a.albedoRoughnessView},{binding:1,resource:a.normalMetallicView},{binding:2,resource:a.depthView},{binding:3,resource:e.shadowMapView},{binding:4,resource:_},{binding:5,resource:y},{binding:6,resource:H}]}),Y=n.createBindGroup({label:"LightAoBG",layout:S,entries:[{binding:0,resource:i},{binding:1,resource:m},{binding:2,resource:T.createView()},{binding:3,resource:b}]}),E=n.createShaderModule({label:"LightingShader",code:ee}),j=n.createRenderPipeline({label:"LightingPipeline",layout:n.createPipelineLayout({bindGroupLayouts:[v,M,S,R]}),vertex:{module:E,entryPoint:"vs_main"},fragment:{module:E,entryPoint:"fs_main",targets:[{format:B}]},primitive:{topology:"triangle-list"}});return new O(h,u,j,q,Z,Y,W,c,p,o?null:x,T,l?null:L,l?null:U,n,S,i,m,b)}updateSSGI(t){this._aoBindGroup=this._device.createBindGroup({label:"LightAoBG",layout:this._aoBGL,entries:[{binding:0,resource:this._aoView},{binding:1,resource:this._aoSampler},{binding:2,resource:t},{binding:3,resource:this._ssgiSampler}]})}updateCamera(t,a,e,i,o,l,n,d){const s=this._cameraScratch;s.set(a.data,0),s.set(e.data,16),s.set(i.data,32),s.set(o.data,48),s[64]=l.x,s[65]=l.y,s[66]=l.z,s[67]=n,s[68]=d,t.queue.writeBuffer(this.cameraBuffer,0,s.buffer)}updateLight(t,a,e,i,o,l=!0,n=!1,d=.02){const s=this._lightScratch,h=this._lightScratchU;let u=0;s[u++]=a.x,s[u++]=a.y,s[u++]=a.z,s[u++]=i,s[u++]=e.x,s[u++]=e.y,s[u++]=e.z,h[u++]=o.length;for(let c=0;c<4;c++)c<o.length&&s.set(o[c].lightViewProj.data,u),u+=16;for(let c=0;c<4;c++)s[u++]=c<o.length?o[c].splitFar:1e9;h[u]=l?1:0,h[u+1]=n?1:0,s[81]=d;for(let c=0;c<4;c++)s[84+c]=c<o.length?o[c].depthRange:1;for(let c=0;c<4;c++)s[88+c]=c<o.length?o[c].texelWorldSize:1;t.queue.writeBuffer(this.lightBuffer,0,s.buffer)}updateCloudShadow(t,a,e,i){const o=this._cloudShadowScratch;o[0]=a,o[1]=e,o[2]=i,t.queue.writeBuffer(this.lightBuffer,312,o.buffer)}execute(t,a){const e=t.beginRenderPass({label:"DeferredLightingPass",colorAttachments:[{view:this.hdrView,loadOp:"load",storeOp:"store"}]});e.setPipeline(this._pipeline),e.setBindGroup(0,this._sceneBindGroup),e.setBindGroup(1,this._gbufferBindGroup),e.setBindGroup(2,this._aoBindGroup),e.setBindGroup(3,this._iblBindGroup),e.draw(3),e.end()}destroy(){var t,a,e,i;this.hdrTexture.destroy(),this.cameraBuffer.destroy(),this.lightBuffer.destroy(),(t=this._defaultCloudShadow)==null||t.destroy(),(a=this._defaultSsgi)==null||a.destroy(),(e=this._defaultIblCube)==null||e.destroy(),(i=this._defaultBrdfLut)==null||i.destroy()}}const V=64*4+16+16,te=128;class k extends G{constructor(t,a,e,i,o){super();r(this,"name","GeometryPass");r(this,"_gbuffer");r(this,"_cameraBGL");r(this,"_modelBGL");r(this,"_pipelineCache",new Map);r(this,"_cameraBuffer");r(this,"_cameraBindGroup");r(this,"_modelBuffers",[]);r(this,"_modelBindGroups",[]);r(this,"_drawItems",[]);r(this,"_modelData",new Float32Array(32));r(this,"_cameraScratch",new Float32Array(V/4));this._gbuffer=t,this._cameraBGL=a,this._modelBGL=e,this._cameraBuffer=i,this._cameraBindGroup=o}static create(t,a){const{device:e}=t,i=e.createBindGroupLayout({label:"GeomCameraBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),o=e.createBindGroupLayout({label:"GeomModelBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),l=e.createBuffer({label:"GeomCameraBuffer",size:V,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),n=e.createBindGroup({label:"GeomCameraBindGroup",layout:i,entries:[{binding:0,resource:{buffer:l}}]});return new k(a,i,o,l,n)}setDrawItems(t){this._drawItems=t}updateCamera(t,a,e,i,o,l,n,d){const s=this._cameraScratch;s.set(a.data,0),s.set(e.data,16),s.set(i.data,32),s.set(o.data,48),s[64]=l.x,s[65]=l.y,s[66]=l.z,s[67]=n,s[68]=d,t.queue.writeBuffer(this._cameraBuffer,0,s.buffer)}execute(t,a){var o,l;const{device:e}=a;this._ensurePerDrawBuffers(e,this._drawItems.length);for(let n=0;n<this._drawItems.length;n++){const d=this._drawItems[n],s=this._modelData;s.set(d.modelMatrix.data,0),s.set(d.normalMatrix.data,16),a.queue.writeBuffer(this._modelBuffers[n],0,s.buffer),(l=(o=d.material).update)==null||l.call(o,a.queue)}const i=t.beginRenderPass({label:"GeometryPass",colorAttachments:[{view:this._gbuffer.albedoRoughnessView,clearValue:[0,0,0,1],loadOp:"clear",storeOp:"store"},{view:this._gbuffer.normalMetallicView,clearValue:[0,0,0,0],loadOp:"clear",storeOp:"store"}],depthStencilAttachment:{view:this._gbuffer.depthView,depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"store"}});i.setBindGroup(0,this._cameraBindGroup);for(let n=0;n<this._drawItems.length;n++){const d=this._drawItems[n];i.setPipeline(this._getPipeline(e,d.material)),i.setBindGroup(1,this._modelBindGroups[n]),i.setBindGroup(2,d.material.getBindGroup(e)),i.setVertexBuffer(0,d.mesh.vertexBuffer),i.setIndexBuffer(d.mesh.indexBuffer,"uint32"),i.drawIndexed(d.mesh.indexCount)}i.end()}_getPipeline(t,a){let e=this._pipelineCache.get(a.shaderId);if(e)return e;const i=t.createShaderModule({label:`GeometryShader[${a.shaderId}]`,code:a.getShaderCode(Q.Geometry)});return e=t.createRenderPipeline({label:`GeometryPipeline[${a.shaderId}]`,layout:t.createPipelineLayout({bindGroupLayouts:[this._cameraBGL,this._modelBGL,a.getBindGroupLayout(t)]}),vertex:{module:i,entryPoint:"vs_main",buffers:[{arrayStride:C,attributes:D}]},fragment:{module:i,entryPoint:"fs_main",targets:[{format:"rgba8unorm"},{format:"rgba16float"}]},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"back"}}),this._pipelineCache.set(a.shaderId,e),e}_ensurePerDrawBuffers(t,a){for(;this._modelBuffers.length<a;){const e=t.createBuffer({size:te,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});this._modelBuffers.push(e),this._modelBindGroups.push(t.createBindGroup({layout:this._modelBGL,entries:[{binding:0,resource:{buffer:e}}]}))}}destroy(){this._cameraBuffer.destroy();for(const t of this._modelBuffers)t.destroy()}}export{O as D,z as G,B as H,F as S,k as a};
