var P=Object.defineProperty;var N=(w,_,l)=>_ in w?P(w,_,{enumerable:!0,configurable:!0,writable:!0,value:l}):w[_]=l;var i=(w,_,l)=>N(w,typeof _!="symbol"?_+"":_,l);import{P as U}from"./mesh-B_UY4euz.js";const C=`// Deferred PBR lighting pass — fullscreen triangle, reads GBuffer + shadow maps + IBL.
...
// SSAO + SSGI (group 2). ao_tex/ao_samp omitted in the no-AO variant (the
// pipeline layout for that variant only declares bindings 2 and 3).
#ifdef HAS_AO
...
`,R="rgba16float",L=64*4+16+16,G=368,V="lighting:camera",F="lighting:light",I={label:"LightCameraBuffer",size:L,extraUsage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST},z={label:"LightBuffer",size:G,extraUsage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST};class E extends U{constructor(l,e,o,r,s,c,f,h,t,u,n,a,d,S,b,y,v,x,g){super();i(this,"name","DeferredLightingPass");i(this,"_pipelines");i(this,"_sceneBgl");i(this,"_gbufferBgl");i(this,"_aoBglWithAo");i(this,"_aoBglNoAo");i(this,"_iblBgl");i(this,"_comparisonSampler");i(this,"_linearSampler");i(this,"_aoSampler");i(this,"_ssgiSampler");i(this,"_iblSampler");i(this,"_defaultCloudShadow");i(this,"_defaultCloudShadowView");i(this,"_defaultSsgi");i(this,"_defaultSsgiView");i(this,"_defaultIblCube");i(this,"_defaultIblView");i(this,"_defaultBrdfLut");i(this,"_defaultBrdfLutView");i(this,"_cameraBufferRef",null);i(this,"_lightBufferRef",null);i(this,"_cameraScratch",new Float32Array(L/4));i(this,"_lightScratch",new Float32Array(G/4));i(this,"_lightScratchU",new Uint32Array(this._lightScratch.buffer));i(this,"_cloudShadowScratch",new Float32Array(3));i(this,"_pendingCamera",null);i(this,"_pendingLight",null);i(this,"_pendingCloudShadow",null);this._pipelines=l,this._sceneBgl=e,this._gbufferBgl=o,this._aoBglWithAo=r,this._aoBglNoAo=s,this._iblBgl=c,this._comparisonSampler=f,this._linearSampler=h,this._aoSampler=t,this._ssgiSampler=u,this._iblSampler=n,this._defaultCloudShadow=a,this._defaultCloudShadowView=d,this._defaultSsgi=S,this._defaultSsgiView=b,this._defaultIblCube=y,this._defaultIblView=v,this._defaultBrdfLut=x,this._defaultBrdfLutView=g}static create(l){const{device:e}=l,o=e.createSampler({label:"ShadowSampler",compare:"less-equal",magFilter:"linear",minFilter:"linear"}),r=e.createSampler({label:"GBufferLinearSampler",magFilter:"linear",minFilter:"linear"}),s=e.createSampler({label:"AoSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),c=e.createSampler({label:"SsgiSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),f=e.createSampler({label:"IblSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge"}),h=e.createBindGroupLayout({label:"LightSceneBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),t=e.createBindGroupLayout({label:"LightGBufferBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth",viewDimension:"2d-array"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"comparison"}},{binding:5,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:6,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}}]}),u=e.createBindGroupLayout({label:"LightAoBGL[withAo]",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),n=e.createBindGroupLayout({label:"LightAoBGL[noAo]",entries:[{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),a=e.createBindGroupLayout({label:"LightIblBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),d=e.createTexture({label:"DefaultCloudShadow",size:{width:1,height:1},format:"r8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});e.queue.writeTexture({texture:d},new Uint8Array([255]),{bytesPerRow:1},{width:1,height:1});const S=d.createView(),b=e.createTexture({label:"DefaultSsgi",size:{width:1,height:1},format:R,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),y=b.createView(),v=e.createTexture({label:"DefaultIblCube",size:{width:1,height:1,depthOrArrayLayers:6},format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),x=v.createView({dimension:"cube"}),g=e.createTexture({label:"DefaultBrdfLut",size:{width:1,height:1},format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),B=g.createView(),M=m=>{const A=m?{HAS_AO:"1"}:{},T=l.createShaderModule(C,`LightingShader[${m?"ao":"noAo"}]`,A);return e.createRenderPipeline({label:`LightingPipeline[${m?"ao":"noAo"}]`,layout:e.createPipelineLayout({bindGroupLayouts:[h,t,m?u:n,a]}),vertex:{module:T,entryPoint:"vs_main"},fragment:{module:T,entryPoint:"fs_main",targets:[{format:R}]},primitive:{topology:"triangle-list"}})},p=new Map([[!0,M(!0)],[!1,M(!1)]]);return new E(p,h,t,u,n,a,o,r,s,c,f,d,S,b,y,v,x,g,B)}updateCamera(l){const e=l.activeCamera;if(!e)throw new Error("DeferredLightingPass.updateCamera: ctx.activeCamera is null");const o=e.position(),r=this._cameraScratch;r.set(e.viewMatrix().data,0),r.set(e.projectionMatrix().data,16),r.set(e.viewProjectionMatrix().data,32),r.set(e.inverseViewProjectionMatrix().data,48),r[64]=o.x,r[65]=o.y,r[66]=o.z,r[67]=e.near,r[68]=e.far,this._cameraBufferRef?l.queue.writeBuffer(this._cameraBufferRef,0,r.buffer):this._pendingCamera=r.buffer.slice(0,L)}updateLight(l,e,o,r,s,c=!0,f=!1,h=.02){const t=this._lightScratch,u=this._lightScratchU;let n=0;t[n++]=e.x,t[n++]=e.y,t[n++]=e.z,t[n++]=r,t[n++]=o.x,t[n++]=o.y,t[n++]=o.z,u[n++]=s.length;for(let a=0;a<4;a++)a<s.length&&t.set(s[a].lightViewProj.data,n),n+=16;for(let a=0;a<4;a++)t[n++]=a<s.length?s[a].splitFar:1e9;u[n]=c?1:0,u[n+1]=f?1:0,t[81]=h;for(let a=0;a<4;a++)t[84+a]=a<s.length?s[a].depthRange:1;for(let a=0;a<4;a++)t[88+a]=a<s.length?s[a].texelWorldSize:1;this._lightBufferRef?l.queue.writeBuffer(this._lightBufferRef,0,t.buffer):this._pendingLight=t.buffer.slice(0,G)}updateCloudShadow(l,e,o,r){const s=this._cloudShadowScratch;s[0]=e,s[1]=o,s[2]=r,this._lightBufferRef?l.queue.writeBuffer(this._lightBufferRef,312,s.buffer):this._pendingCloudShadow=s.buffer.slice(0,12)}addToGraph(l,e){const{ctx:o}=l,r=l.importPersistentBuffer(V,I),s=l.importPersistentBuffer(F,z);let c;const f=!!e.hdr;f?c=e.hdr:c=void 0;let h;return l.addPass(this.name,"render",t=>{f||(c=t.createTexture({label:"lighting.hdr",format:R,width:o.width,height:o.height,extraUsage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC})),h=t.write(c,"attachment",{loadOp:f?"load":"clear",storeOp:"store",clearValue:[0,0,0,1]}),t.read(e.gbuffer.albedo,"sampled"),t.read(e.gbuffer.normal,"sampled"),t.read(e.gbuffer.depth,"sampled"),t.read(e.shadowMap,"sampled"),e.ao&&t.read(e.ao,"sampled"),t.read(r,"uniform"),t.read(s,"uniform"),e.cloudShadow&&t.read(e.cloudShadow,"sampled"),e.ssgi&&t.read(e.ssgi,"sampled"),t.setExecute((u,n)=>{var m,A,T;const a=n.getBuffer(r),d=n.getBuffer(s);this._cameraBufferRef!==a&&(this._cameraBufferRef=a,this._pendingCamera&&(o.queue.writeBuffer(a,0,this._pendingCamera),this._pendingCamera=null)),this._lightBufferRef!==d&&(this._lightBufferRef=d,this._pendingLight&&(o.queue.writeBuffer(d,0,this._pendingLight),this._pendingLight=null),this._pendingCloudShadow&&(o.queue.writeBuffer(d,312,this._pendingCloudShadow),this._pendingCloudShadow=null));const S=n.getOrCreateBindGroup({layout:this._sceneBgl,entries:[{binding:0,resource:{buffer:a}},{binding:1,resource:{buffer:d}}]}),b=n.getTextureView(e.shadowMap,{dimension:"2d-array"}),y=e.cloudShadow?n.getTextureView(e.cloudShadow):this._defaultCloudShadowView,v=n.getOrCreateBindGroup({layout:this._gbufferBgl,entries:[{binding:0,resource:n.getTextureView(e.gbuffer.albedo)},{binding:1,resource:n.getTextureView(e.gbuffer.normal)},{binding:2,resource:n.getTextureView(e.gbuffer.depth)},{binding:3,resource:b},{binding:4,resource:this._comparisonSampler},{binding:5,resource:this._linearSampler},{binding:6,resource:y}]}),x=e.ssgi?n.getTextureView(e.ssgi):this._defaultSsgiView,g=!!e.ao,B=n.getOrCreateBindGroup({layout:g?this._aoBglWithAo:this._aoBglNoAo,entries:g?[{binding:0,resource:n.getTextureView(e.ao)},{binding:1,resource:this._aoSampler},{binding:2,resource:x},{binding:3,resource:this._ssgiSampler}]:[{binding:2,resource:x},{binding:3,resource:this._ssgiSampler}]}),M=n.getOrCreateBindGroup({layout:this._iblBgl,entries:[{binding:0,resource:((m=e.iblTextures)==null?void 0:m.irradianceView)??this._defaultIblView},{binding:1,resource:((A=e.iblTextures)==null?void 0:A.prefilteredView)??this._defaultIblView},{binding:2,resource:((T=e.iblTextures)==null?void 0:T.brdfLutView)??this._defaultBrdfLutView},{binding:3,resource:this._iblSampler}]}),p=u.renderPassEncoder;p.setPipeline(this._pipelines.get(g)),p.setBindGroup(0,S),p.setBindGroup(1,v),p.setBindGroup(2,B),p.setBindGroup(3,M),p.draw(3)})}),{hdr:h,cameraBuffer:r,lightBuffer:s}}destroy(){this._defaultCloudShadow.destroy(),this._defaultSsgi.destroy(),this._defaultIblCube.destroy(),this._defaultBrdfLut.destroy()}}export{E as D,R as H};
