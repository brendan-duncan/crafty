var De=Object.defineProperty;var ze=(f,c,n)=>c in f?De(f,c,{enumerable:!0,configurable:!0,writable:!0,value:n}):f[c]=n;var r=(f,c,n)=>ze(f,typeof c!="symbol"?c+"":c,n);import{c as U,d as ne,a as H,V as ke,b as He}from"./mesh-BZCnqQH3.js";import{a as ye}from"./scene-CpT0uvDK.js";import{H as T}from"./geometry_pass-COZZ-SyG.js";import{T as K}from"./hdr_loader-_l8cOwn1.js";const Rr=""+new URL("simple_block_atlas-B-7juoTN.png",import.meta.url).href,Mr=""+new URL("simple_block_atlas_normal-BdCvGD-K.png",import.meta.url).href,Nr=""+new URL("simple_block_atlas_mer-C_Oa_Ink.png",import.meta.url).href,Or=""+new URL("simple_block_atlas_heightmap-BOV6qQJl.png",import.meta.url).href,je=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],qe=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)];class Ir extends ye{constructor(){super(...arguments);r(this,"color",U.one());r(this,"intensity",1);r(this,"radius",10);r(this,"castShadow",!1)}worldPosition(){return this.gameObject.localToWorld().transformPoint(U.ZERO)}cubeFaceViewProjs(n=.05){const i=this.worldPosition(),e=ne.perspective(Math.PI/2,1,n,this.radius),a=new Array(6);for(let t=0;t<6;t++)a[t]=e.multiply(ne.lookAt(i,i.add(je[t]),qe[t]));return a}}class Cr extends ye{constructor(){super(...arguments);r(this,"color",U.one());r(this,"intensity",1);r(this,"range",20);r(this,"innerAngle",15);r(this,"outerAngle",30);r(this,"castShadow",!1);r(this,"projectionTexture",null)}worldPosition(){return this.gameObject.localToWorld().transformPoint(U.ZERO)}worldDirection(){return this.gameObject.localToWorld().transformDirection(U.FORWARD).normalize()}lightViewProj(n=.1){const i=this.worldPosition(),e=this.worldDirection(),a=Math.abs(e.y)>.99?U.RIGHT:U.UP,t=ne.lookAt(i,i.add(e),a);return ne.perspective(this.outerAngle*2*Math.PI/180,1,n,this.range).multiply(t)}}const We=`// TAA resolve pass — fullscreen triangle, blends current HDR with reprojected history.\r
\r
...
\r
// 9-tap separable Gaussian, sigma ≈ 2.  Weights are normalized to sum 1.\r
...
fn fs_snow(in: VertexOutput) -> @location(0) vec4<f32> {\r
  // Soft circular disc with radial falloff from center.\r
...
//                average to 18% gray, then lerps the current exposure toward\r
...
const GRAY_LOG2     : f32 = -2.474;  // log2(0.18) — target middle-grey point\r
\r
...
fn cs_histogram(\r
  ...
  // wg_hist is zero-initialized per WGSL spec — no explicit clear needed.\r
\r
...
\r
  ...
  if (cnt == 0u) { return; }\r
\r
  // target exposure = 0.18 / avg_lum  →  in log-space: GRAY_LOG2 - avg_log\r
  let avg_log    = sum_log / f32(cnt);\r
  let target_ev  = clamp(GRAY_LOG2 - avg_log,\r
