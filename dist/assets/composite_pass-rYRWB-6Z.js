var y=Object.defineProperty;var B=(p,c,a)=>c in p?y(p,c,{enumerable:!0,configurable:!0,writable:!0,value:a}):p[c]=a;var n=(p,c,a)=>B(p,typeof c!="symbol"?c+"":c,a);import{P as x}from"./mesh-B_UY4euz.js";const w=`// Auto-exposure — two-pass histogram approach.
//
...
`,P=64,M=32,A=16,G=P*4,h={adaptSpeed:1.5,minExposure:.1,maxExposure:10,lowPct:.05,highPct:.02},E="lighting:exposure",S={label:"AutoExposureValue",size:A,extraUsage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST},d=class d extends x{constructor(a,t,r,s,e,o){super();n(this,"name","AutoExposurePass");n(this,"enabled",!0);n(this,"_device");n(this,"_bgl");n(this,"_histogramPipeline");n(this,"_adaptPipeline");n(this,"_paramsBuffer");n(this,"_histogramBuffer");n(this,"_settings",h);n(this,"_dt",0);n(this,"_exposureBufferRef",null);n(this,"_initialized",!1);n(this,"_resetScratch",new Float32Array([.1,0,0,0]));this._device=a,this._bgl=t,this._histogramPipeline=r,this._adaptPipeline=s,this._paramsBuffer=e,this._histogramBuffer=o}setFixedExposure(a){this._resetScratch[0]=a,this._exposureBufferRef&&this._device.queue.writeBuffer(this._exposureBufferRef,0,this._resetScratch)}static create(a,t=h){const{device:r}=a,s=r.createBindGroupLayout({label:"AutoExposureBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),e=r.createBuffer({label:"AutoExposureHistogram",size:G,usage:GPUBufferUsage.STORAGE}),o=r.createBuffer({label:"AutoExposureParams",size:M,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});d._writeParams(r,o,0,t);const i=r.createPipelineLayout({bindGroupLayouts:[s]}),f=a.createShaderModule(w,"AutoExposure"),u=r.createComputePipeline({label:"AutoExposureHistogramPipeline",layout:i,compute:{module:f,entryPoint:"cs_histogram"}}),l=r.createComputePipeline({label:"AutoExposureAdaptPipeline",layout:i,compute:{module:f,entryPoint:"cs_adapt"}});return new d(r,s,u,l,o,e)}update(a,t=h){this._dt=a.deltaTime,this._settings=t,d._writeParams(this._device,this._paramsBuffer,a.deltaTime,t)}addToGraph(a,t){const r=a.importPersistentBuffer(E,S);let s;return this.enabled?(a.addPass(this.name,"compute",e=>{e.read(t.hdr,"sampled"),s=e.write(r,"storage-read-write"),e.setExecute((o,i)=>{const f=i.getBuffer(r);this._exposureBufferRef!==f&&(this._exposureBufferRef=f,this._initialized=!1),this._initialized||(this._device.queue.writeBuffer(f,0,this._resetScratch),this._initialized=!0);const u=i.getTexture(t.hdr),l=i.getOrCreateBindGroup({label:"AutoExposureBG",layout:this._bgl,entries:[{binding:0,resource:i.getTextureView(t.hdr)},{binding:1,resource:{buffer:this._histogramBuffer}},{binding:2,resource:{buffer:f}},{binding:3,resource:{buffer:this._paramsBuffer}}]});d._writeParams(this._device,this._paramsBuffer,this._dt,this._settings);const _=o.computePassEncoder;_.setBindGroup(0,l),_.setPipeline(this._histogramPipeline),_.dispatchWorkgroups(Math.ceil(u.width/32),Math.ceil(u.height/32)),_.setPipeline(this._adaptPipeline),_.dispatchWorkgroups(1)})}),{exposureBuffer:s}):(a.addPass(this.name+".disabled","transfer",e=>{s=e.write(r,"copy-dst"),e.setExecute((o,i)=>{this._device.queue.writeBuffer(i.getBuffer(r),0,this._resetScratch)})}),this._initialized=!0,{exposureBuffer:s})}destroy(){this._paramsBuffer.destroy(),this._histogramBuffer.destroy()}static _writeParams(a,t,r,s){const e=d._paramsScratch;e[0]=r,e[1]=s.adaptSpeed,e[2]=s.minExposure,e[3]=s.maxExposure,e[4]=s.lowPct,e[5]=s.highPct,e[6]=0,e[7]=0,a.queue.writeBuffer(t,0,e)}};n(d,"_paramsScratch",new Float32Array(8));let g=d;const U=`// composite.wgsl — Fog + Underwater + Tonemap merged into a single full-screen draw.
...
`,m=64,v=96;class b extends x{constructor(a,t,r,s,e,o,i){super();n(this,"name","CompositePass");n(this,"depthFogEnabled",!0);n(this,"depthDensity",1);n(this,"depthBegin",32);n(this,"depthEnd",128);n(this,"depthCurve",1.5);n(this,"heightFogEnabled",!1);n(this,"heightDensity",.7);n(this,"heightMin",48);n(this,"heightMax",80);n(this,"heightCurve",1);n(this,"fogColor",[1,1,1]);n(this,"_pipeline");n(this,"_texturesBgl");n(this,"_bufBgl");n(this,"_paramsBgl");n(this,"_paramsBuf");n(this,"_starBuf");n(this,"_sampler");n(this,"_paramsAB",new ArrayBuffer(m));n(this,"_paramsF",new Float32Array(this._paramsAB));n(this,"_paramsU",new Uint32Array(this._paramsAB));n(this,"_starScratch",new Float32Array(v/4));this._pipeline=a,this._texturesBgl=t,this._bufBgl=r,this._paramsBgl=s,this._paramsBuf=e,this._starBuf=o,this._sampler=i}static create(a){const{device:t,format:r}=a,s=t.createBindGroupLayout({label:"CompositeBGL0",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),e=t.createBindGroupLayout({label:"CompositeBGL1",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),o=t.createBindGroupLayout({label:"CompositeBGL2",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}}]}),i=t.createSampler({label:"CompositeSampler",magFilter:"linear",minFilter:"linear"}),f=t.createBuffer({label:"CompositeParams",size:m,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),u=t.createBuffer({label:"CompositeStars",size:v,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),l=a.createShaderModule(U,"CompositeShader"),_=t.createRenderPipeline({label:"CompositePipeline",layout:t.createPipelineLayout({bindGroupLayouts:[s,e,o]}),vertex:{module:l,entryPoint:"vs_main"},fragment:{module:l,entryPoint:"fs_main",targets:[{format:r}]},primitive:{topology:"triangle-list"}});return new b(_,s,e,o,f,u,i)}updateParams(a,t,r,s,e,o){const i=this._paramsF,f=this._paramsU;let u=0;this.depthFogEnabled&&(u|=1),this.heightFogEnabled&&(u|=2);let l=0;s&&(l|=1),e&&(l|=2),o&&(l|=4),i[0]=this.fogColor[0],i[1]=this.fogColor[1],i[2]=this.fogColor[2],i[3]=this.depthDensity,i[4]=this.depthBegin,i[5]=this.depthEnd,i[6]=this.depthCurve,i[7]=this.heightDensity,i[8]=this.heightMin,i[9]=this.heightMax,i[10]=this.heightCurve,f[11]=u,i[12]=r,i[13]=t?1:0,f[14]=l,i[15]=0,a.queue.writeBuffer(this._paramsBuf,0,this._paramsAB)}updateStars(a,t,r,s){const e=this._starScratch;e.set(t.data,0),e[16]=r.x,e[17]=r.y,e[18]=r.z,e[19]=0,e[20]=s.x,e[21]=s.y,e[22]=s.z,e[23]=0,a.queue.writeBuffer(this._starBuf,0,e.buffer)}addToGraph(a,t){a.addPass(this.name,"render",r=>{r.read(t.input,"sampled"),r.read(t.ao,"sampled"),r.read(t.depth,"sampled"),r.read(t.cameraBuffer,"uniform"),r.read(t.lightBuffer,"uniform"),r.read(t.exposureBuffer,"storage-read"),r.write(t.backbuffer,"attachment",{loadOp:"clear",storeOp:"store",clearValue:[0,0,0,1]}),r.setExecute((s,e)=>{const o=e.getOrCreateBindGroup({label:"CompositeBG0",layout:this._texturesBgl,entries:[{binding:0,resource:e.getTextureView(t.input)},{binding:1,resource:e.getTextureView(t.ao)},{binding:2,resource:e.getTextureView(t.depth)},{binding:3,resource:this._sampler}]}),i=e.getOrCreateBindGroup({label:"CompositeBG1",layout:this._bufBgl,entries:[{binding:0,resource:{buffer:e.getBuffer(t.cameraBuffer)}},{binding:1,resource:{buffer:e.getBuffer(t.lightBuffer)}}]}),f=e.getOrCreateBindGroup({label:"CompositeBG2",layout:this._paramsBgl,entries:[{binding:0,resource:{buffer:this._paramsBuf}},{binding:1,resource:{buffer:this._starBuf}},{binding:2,resource:{buffer:e.getBuffer(t.exposureBuffer)}}]}),u=s.renderPassEncoder;u.setPipeline(this._pipeline),u.setBindGroup(0,o),u.setBindGroup(1,i),u.setBindGroup(2,f),u.draw(3)})})}destroy(){this._paramsBuf.destroy(),this._starBuf.destroy()}}export{g as A,b as C};
