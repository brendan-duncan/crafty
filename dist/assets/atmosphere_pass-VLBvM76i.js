var m=Object.defineProperty;var v=(u,o,n)=>o in u?m(u,o,{enumerable:!0,configurable:!0,writable:!0,value:n}):u[o]=n;var s=(u,o,n)=>v(u,typeof o!="symbol"?o+"":o,n);import{a as _}from"./mesh-BK4JnZ1v.js";import{H as y}from"./deferred_lighting_pass-BBq3Yn03.js";const g=`// Physically based single-scattering atmosphere (Rayleigh + Mie).
...
`,l=96;class d extends _{constructor(n,a,e,t,r){super();s(this,"name","AtmospherePass");s(this,"_pipeline");s(this,"_uniformBuf");s(this,"_bg");s(this,"_output",null);s(this,"_scratch",new Float32Array(l/4));s(this,"_load");this._pipeline=n,this._uniformBuf=a,this._bg=e,this._output=t,this._load=r}static create(n,a){const{device:e}=n,{output:t,load:r}=a,c=e.createBuffer({label:"AtmosphereUniform",size:l,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),i=e.createBindGroupLayout({label:"AtmosphereBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),h=e.createBindGroup({label:"AtmosphereBG",layout:i,entries:[{binding:0,resource:{buffer:c}}]}),f=n.createShaderModule(g,"AtmosphereShader"),p=e.createRenderPipeline({label:"AtmospherePipeline",layout:e.createPipelineLayout({bindGroupLayouts:[i]}),vertex:{module:f,entryPoint:"vs_main"},fragment:{module:f,entryPoint:"fs_main",targets:[{format:y}]},primitive:{topology:"triangle-list"}});return new d(p,c,h,t??null,r??"clear")}setOutput(n){this._output=n}update(n,a,e,t){const r=this._scratch;r.set(a.data,0),r[16]=e.x,r[17]=e.y,r[18]=e.z;const c=Math.sqrt(t.x*t.x+t.y*t.y+t.z*t.z),i=c>0?1/c:0;r[20]=-t.x*i,r[21]=-t.y*i,r[22]=-t.z*i,n.queue.writeBuffer(this._uniformBuf,0,r.buffer)}execute(n,a){if(this._output===null)throw new Error("AtmospherePass: output texture view not set");const e=n.beginRenderPass({label:"AtmospherePass",colorAttachments:[{view:this._output,clearValue:[0,0,0,1],loadOp:this._load,storeOp:"store"}]});e.setPipeline(this._pipeline),e.setBindGroup(0,this._bg),e.draw(3),e.end()}destroy(){this._uniformBuf.destroy()}}export{d as A};
