var u=Object.defineProperty;var c=(r,t,o)=>t in r?u(r,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):r[t]=o;var e=(r,t,o)=>c(r,typeof t!="symbol"?t+"":t,o);import{f,V as n,M as d}from"./mesh-QCRC26ja.js";const p=[new n(1,0,0),new n(-1,0,0),new n(0,1,0),new n(0,-1,0),new n(0,0,1),new n(0,0,-1)],v=[new n(0,-1,0),new n(0,-1,0),new n(0,0,1),new n(0,0,-1),new n(0,-1,0),new n(0,-1,0)];class _ extends f{constructor(){super(...arguments);e(this,"color",n.one());e(this,"intensity",1);e(this,"radius",10);e(this,"castShadow",!1)}worldPosition(){return this.gameObject.localToWorld().transformPoint(n.ZERO)}cubeFaceViewProjs(o=.05){const i=this.worldPosition(),a=d.perspective(Math.PI/2,1,o,this.radius),l=new Array(6);for(let s=0;s<6;s++)l[s]=a.multiply(d.lookAt(i,i.add(p[s]),v[s]));return l}}class x extends f{constructor(){super(...arguments);e(this,"color",n.one());e(this,"intensity",1);e(this,"range",20);e(this,"innerAngle",15);e(this,"outerAngle",30);e(this,"castShadow",!1);e(this,"projectionTexture",null)}worldPosition(){return this.gameObject.localToWorld().transformPoint(n.ZERO)}worldDirection(){return this.gameObject.localToWorld().transformDirection(n.FORWARD).normalize()}lightViewProj(o=.1){const i=this.worldPosition(),a=this.worldDirection(),l=Math.abs(a.y)>.99?n.RIGHT:n.UP,s=d.lookAt(i,i.add(a),l);return d.perspective(this.outerAngle*2*Math.PI/180,1,o,this.range).multiply(s)}}const w=`// SSAO: hemisphere sampling in view space.
...
`,b=`// SSAO blur: separable bilateral depth-aware Gaussian blur.
...
`,y=`// VSM shadow map generation for point and spot lights.
//
...
`,V=`// Additive deferred pass for point and spot lights.
...
`;export{_ as P,x as S,w as a,b,V as l,y as s};
