var De=Object.defineProperty;var ze=(f,c,r)=>c in f?De(f,c,{enumerable:!0,configurable:!0,writable:!0,value:r}):f[c]=r;var t=(f,c,r)=>ze(f,typeof c!="symbol"?c+"":c,r);import{V as U,M as ne,a as H,c as ke,d as He}from"./mesh-BK4JnZ1v.js";import{a as ye}from"./scene-BC1pedt7.js";import{H as T}from"./deferred_lighting_pass-BBq3Yn03.js";import{T as K}from"./hdr_loader-BebuUkhF.js";const Mt=""+new URL("simple_block_atlas-B-7juoTN.png",import.meta.url).href,Rt=""+new URL("simple_block_atlas_normal-BdCvGD-K.png",import.meta.url).href,Nt=""+new URL("simple_block_atlas_mer-C_Oa_Ink.png",import.meta.url).href,Ot=""+new URL("simple_block_atlas_heightmap-BOV6qQJl.png",import.meta.url).href,je=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],qe=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)];class It extends ye{constructor(){super(...arguments);t(this,"color",U.one());t(this,"intensity",1);t(this,"radius",10);t(this,"castShadow",!1)}worldPosition(){return this.gameObject.localToWorld().transformPoint(U.ZERO)}cubeFaceViewProjs(r=.05){const i=this.worldPosition(),e=ne.perspective(Math.PI/2,1,r,this.radius),a=new Array(6);for(let n=0;n<6;n++)a[n]=e.multiply(ne.lookAt(i,i.add(je[n]),qe[n]));return a}}class Ct extends ye{constructor(){super(...arguments);t(this,"color",U.one());t(this,"intensity",1);t(this,"range",20);t(this,"innerAngle",15);t(this,"outerAngle",30);t(this,"castShadow",!1);t(this,"projectionTexture",null)}worldPosition(){return this.gameObject.localToWorld().transformPoint(U.ZERO)}worldDirection(){return this.gameObject.localToWorld().transformDirection(U.FORWARD).normalize()}lightViewProj(r=.1){const i=this.worldPosition(),e=this.worldDirection(),a=Math.abs(e.y)>.99?U.RIGHT:U.UP,n=ne.lookAt(i,i.add(e),a);return ne.perspective(this.outerAngle*2*Math.PI/180,1,r,this.range).multiply(n)}}const We=`// TAA resolve pass — fullscreen triangle, blends current HDR with reprojected history.
...
`,ue=128;class we extends H{constructor(r,i,e,a,n,o,u,s,d,m){super();t(this,"name","TAAPass");t(this,"_resolved");t(this,"resolvedView");t(this,"_history");t(this,"_historyView");t(this,"_pipeline");t(this,"_uniformBuffer");t(this,"_uniformBG");t(this,"_textureBG");t(this,"_width");t(this,"_height");t(this,"_scratch",new Float32Array(ue/4));this._resolved=r,this.resolvedView=i,this._history=e,this._historyView=a,this._pipeline=n,this._uniformBuffer=o,this._uniformBG=u,this._textureBG=s,this._width=d,this._height=m}get historyView(){return this._historyView}static create(r,i,e){const{device:a,width:n,height:o}=r,u=a.createTexture({label:"TAA Resolved",size:{width:n,height:o},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),s=a.createTexture({label:"TAA History",size:{width:n,height:o},format:T,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),d=u.createView(),m=s.createView(),l=a.createBuffer({label:"TAAUniformBuffer",size:ue,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),p=a.createBindGroupLayout({label:"TAAUniformBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),g=a.createBindGroupLayout({label:"TAATextureBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),h=a.createSampler({label:"TAALinearSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),b=a.createBindGroup({layout:p,entries:[{binding:0,resource:{buffer:l}}]}),_=a.createBindGroup({layout:g,entries:[{binding:0,resource:i.outputView},{binding:1,resource:m},{binding:2,resource:e.depthView},{binding:3,resource:h}]}),y=r.createShaderModule(We,"TAAShader"),v=a.createRenderPipeline({label:"TAAPipeline",layout:a.createPipelineLayout({bindGroupLayouts:[p,g]}),vertex:{module:y,entryPoint:"vs_main"},fragment:{module:y,entryPoint:"fs_main",targets:[{format:T}]},primitive:{topology:"triangle-list"}});return new we(u,d,s,m,v,l,b,_,n,o)}updateCamera(r,i,e){const a=this._scratch;a.set(i.data,0),a.set(e.data,16),r.queue.writeBuffer(this._uniformBuffer,0,a.buffer)}execute(r,i){const e=r.beginRenderPass({label:"TAAPass",colorAttachments:[{view:this.resolvedView,clearValue:[0,0,0,1],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._pipeline),e.setBindGroup(0,this._uniformBG),e.setBindGroup(1,this._textureBG),e.draw(3),e.end(),r.copyTextureToTexture({texture:this._resolved},{texture:this._history},{width:this._width,height:this._height})}destroy(){this._resolved.destroy(),this._history.destroy(),this._uniformBuffer.destroy()}}const $e=`// Bloom: prefilter (downsample + threshold) and separable Gaussian blur.
...
`,J="r8unorm",se=16,et=464;function tt(){const f=new Float32Array(se*4);for(let c=0;c<se;c++){const r=Math.random(),i=Math.random()*Math.PI*2,e=Math.sqrt(1-r*r),a=.1+.9*(c/se)**2;f[c*4+0]=e*Math.cos(i)*a,f[c*4+1]=e*Math.sin(i)*a,f[c*4+2]=r*a,f[c*4+3]=0}return f}function rt(){const f=new Uint8Array(64);for(let c=0;c<16;c++){const r=Math.random()*Math.PI*2;f[c*4+0]=Math.round((Math.cos(r)*.5+.5)*255),f[c*4+1]=Math.round((Math.sin(r)*.5+.5)*255),f[c*4+2]=128,f[c*4+3]=255}return f}class Ge extends H{constructor(r,i,e,a,n,o,u,s,d,m,l){super();t(this,"name","SSAOPass");t(this,"aoView");t(this,"_raw");t(this,"_blurred");t(this,"_rawView");t(this,"_ssaoPipeline");t(this,"_blurPipeline");t(this,"_uniformBuffer");t(this,"_noiseTex");t(this,"_cameraScratch",new Float32Array(48));t(this,"_paramsScratch",new Float32Array(4));t(this,"_ssaoBG0");t(this,"_ssaoBG1");t(this,"_blurBG");this._raw=r,this._rawView=i,this._blurred=e,this.aoView=a,this._ssaoPipeline=n,this._blurPipeline=o,this._uniformBuffer=u,this._noiseTex=s,this._ssaoBG0=d,this._ssaoBG1=m,this._blurBG=l}static create(r,i){const{device:e,width:a,height:n}=r,o=Math.max(1,a>>1),u=Math.max(1,n>>1),s=e.createTexture({label:"SsaoRaw",size:{width:o,height:u},format:J,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),d=e.createTexture({label:"SsaoBlurred",size:{width:o,height:u},format:J,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),m=s.createView(),l=d.createView(),p=e.createTexture({label:"SsaoNoise",size:{width:4,height:4},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});e.queue.writeTexture({texture:p},rt().buffer,{bytesPerRow:4*4,rowsPerImage:4},{width:4,height:4});const g=p.createView(),h=e.createBuffer({label:"SsaoUniforms",size:et,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});e.queue.writeBuffer(h,208,tt().buffer),e.queue.writeBuffer(h,192,new Float32Array([1,.005,2,0]).buffer);const b=e.createSampler({label:"SsaoBlurSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),_=e.createBindGroupLayout({label:"SsaoBGL0",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),y=e.createBindGroupLayout({label:"SsaoBGL1",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}}]}),v=e.createBindGroupLayout({label:"SsaoBlurBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),P=r.createShaderModule(Je,"SsaoShader"),B=r.createShaderModule(Qe,"SsaoBlurShader"),G=e.createRenderPipeline({label:"SsaoPipeline",layout:e.createPipelineLayout({bindGroupLayouts:[_,y]}),vertex:{module:P,entryPoint:"vs_main"},fragment:{module:P,entryPoint:"fs_ssao",targets:[{format:J}]},primitive:{topology:"triangle-list"}}),x=e.createRenderPipeline({label:"SsaoBlurPipeline",layout:e.createPipelineLayout({bindGroupLayouts:[v]}),vertex:{module:B,entryPoint:"vs_main"},fragment:{module:B,entryPoint:"fs_blur",targets:[{format:J}]},primitive:{topology:"triangle-list"}}),S=e.createBindGroup({label:"SsaoBG0",layout:_,entries:[{binding:0,resource:{buffer:h}}]}),E=e.createBindGroup({label:"SsaoBG1",layout:y,entries:[{binding:0,resource:i.normalMetallicView},{binding:1,resource:i.depthView},{binding:2,resource:g}]}),V=e.createBindGroup({label:"SsaoBlurBG",layout:v,entries:[{binding:0,resource:m},{binding:1,resource:b}]});return new Ge(s,m,d,l,G,x,h,p,S,E,V)}updateCamera(r,i,e,a){const n=this._cameraScratch;n.set(i.data,0),n.set(e.data,16),n.set(a.data,32),r.device.queue.writeBuffer(this._uniformBuffer,0,n.buffer)}updateParams(r,i=1,e=.005,a=2){this._paramsScratch[0]=i,this._paramsScratch[1]=e,this._paramsScratch[2]=a,this._paramsScratch[3]=0,r.device.queue.writeBuffer(this._uniformBuffer,192,this._paramsScratch.buffer)}execute(r,i){{const e=r.beginRenderPass({label:"SSAOPass",colorAttachments:[{view:this._rawView,clearValue:[1,0,0,1],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._ssaoPipeline),e.setBindGroup(0,this._ssaoBG0),e.setBindGroup(1,this._ssaoBG1),e.draw(3),e.end()}{const e=r.beginRenderPass({label:"SSAOBlur",colorAttachments:[{view:this.aoView,clearValue:[1,0,0,1],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._blurPipeline),e.setBindGroup(0,this._blurBG),e.draw(3),e.end()}}destroy(){this._raw.destroy(),this._blurred.destroy(),this._uniformBuffer.destroy(),this._noiseTex.destroy()}}const nt=`// Screen-Space Global Illumination — ray march pass.
...
`,ce=368,at={numRays:4,numSteps:16,radius:3,thickness:.5,strength:1};function st(){const f=new Uint8Array(new ArrayBuffer(64));for(let c=0;c<16;c++){const r=Math.random()*Math.PI*2;f[c*4+0]=Math.round((Math.cos(r)*.5+.5)*255),f[c*4+1]=Math.round((Math.sin(r)*.5+.5)*255),f[c*4+2]=128,f[c*4+3]=255}return f}class Se extends H{constructor(r,i,e,a,n,o,u,s,d,m,l,p,g,h,b,_){super();t(this,"name","SSGIPass");t(this,"resultView");t(this,"_uniformBuffer");t(this,"_noiseTexture");t(this,"_rawTexture");t(this,"_rawView");t(this,"_historyTexture");t(this,"_resultTexture");t(this,"_ssgiPipeline");t(this,"_temporalPipeline");t(this,"_ssgiBG0");t(this,"_ssgiBG1");t(this,"_tempBG0");t(this,"_tempBG1");t(this,"_settings");t(this,"_frameIndex",0);t(this,"_scratch",new Float32Array(ce/4));t(this,"_scratchU32",new Uint32Array(this._scratch.buffer));t(this,"_width");t(this,"_height");this._uniformBuffer=r,this._noiseTexture=i,this._rawTexture=e,this._rawView=a,this._historyTexture=n,this._resultTexture=o,this.resultView=u,this._ssgiPipeline=s,this._temporalPipeline=d,this._ssgiBG0=m,this._ssgiBG1=l,this._tempBG0=p,this._tempBG1=g,this._settings=h,this._width=b,this._height=_}static create(r,i,e,a=at){const{device:n,width:o,height:u}=r,s=n.createBuffer({label:"SSGIUniforms",size:ce,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),d=n.createTexture({label:"SSGINoise",size:{width:4,height:4},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});n.queue.writeTexture({texture:d},st(),{bytesPerRow:4*4,rowsPerImage:4},{width:4,height:4});const m=d.createView(),l=n.createTexture({label:"SSGIRaw",size:{width:o,height:u},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),p=l.createView(),g=n.createTexture({label:"SSGIHistory",size:{width:o,height:u},format:T,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),h=g.createView(),b=n.createTexture({label:"SSGIResult",size:{width:o,height:u},format:T,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),_=b.createView(),y=n.createSampler({label:"SSGILinearSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),v=n.createBindGroupLayout({label:"SSGIUniformBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),P=n.createBindGroupLayout({label:"SSGITexBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),B=n.createBindGroupLayout({label:"SSGITempTexBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),G=n.createBindGroup({label:"SSGIUniformBG",layout:v,entries:[{binding:0,resource:{buffer:s}}]}),x=n.createBindGroup({label:"SSGITexBG",layout:P,entries:[{binding:0,resource:i.depthView},{binding:1,resource:i.normalMetallicView},{binding:2,resource:e},{binding:3,resource:m},{binding:4,resource:y}]}),S=n.createBindGroup({label:"SSGITempUniformBG",layout:v,entries:[{binding:0,resource:{buffer:s}}]}),E=n.createBindGroup({label:"SSGITempTexBG",layout:B,entries:[{binding:0,resource:p},{binding:1,resource:h},{binding:2,resource:i.depthView},{binding:3,resource:y}]}),V=r.createShaderModule(nt,"SSGIShader"),L=r.createShaderModule(it,"SSGITempShader"),R=n.createRenderPipeline({label:"SSGIPipeline",layout:n.createPipelineLayout({bindGroupLayouts:[v,P]}),vertex:{module:V,entryPoint:"vs_main"},fragment:{module:V,entryPoint:"fs_ssgi",targets:[{format:T}]},primitive:{topology:"triangle-list"}}),N=n.createRenderPipeline({label:"SSGITempPipeline",layout:n.createPipelineLayout({bindGroupLayouts:[v,B]}),vertex:{module:L,entryPoint:"vs_main"},fragment:{module:L,entryPoint:"fs_temporal",targets:[{format:T}]},primitive:{topology:"triangle-list"}});return new Se(s,d,l,p,g,b,_,R,N,G,x,S,E,a,o,u)}updateCamera(r,i,e,a,n,o,u){const s=this._scratch;s.set(i.data,0),s.set(e.data,16),s.set(a.data,32),s.set(n.data,48),s.set(o.data,64),s[80]=u.x,s[81]=u.y,s[82]=u.z;const d=this._scratchU32;d[83]=this._settings.numRays,d[84]=this._settings.numSteps,s[85]=this._settings.radius,s[86]=this._settings.thickness,s[87]=this._settings.strength,d[88]=this._frameIndex++,r.queue.writeBuffer(this._uniformBuffer,0,s.buffer)}updateSettings(r){this._settings={...this._settings,...r}}execute(r,i){{const e=r.beginRenderPass({label:"SSGIRayMarch",colorAttachments:[{view:this._rawView,clearValue:[0,0,0,0],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._ssgiPipeline),e.setBindGroup(0,this._ssgiBG0),e.setBindGroup(1,this._ssgiBG1),e.draw(3),e.end()}{const e=r.beginRenderPass({label:"SSGITemporal",colorAttachments:[{view:this.resultView,clearValue:[0,0,0,0],loadOp:"clear",storeOp:"store"}]});e.setPipeline(this._temporalPipeline),e.setBindGroup(0,this._tempBG0),e.setBindGroup(1,this._tempBG1),e.draw(3),e.end()}r.copyTextureToTexture({texture:this._resultTexture},{texture:this._historyTexture},{width:this._width,height:this._height})}destroy(){this._uniformBuffer.destroy(),this._noiseTexture.destroy(),this._rawTexture.destroy(),this._historyTexture.destroy(),this._resultTexture.destroy()}}const ot=`// VSM shadow map generation for point and spot lights.
//
...
`,Q=32,ee=32,$=4,j=8,te=256,re=512,D=256,de=80,lt=64,ut=6*$,ct=ut+j;class Ue extends H{constructor(r,i,e,a,n,o,u,s,d,m,l,p,g,h){super();t(this,"name","PointSpotShadowPass");t(this,"pointVsmView");t(this,"spotVsmView");t(this,"projTexView");t(this,"_pointVsmTex");t(this,"_spotVsmTex");t(this,"_projTexArray");t(this,"_pointDepth");t(this,"_spotDepth");t(this,"_pointFaceViews");t(this,"_spotFaceViews");t(this,"_pointDepthView");t(this,"_spotDepthView");t(this,"_pointPipeline");t(this,"_spotPipeline");t(this,"_shadowBufs");t(this,"_shadowBGs");t(this,"_modelBufs",[]);t(this,"_modelBGs",[]);t(this,"_modelBGL");t(this,"_shadowScratch",new Float32Array(de/4));t(this,"_snapshot",[]);t(this,"_pointLights",[]);t(this,"_spotLights",[]);this._pointVsmTex=r,this._spotVsmTex=i,this._projTexArray=e,this._pointDepth=a,this._spotDepth=n,this._pointFaceViews=o,this._spotFaceViews=u,this._pointDepthView=s,this._spotDepthView=d,this._pointPipeline=m,this._spotPipeline=l,this._shadowBufs=p,this._shadowBGs=g,this._modelBGL=h,this.pointVsmView=r.createView({dimension:"cube-array",arrayLayerCount:$*6}),this.spotVsmView=i.createView({dimension:"2d-array"}),this.projTexView=e.createView({dimension:"2d-array"})}static create(r){const{device:i}=r,e=i.createTexture({label:"PointVSM",size:{width:te,height:te,depthOrArrayLayers:$*6},format:"rgba16float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),a=i.createTexture({label:"SpotVSM",size:{width:re,height:re,depthOrArrayLayers:j},format:"rgba16float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),n=i.createTexture({label:"ProjTexArray",size:{width:D,height:D,depthOrArrayLayers:j},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),o=new Uint8Array(D*D*4).fill(255);for(let x=0;x<j;x++)i.queue.writeTexture({texture:n,origin:{x:0,y:0,z:x}},o,{bytesPerRow:D*4,rowsPerImage:D},{width:D,height:D,depthOrArrayLayers:1});const u=i.createTexture({label:"PointShadowDepth",size:{width:te,height:te},format:"depth32float",usage:GPUTextureUsage.RENDER_ATTACHMENT}),s=i.createTexture({label:"SpotShadowDepth",size:{width:re,height:re},format:"depth32float",usage:GPUTextureUsage.RENDER_ATTACHMENT}),d=Array.from({length:$*6},(x,S)=>e.createView({dimension:"2d",baseArrayLayer:S,arrayLayerCount:1})),m=Array.from({length:j},(x,S)=>a.createView({dimension:"2d",baseArrayLayer:S,arrayLayerCount:1})),l=u.createView(),p=s.createView(),g=i.createBindGroupLayout({label:"PSShadowBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),h=i.createBindGroupLayout({label:"PSModelBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),b=[],_=[];for(let x=0;x<ct;x++){const S=i.createBuffer({label:`PSShadowUniform ${x}`,size:de,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});b.push(S),_.push(i.createBindGroup({label:`PSShadowBG ${x}`,layout:g,entries:[{binding:0,resource:{buffer:S}}]}))}const y=i.createPipelineLayout({bindGroupLayouts:[g,h]}),v=r.createShaderModule(ot,"PointSpotShadowShader"),P={module:v,buffers:[{arrayStride:He,attributes:[ke[0]]}]},B=i.createRenderPipeline({label:"PointShadowPipeline",layout:y,vertex:{...P,entryPoint:"vs_point"},fragment:{module:v,entryPoint:"fs_point",targets:[{format:"rgba16float"}]},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"back"}}),G=i.createRenderPipeline({label:"SpotShadowPipeline",layout:y,vertex:{...P,entryPoint:"vs_spot"},fragment:{module:v,entryPoint:"fs_spot",targets:[{format:"rgba16float"}]},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"back"}});return new Ue(e,a,n,u,s,d,m,l,p,B,G,b,_,h)}update(r,i,e){this._pointLights=r,this._spotLights=i,this._snapshot=e}setProjectionTexture(r,i,e){r.copyTextureToTexture({texture:e},{texture:this._projTexArray,origin:{x:0,y:0,z:i}},{width:D,height:D,depthOrArrayLayers:1})}execute(r,i){const{device:e}=i,a=this._snapshot;this._ensureModelBuffers(e,a.length);for(let s=0;s<this._spotLights.length&&s<j;s++){const d=this._spotLights[s];d.projectionTexture&&this.setProjectionTexture(r,s,d.projectionTexture)}for(let s=0;s<a.length;s++)i.queue.writeBuffer(this._modelBufs[s],0,a[s].modelMatrix.data.buffer);let n=0,o=0;for(const s of this._pointLights){if(!s.castShadow||o>=$)continue;const d=s.worldPosition(),m=s.cubeFaceViewProjs(),l=this._shadowScratch;l[16]=d.x,l[17]=d.y,l[18]=d.z,l[19]=s.radius;for(let p=0;p<6;p++){l.set(m[p].data,0),i.queue.writeBuffer(this._shadowBufs[n],0,l.buffer);const g=o*6+p,h=r.beginRenderPass({label:`PointShadow light${o} face${p}`,colorAttachments:[{view:this._pointFaceViews[g],clearValue:{r:1,g:1,b:0,a:1},loadOp:"clear",storeOp:"store"}],depthStencilAttachment:{view:this._pointDepthView,depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"discard"}});h.setPipeline(this._pointPipeline),h.setBindGroup(0,this._shadowBGs[n]),this._drawItems(h,a),h.end(),n++}o++}let u=0;for(const s of this._spotLights){if(!s.castShadow||u>=j)continue;const d=s.lightViewProj(),m=s.worldPosition(),l=this._shadowScratch;l.set(d.data,0),l[16]=m.x,l[17]=m.y,l[18]=m.z,l[19]=s.range,i.queue.writeBuffer(this._shadowBufs[n],0,l.buffer);const p=r.beginRenderPass({label:`SpotShadow light${u}`,colorAttachments:[{view:this._spotFaceViews[u],clearValue:{r:1,g:1,b:0,a:1},loadOp:"clear",storeOp:"store"}],depthStencilAttachment:{view:this._spotDepthView,depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"discard"}});p.setPipeline(this._spotPipeline),p.setBindGroup(0,this._shadowBGs[n]),this._drawItems(p,a),p.end(),n++,u++}}_drawItems(r,i){for(let e=0;e<i.length;e++){const{mesh:a}=i[e];r.setBindGroup(1,this._modelBGs[e]),r.setVertexBuffer(0,a.vertexBuffer),r.setIndexBuffer(a.indexBuffer,"uint32"),r.drawIndexed(a.indexCount)}}_ensureModelBuffers(r,i){for(;this._modelBufs.length<i;){const e=r.createBuffer({label:`PSModelUniform ${this._modelBufs.length}`,size:lt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});this._modelBufs.push(e),this._modelBGs.push(r.createBindGroup({layout:this._modelBGL,entries:[{binding:0,resource:{buffer:e}}]}))}}destroy(){this._pointVsmTex.destroy(),this._spotVsmTex.destroy(),this._projTexArray.destroy(),this._pointDepth.destroy(),this._spotDepth.destroy();for(const r of this._shadowBufs)r.destroy();for(const r of this._modelBufs)r.destroy()}}const dt=`// Additive deferred pass for point and spot lights.
...
`,pe=64*4+16+16,pt=8,fe=48,he=128;class Te extends H{constructor(r,i,e,a,n,o,u,s,d,m){super();t(this,"name","PointSpotLightPass");t(this,"_pipeline");t(this,"_cameraBG");t(this,"_gbufferBG");t(this,"_lightBG");t(this,"_shadowBG");t(this,"_cameraBuffer");t(this,"_lightCountsBuffer");t(this,"_pointBuffer");t(this,"_spotBuffer");t(this,"_hdrView");t(this,"_cameraData",new Float32Array(pe/4));t(this,"_lightCountsArr",new Uint32Array(2));t(this,"_pointBuf",new ArrayBuffer(Q*fe));t(this,"_pointF32",new Float32Array(this._pointBuf));t(this,"_pointI32",new Int32Array(this._pointBuf));t(this,"_spotBuf",new ArrayBuffer(ee*he));t(this,"_spotF32",new Float32Array(this._spotBuf));t(this,"_spotI32",new Int32Array(this._spotBuf));this._pipeline=r,this._cameraBG=i,this._gbufferBG=e,this._lightBG=a,this._shadowBG=n,this._cameraBuffer=o,this._lightCountsBuffer=u,this._pointBuffer=s,this._spotBuffer=d,this._hdrView=m}static create(r,i,e,a){const{device:n}=r,o=n.createBuffer({label:"PSLCameraBuffer",size:pe,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),u=n.createBuffer({label:"PSLLightCounts",size:pt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),s=n.createBuffer({label:"PSLPointBuffer",size:Q*fe,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),d=n.createBuffer({label:"PSLSpotBuffer",size:ee*he,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),m=n.createSampler({label:"PSLLinearSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),l=n.createSampler({label:"PSLVsmSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge"}),p=n.createSampler({label:"PSLProjSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),g=n.createBindGroupLayout({label:"PSLCameraBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),h=n.createBindGroupLayout({label:"PSLGBufferBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),b=n.createBindGroupLayout({label:"PSLLightBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}}]}),_=n.createBindGroupLayout({label:"PSLShadowBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube-array"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),y=n.createBindGroup({label:"PSLCameraBG",layout:g,entries:[{binding:0,resource:{buffer:o}}]}),v=n.createBindGroup({label:"PSLGBufferBG",layout:h,entries:[{binding:0,resource:i.albedoRoughnessView},{binding:1,resource:i.normalMetallicView},{binding:2,resource:i.depthView},{binding:3,resource:m}]}),P=n.createBindGroup({label:"PSLLightBG",layout:b,entries:[{binding:0,resource:{buffer:u}},{binding:1,resource:{buffer:s}},{binding:2,resource:{buffer:d}}]}),B=n.createBindGroup({label:"PSLShadowBG",layout:_,entries:[{binding:0,resource:e.pointVsmView},{binding:1,resource:e.spotVsmView},{binding:2,resource:e.projTexView},{binding:3,resource:l},{binding:4,resource:p}]}),G=r.createShaderModule(dt,"PointSpotLightShader"),x=n.createRenderPipeline({label:"PointSpotLightPipeline",layout:n.createPipelineLayout({bindGroupLayouts:[g,h,b,_]}),vertex:{module:G,entryPoint:"vs_main"},fragment:{module:G,entryPoint:"fs_main",targets:[{format:T,blend:{color:{srcFactor:"one",dstFactor:"one",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one",operation:"add"}}}]},primitive:{topology:"triangle-list"}});return new Te(x,y,v,P,B,o,u,s,d,a)}updateCamera(r,i,e,a,n,o,u,s){const d=this._cameraData;d.set(i.data,0),d.set(e.data,16),d.set(a.data,32),d.set(n.data,48),d[64]=o.x,d[65]=o.y,d[66]=o.z,d[67]=u,d[68]=s,r.queue.writeBuffer(this._cameraBuffer,0,d.buffer)}updateLights(r,i,e){const a=this._lightCountsArr;a[0]=Math.min(i.length,Q),a[1]=Math.min(e.length,ee),r.queue.writeBuffer(this._lightCountsBuffer,0,a.buffer);const n=this._pointF32,o=this._pointI32;let u=0;for(let l=0;l<Math.min(i.length,Q);l++){const p=i[l],g=p.worldPosition(),h=l*12;n[h+0]=g.x,n[h+1]=g.y,n[h+2]=g.z,n[h+3]=p.radius,n[h+4]=p.color.x,n[h+5]=p.color.y,n[h+6]=p.color.z,n[h+7]=p.intensity,p.castShadow&&u<$?o[h+8]=u++:o[h+8]=-1,o[h+9]=0,o[h+10]=0,o[h+11]=0}r.queue.writeBuffer(this._pointBuffer,0,this._pointBuf);const s=this._spotF32,d=this._spotI32;let m=0;for(let l=0;l<Math.min(e.length,ee);l++){const p=e[l],g=p.worldPosition(),h=p.worldDirection(),b=p.lightViewProj(),_=l*32;s[_+0]=g.x,s[_+1]=g.y,s[_+2]=g.z,s[_+3]=p.range,s[_+4]=h.x,s[_+5]=h.y,s[_+6]=h.z,s[_+7]=Math.cos(p.innerAngle*Math.PI/180),s[_+8]=p.color.x,s[_+9]=p.color.y,s[_+10]=p.color.z,s[_+11]=Math.cos(p.outerAngle*Math.PI/180),s[_+12]=p.intensity,p.castShadow&&m<j?d[_+13]=m++:d[_+13]=-1,d[_+14]=p.projectionTexture!==null?l:-1,d[_+15]=0,s.set(b.data,_+16)}r.queue.writeBuffer(this._spotBuffer,0,this._spotBuf)}updateLight(r){r.computeLightViewProj()}execute(r,i){const e=r.beginRenderPass({label:"PointSpotLightPass",colorAttachments:[{view:this._hdrView,loadOp:"load",storeOp:"store"}]});e.setPipeline(this._pipeline),e.setBindGroup(0,this._cameraBG),e.setBindGroup(1,this._gbufferBG),e.setBindGroup(2,this._lightBG),e.setBindGroup(3,this._shadowBG),e.draw(3),e.end()}destroy(){this._cameraBuffer.destroy(),this._lightCountsBuffer.destroy(),this._pointBuffer.destroy(),this._spotBuffer.destroy()}}const Ae=`
struct Particle {
  position : vec3<f32>,  // offset  0
...
`;function ft(f){switch(f.kind){case"sphere":{const c=Math.cos(f.solidAngle).toFixed(6),r=f.radius.toFixed(6);return`{
  ...
  p.position = uniforms.world_pos + world_dir * ${r};
  p.velocity = world_dir * speed;
}`}case"box":{const[c,r,i]=f.halfExtents.map(e=>e.toFixed(6));return`{
  ...
  p.velocity = up * speed;
}`}}}function Ve(f){switch(f.type){case"gravity":return`p.velocity.y -= ${f.strength.toFixed(6)} * uniforms.dt;`;case"drag":return`p.velocity -= p.velocity * ${f.coefficient.toFixed(6)} * uniforms.dt;`;case"force":{const[c,r,i]=f.direction.map(e=>e.toFixed(6));return`p.velocity += vec3<f32>(${c}, ${r}, ${i}) * ${f.strength.toFixed(6)} * uniforms.dt;`}case"swirl_force":{const c=f.speed.toFixed(6),r=f.strength.toFixed(6);return`{
...
}`}case"size_random":return`p.size = rand_range(${f.min.toFixed(6)}, ${f.max.toFixed(6)}, pcg_hash(idx * 2654435761u));`;case"size_over_lifetime":return`p.size = mix(${f.start.toFixed(6)}, ${f.end.toFixed(6)}, t);`;case"color_over_lifetime":{const[c,r,i,e]=f.startColor.map(s=>s.toFixed(6)),[a,n,o,u]=f.endColor.map(s=>s.toFixed(6));return`p.color = mix(vec4<f32>(${c}, ${r}, ${i}, ${e}), vec4<f32>(${a}, ${n}, ${o}, ${u}), t);`}case"block_collision":return`{
...
}`}}function Le(f,c){return f?f.filter(r=>r.trigger===c).flatMap(r=>r.actions.map(Ve)).join(`
  `):""}function ht(f){const{emitter:c,events:r}=f,[i,e]=c.lifetime.map(s=>s.toFixed(6)),[a,n]=c.initialSpeed.map(s=>s.toFixed(6)),[o,u]=c.initialSize.map(s=>s.toFixed(6));return`
${Ae}
...
fn cs_main(@builtin(global_invocation_id) gid: vec3<u32>) {
  ...
  let speed = rand_range(${a}, ${n}, seed + 1u);
...
`,me=64,_e=80,yt=16,wt=16,ge=288,ve=16,oe=128;class Ee extends H{constructor(r,i,e,a,n,o,u,s,d,m,l,p,g,h,b,_,y,v,P,B,G,x,S,E,V,L,R){super();t(this,"name","ParticlePass");t(this,"_gbuffer");t(this,"_hdrView");t(this,"_isForward");t(this,"_maxParticles");t(this,"_config");t(this,"_particleBuffer");t(this,"_aliveList");t(this,"_counterBuffer");t(this,"_indirectBuffer");t(this,"_computeUniforms");t(this,"_renderUniforms");t(this,"_cameraBuffer");t(this,"_spawnPipeline");t(this,"_updatePipeline");t(this,"_compactPipeline");t(this,"_indirectPipeline");t(this,"_renderPipeline");t(this,"_computeDataBG");t(this,"_computeUniBG");t(this,"_compactDataBG");t(this,"_compactUniBG");t(this,"_renderDataBG");t(this,"_cameraRenderBG");t(this,"_renderParamsBG");t(this,"_heightmapDataBuf");t(this,"_heightmapUniBuf");t(this,"_heightmapBG");t(this,"_spawnAccum",0);t(this,"_spawnOffset",0);t(this,"_spawnCount",0);t(this,"_pendingBurst",null);t(this,"_time",0);t(this,"_frameSeed",0);t(this,"_cuBuf",new Float32Array(_e/4));t(this,"_cuiView",new Uint32Array(this._cuBuf.buffer));t(this,"_camBuf",new Float32Array(ge/4));t(this,"_hmUniBuf",new Float32Array(ve/4));t(this,"_hmRes",new Uint32Array([oe]));t(this,"_resetArr",new Uint32Array(1));this._gbuffer=r,this._hdrView=i,this._isForward=e,this._config=a,this._maxParticles=n,this._particleBuffer=o,this._aliveList=u,this._counterBuffer=s,this._indirectBuffer=d,this._computeUniforms=m,this._renderUniforms=l,this._cameraBuffer=p,this._spawnPipeline=g,this._updatePipeline=h,this._compactPipeline=b,this._indirectPipeline=_,this._renderPipeline=y,this._computeDataBG=v,this._computeUniBG=P,this._compactDataBG=B,this._compactUniBG=G,this._renderDataBG=x,this._cameraRenderBG=S,this._renderParamsBG=E,this._heightmapDataBuf=V,this._heightmapUniBuf=L,this._heightmapBG=R}setSpawnRate(r){this._config.emitter.spawnRate=r}burst(r,i,e){if(e<=0)return;const a=Math.min(e,this._maxParticles);this._pendingBurst={px:r.x,py:r.y,pz:r.z,r:i[0],g:i[1],b:i[2],a:i[3],count:a}}static create(r,i,e,a){const{device:n}=r,o=i.renderer.type==="sprites"&&i.renderer.renderTarget==="hdr",u=i.emitter.maxParticles,s=n.createBuffer({label:"ParticleBuffer",size:u*me,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),d=new Float32Array(u*(me/4));for(let k=0;k<u;k++)d[k*16+3]=-1;n.queue.writeBuffer(s,0,d.buffer);const m=n.createBuffer({label:"ParticleAliveList",size:u*4,usage:GPUBufferUsage.STORAGE}),l=n.createBuffer({label:"ParticleCounter",size:4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),p=n.createBuffer({label:"ParticleIndirect",size:16,usage:GPUBufferUsage.INDIRECT|GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});n.queue.writeBuffer(p,0,new Uint32Array([6,0,0,0]));const g=n.createBuffer({label:"ParticleComputeUniforms",size:_e,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),h=n.createBuffer({label:"ParticleCompactUniforms",size:yt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});n.queue.writeBuffer(h,0,new Uint32Array([u,0,0,0]));const b=n.createBuffer({label:"ParticleRenderUniforms",size:wt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});n.queue.writeBuffer(b,0,new Float32Array([i.emitter.roughness,i.emitter.metallic,0,0]));const _=n.createBuffer({label:"ParticleCameraBuffer",size:ge,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),y=n.createBindGroupLayout({label:"ParticleComputeDataBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),v=n.createBindGroupLayout({label:"ParticleCompactDataBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),P=n.createBindGroupLayout({label:"ParticleComputeUniBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),B=n.createBindGroupLayout({label:"ParticleRenderDataBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}}]}),G=n.createBindGroupLayout({label:"ParticleCameraRenderBGL",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),x=n.createBindGroupLayout({label:"ParticleRenderParamsBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),S=n.createBindGroup({label:"ParticleComputeDataBG",layout:y,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:m}},{binding:2,resource:{buffer:l}},{binding:3,resource:{buffer:p}}]}),E=n.createBindGroup({label:"ParticleCompactDataBG",layout:v,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:m}},{binding:2,resource:{buffer:l}},{binding:3,resource:{buffer:p}}]}),V=n.createBindGroup({label:"ParticleComputeUniBG",layout:P,entries:[{binding:0,resource:{buffer:g}}]}),L=n.createBindGroup({label:"ParticleCompactUniBG",layout:P,entries:[{binding:0,resource:{buffer:h}}]}),R=n.createBindGroup({label:"ParticleRenderDataBG",layout:B,entries:[{binding:0,resource:{buffer:s}},{binding:1,resource:{buffer:m}}]}),N=n.createBindGroup({label:"ParticleCameraRenderBG",layout:G,entries:[{binding:0,resource:{buffer:_}}]}),F=n.createBindGroup({label:"ParticleRenderParamsBG",layout:x,entries:[{binding:0,resource:{buffer:b}}]});let O,I,C,z;mt(i)&&(O=n.createBuffer({label:"ParticleHeightmapData",size:oe*oe*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),I=n.createBuffer({label:"ParticleHeightmapUniforms",size:ve,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),z=n.createBindGroupLayout({label:"ParticleHeightmapBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),C=n.createBindGroup({label:"ParticleHeightmapBG",layout:z,entries:[{binding:0,resource:{buffer:O}},{binding:1,resource:{buffer:I}}]}));const Y=n.createPipelineLayout({bindGroupLayouts:[y,P]}),Z=z?n.createPipelineLayout({bindGroupLayouts:[y,P,z]}):n.createPipelineLayout({bindGroupLayouts:[y,P]}),X=n.createPipelineLayout({bindGroupLayouts:[v,P]}),A=n.createShaderModule({label:"ParticleSpawn",code:ht(i)}),q=n.createShaderModule({label:"ParticleUpdate",code:gt(i)}),M=n.createShaderModule({label:"ParticleCompact",code:vt}),w=n.createComputePipeline({label:"ParticleSpawnPipeline",layout:Y,compute:{module:A,entryPoint:"cs_main"}}),Re=n.createComputePipeline({label:"ParticleUpdatePipeline",layout:Z,compute:{module:q,entryPoint:"cs_main"}}),Ne=n.createComputePipeline({label:"ParticleCompactPipeline",layout:X,compute:{module:M,entryPoint:"cs_compact"}}),Oe=n.createComputePipeline({label:"ParticleIndirectPipeline",layout:X,compute:{module:M,entryPoint:"cs_write_indirect"}});let ie;if(o){const k=i.renderer.type==="sprites"?i.renderer.billboard:"camera",ae=i.renderer.type==="sprites"?i.renderer.shape??"soft":"soft",Ie=k==="camera"?"vs_camera":"vs_main",Ce=k==="velocity"?"fs_main":ae==="pixel"?"fs_pixel":"fs_snow",le=r.createShaderModule(xt,"ParticleRenderForward"),Fe=n.createPipelineLayout({bindGroupLayouts:[B,G]});ie=n.createRenderPipeline({label:"ParticleForwardPipeline",layout:Fe,vertex:{module:le,entryPoint:Ie},fragment:{module:le,entryPoint:Ce,targets:[{format:T,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha",operation:"add"}}}]},depthStencil:{format:"depth32float",depthWriteEnabled:!1,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"none"}})}else{const k=r.createShaderModule(bt,"ParticleRender"),ae=n.createPipelineLayout({bindGroupLayouts:[B,G,x]});ie=n.createRenderPipeline({label:"ParticleRenderPipeline",layout:ae,vertex:{module:k,entryPoint:"vs_main"},fragment:{module:k,entryPoint:"fs_main",targets:[{format:"rgba8unorm"},{format:"rgba16float"}]},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less"},primitive:{topology:"triangle-list",cullMode:"none"}})}return new Ee(e,a,o,i,u,s,m,l,p,g,b,_,w,Re,Ne,Oe,ie,S,V,E,L,R,N,o?void 0:F,O,I,C)}updateHeightmap(r,i,e,a,n){if(!this._heightmapDataBuf||!this._heightmapUniBuf)return;r.queue.writeBuffer(this._heightmapDataBuf,0,i.buffer);const o=this._hmUniBuf;o[0]=e,o[1]=a,o[2]=n,r.queue.writeBuffer(this._heightmapUniBuf,0,o.buffer,0,12),r.queue.writeBuffer(this._heightmapUniBuf,12,this._hmRes)}update(r,i,e,a,n,o,u,s,d,m){this._time+=i,this._frameSeed=this._frameSeed+1&4294967295,this._spawnAccum+=this._config.emitter.spawnRate*i,this._spawnCount=Math.min(Math.floor(this._spawnAccum),this._maxParticles),this._spawnAccum-=this._spawnCount;const l=m.data;let p=l[12],g=l[13],h=l[14];const b=Math.hypot(l[0],l[1],l[2]),_=Math.hypot(l[4],l[5],l[6]),y=Math.hypot(l[8],l[9],l[10]),v=l[0]/b,P=l[1]/b,B=l[2]/b,G=l[4]/_,x=l[5]/_,S=l[6]/_,E=l[8]/y,V=l[9]/y,L=l[10]/y,R=v+x+L;let N,F,O,I;if(R>0){const w=.5/Math.sqrt(R+1);I=.25/w,N=(S-V)*w,F=(E-B)*w,O=(P-G)*w}else if(v>x&&v>L){const w=2*Math.sqrt(1+v-x-L);I=(S-V)/w,N=.25*w,F=(G+P)/w,O=(E+B)/w}else if(x>L){const w=2*Math.sqrt(1+x-v-L);I=(E-B)/w,N=(G+P)/w,F=.25*w,O=(V+S)/w}else{const w=2*Math.sqrt(1+L-v-x);I=(P-G)/w,N=(E+B)/w,F=(V+S)/w,O=.25*w}const C=this._config.emitter.initialColor;let z=C[0],Y=C[1],Z=C[2],X=C[3];if(this._pendingBurst){const w=this._pendingBurst;p=w.px,g=w.py,h=w.pz,N=0,F=0,O=0,I=1,this._spawnCount=w.count,z=w.r,Y=w.g,Z=w.b,X=w.a,this._pendingBurst=null}const A=this._cuBuf,q=this._cuiView;A[0]=p,A[1]=g,A[2]=h,q[3]=this._spawnCount,A[4]=N,A[5]=F,A[6]=O,A[7]=I,q[8]=this._spawnOffset,q[9]=this._maxParticles,q[10]=this._frameSeed,q[11]=0,A[12]=i,A[13]=this._time,A[16]=z,A[17]=Y,A[18]=Z,A[19]=X,r.queue.writeBuffer(this._computeUniforms,0,A.buffer),r.queue.writeBuffer(this._counterBuffer,0,this._resetArr),this._spawnOffset=(this._spawnOffset+this._spawnCount)%this._maxParticles;const M=this._camBuf;M.set(e.data,0),M.set(a.data,16),M.set(n.data,32),M.set(o.data,48),M[64]=u.x,M[65]=u.y,M[66]=u.z,M[67]=s,M[68]=d,r.queue.writeBuffer(this._cameraBuffer,0,M.buffer)}execute(r,i){const e=r.beginComputePass({label:"ParticleCompute"});if(this._spawnCount>0&&(e.setPipeline(this._spawnPipeline),e.setBindGroup(0,this._computeDataBG),e.setBindGroup(1,this._computeUniBG),e.dispatchWorkgroups(Math.ceil(this._spawnCount/64))),e.setPipeline(this._updatePipeline),e.setBindGroup(0,this._computeDataBG),e.setBindGroup(1,this._computeUniBG),this._heightmapBG&&e.setBindGroup(2,this._heightmapBG),e.dispatchWorkgroups(Math.ceil(this._maxParticles/64)),e.setPipeline(this._compactPipeline),e.setBindGroup(0,this._compactDataBG),e.setBindGroup(1,this._compactUniBG),e.dispatchWorkgroups(Math.ceil(this._maxParticles/64)),e.setPipeline(this._indirectPipeline),e.dispatchWorkgroups(1),e.end(),this._isForward){const a=r.beginRenderPass({label:"ParticleForwardPass",colorAttachments:[{view:this._hdrView,loadOp:"load",storeOp:"store"}],depthStencilAttachment:{view:this._gbuffer.depthView,depthReadOnly:!0}});a.setPipeline(this._renderPipeline),a.setBindGroup(0,this._renderDataBG),a.setBindGroup(1,this._cameraRenderBG),a.drawIndirect(this._indirectBuffer,0),a.end()}else{const a=r.beginRenderPass({label:"ParticleGBufferPass",colorAttachments:[{view:this._gbuffer.albedoRoughnessView,loadOp:"load",storeOp:"store"},{view:this._gbuffer.normalMetallicView,loadOp:"load",storeOp:"store"}],depthStencilAttachment:{view:this._gbuffer.depthView,depthLoadOp:"load",depthStoreOp:"store"}});a.setPipeline(this._renderPipeline),a.setBindGroup(0,this._renderDataBG),a.setBindGroup(1,this._cameraRenderBG),a.setBindGroup(2,this._renderParamsBG),a.drawIndirect(this._indirectBuffer,0),a.end()}}destroy(){var r,i;this._particleBuffer.destroy(),this._aliveList.destroy(),this._counterBuffer.destroy(),this._indirectBuffer.destroy(),this._computeUniforms.destroy(),this._renderUniforms.destroy(),this._cameraBuffer.destroy(),(r=this._heightmapDataBuf)==null||r.destroy(),(i=this._heightmapUniBuf)==null||i.destroy()}}const Pt=`// Auto-exposure — two-pass histogram approach.
//
...
`,Bt=64,Gt=32,St=16,Ut=Bt*4,be={adaptSpeed:1.5,minExposure:.1,maxExposure:10,lowPct:.05,highPct:.02},W=class W extends H{constructor(r,i,e,a,n,o,u,s){super();t(this,"name","AutoExposurePass");t(this,"exposureBuffer");t(this,"_histogramPipeline");t(this,"_adaptPipeline");t(this,"_bindGroup");t(this,"_paramsBuffer");t(this,"_histogramBuffer");t(this,"_hdrWidth");t(this,"_hdrHeight");t(this,"enabled",!0);t(this,"_resetScratch",new Float32Array([1,0,0,0]));this._histogramPipeline=r,this._adaptPipeline=i,this._bindGroup=e,this._paramsBuffer=a,this._histogramBuffer=n,this.exposureBuffer=o,this._hdrWidth=u,this._hdrHeight=s}static create(r,i,e=be){const{device:a}=r,n=a.createBindGroupLayout({label:"AutoExposureBGL",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),o=a.createBuffer({label:"AutoExposureHistogram",size:Ut,usage:GPUBufferUsage.STORAGE}),u=a.createBuffer({label:"AutoExposureValue",size:St,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});a.queue.writeBuffer(u,0,new Float32Array([1,0,0,0]));const s=a.createBuffer({label:"AutoExposureParams",size:Gt,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});W._writeParams(a,s,0,e);const d=a.createBindGroup({label:"AutoExposureBG",layout:n,entries:[{binding:0,resource:i.createView()},{binding:1,resource:{buffer:o}},{binding:2,resource:{buffer:u}},{binding:3,resource:{buffer:s}}]}),m=a.createPipelineLayout({bindGroupLayouts:[n]}),l=r.createShaderModule(Pt,"AutoExposure"),p=a.createComputePipeline({label:"AutoExposureHistogramPipeline",layout:m,compute:{module:l,entryPoint:"cs_histogram"}}),g=a.createComputePipeline({label:"AutoExposureAdaptPipeline",layout:m,compute:{module:l,entryPoint:"cs_adapt"}});return new W(p,g,d,s,o,u,i.width,i.height)}update(r,i,e=be){if(!this.enabled){r.device.queue.writeBuffer(this.exposureBuffer,0,this._resetScratch);return}W._writeParams(r.device,this._paramsBuffer,i,e)}execute(r,i){if(!this.enabled)return;const e=r.beginComputePass({label:"AutoExposurePass"});e.setPipeline(this._histogramPipeline),e.setBindGroup(0,this._bindGroup),e.dispatchWorkgroups(Math.ceil(this._hdrWidth/32),Math.ceil(this._hdrHeight/32)),e.setPipeline(this._adaptPipeline),e.dispatchWorkgroups(1),e.end()}destroy(){this._paramsBuffer.destroy(),this._histogramBuffer.destroy(),this.exposureBuffer.destroy()}static _writeParams(r,i,e,a){const n=W._paramsScratch;n[0]=e,n[1]=a.adaptSpeed,n[2]=a.minExposure,n[3]=a.maxExposure,n[4]=a.lowPct,n[5]=a.highPct,n[6]=0,n[7]=0,r.queue.writeBuffer(i,0,n)}};t(W,"_paramsScratch",new Float32Array(8));let xe=W;class Me{constructor(c,r,i,e,a,n,o){t(this,"colorAtlas");t(this,"normalAtlas");t(this,"merAtlas");t(this,"heightAtlas");t(this,"blockSize");t(this,"blockCount");t(this,"_atlasWidth");t(this,"_atlasHeight");this.colorAtlas=c,this.normalAtlas=r,this.merAtlas=i,this.heightAtlas=e,this.blockSize=a,this._atlasWidth=n,this._atlasHeight=o,this.blockCount=Math.floor(n/a)}static async load(c,r,i,e,a,n=16){async function o(y){const v=await(await fetch(y)).blob();return createImageBitmap(v,{colorSpaceConversion:"none"})}const[u,s,d,m]=await Promise.all([o(r),o(i),o(e),o(a)]),l=u.width,p=u.height,g=K.fromBitmap(c,u,{srgb:!0}),h=K.fromBitmap(c,s,{srgb:!1}),b=K.fromBitmap(c,d,{srgb:!1}),_=K.fromBitmap(c,m,{srgb:!1});return new Me(g,h,b,_,n,l,p)}uvTransform(c){const r=this.blockSize/this._atlasWidth,i=this.blockSize/this._atlasHeight;return[c*r,0,r,i]}destroy(){this.colorAtlas.destroy(),this.normalAtlas.destroy(),this.merAtlas.destroy(),this.heightAtlas.destroy()}}export{xe as A,Pe as B,Be as D,Ee as P,Ge as S,we as T,Te as a,Ue as b,Se as c,Me as d,Mt as e,It as f,Ct as g,Ot as h,Nt as m,Rt as n};
