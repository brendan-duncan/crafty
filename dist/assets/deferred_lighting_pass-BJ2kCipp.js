var C=Object.defineProperty;var H=(_,u,i)=>u in _?C(_,u,{enumerable:!0,configurable:!0,writable:!0,value:i}):_[u]=i;var a=(_,u,i)=>H(_,typeof u!="symbol"?u+"":u,i);import{a as O}from"./mesh-BUGOzOTp.js";const W=`// Deferred PBR lighting pass — fullscreen triangle, reads GBuffer + shadow maps + IBL.
...
`,S="rgba16float",E=64*4+16+16,N=368;class P extends O{constructor(i,l,r,c,s,o,e,h,t,f,d,n,p,b,x,g,m,v){super();a(this,"name","DeferredLightingPass");a(this,"hdrTexture");a(this,"hdrView");a(this,"cameraBuffer");a(this,"lightBuffer");a(this,"_pipeline");a(this,"_sceneBindGroup");a(this,"_gbufferBindGroup");a(this,"_aoBindGroup");a(this,"_iblBindGroup");a(this,"_defaultCloudShadow");a(this,"_defaultSsgi");a(this,"_defaultIblCube");a(this,"_defaultBrdfLut");a(this,"_device");a(this,"_aoBGL");a(this,"_aoView");a(this,"_aoSampler");a(this,"_ssgiSampler");a(this,"_cameraScratch",new Float32Array(E/4));a(this,"_lightScratch",new Float32Array(N/4));a(this,"_lightScratchU",new Uint32Array(this._lightScratch.buffer));a(this,"_cloudShadowScratch",new Float32Array(3));this.hdrTexture=i,this.hdrView=l,this._pipeline=r,this._sceneBindGroup=c,this._gbufferBindGroup=s,this._aoBindGroup=o,this._iblBindGroup=e,this.cameraBuffer=h,this.lightBuffer=t,this._defaultCloudShadow=f,this._defaultSsgi=d,this._defaultIblCube=n,this._defaultBrdfLut=p,this._device=b,this._aoBGL=x,this._aoView=g,this._aoSampler=m,this._ssgiSampler=v}static create(i,l,r,c,s,o){const{device:e,width:h,height:t}=i,f=e.createTexture({label:"HDR Texture",size:{width:h,height:t},format:S,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),d=f.createView(),n=e.createBuffer({label:"LightCameraBuffer",size:E,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),p=e.createBuffer({label:"LightBuffer",size:N,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),b=e.createSampler({label:"ShadowSampler",compare:"less-equal",magFilter:"linear",minFilter:"linear"}),x=e.createSampler({label:"GBufferLinearSampler",magFilter:"linear",minFilter:"linear"}),g=e.createSampler({label:"AoSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),m=e.createSampler({label:"SsgiSampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),v=e.createBindGroupLayout({label:"LightSceneBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),T=e.createBindGroupLayout({label:"LightGBufferBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth",viewDimension:"2d-array"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"comparison"}},{binding:5,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:6,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}}]}),w=e.createTexture({label:"DefaultCloudShadow",size:{width:1,height:1},format:"r8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});e.queue.writeTexture({texture:w},new Uint8Array([255]),{bytesPerRow:1},{width:1,height:1});const U=s??w.createView(),y=e.createBindGroupLayout({label:"LightAoBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),M=e.createTexture({label:"DefaultSsgi",size:{width:1,height:1},format:S,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),G=e.createBindGroupLayout({label:"LightIblBGL",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"cube"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}}]}),z=e.createSampler({label:"IblSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge"}),A=e.createTexture({label:"DefaultIblCube",size:{width:1,height:1,depthOrArrayLayers:6},format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),L=A.createView({dimension:"cube"}),B=e.createTexture({label:"DefaultBrdfLut",size:{width:1,height:1},format:"rgba16float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),I=e.createBindGroup({label:"LightIblBG",layout:G,entries:[{binding:0,resource:(o==null?void 0:o.irradianceView)??L},{binding:1,resource:(o==null?void 0:o.prefilteredView)??L},{binding:2,resource:(o==null?void 0:o.brdfLutView)??B.createView()},{binding:3,resource:z}]}),k=e.createBindGroup({layout:v,entries:[{binding:0,resource:{buffer:n}},{binding:1,resource:{buffer:p}}]}),D=e.createBindGroup({layout:T,entries:[{binding:0,resource:l.albedoRoughnessView},{binding:1,resource:l.normalMetallicView},{binding:2,resource:l.depthView},{binding:3,resource:r.shadowMapView},{binding:4,resource:b},{binding:5,resource:x},{binding:6,resource:U}]}),F=e.createBindGroup({label:"LightAoBG",layout:y,entries:[{binding:0,resource:c},{binding:1,resource:g},{binding:2,resource:M.createView()},{binding:3,resource:m}]}),R=e.createShaderModule({label:"LightingShader",code:W}),V=e.createRenderPipeline({label:"LightingPipeline",layout:e.createPipelineLayout({bindGroupLayouts:[v,T,y,G]}),vertex:{module:R,entryPoint:"vs_main"},fragment:{module:R,entryPoint:"fs_main",targets:[{format:S}]},primitive:{topology:"triangle-list"}});return new P(f,d,V,k,D,F,I,n,p,s?null:w,M,o?null:A,o?null:B,e,y,c,g,m)}updateSSGI(i){this._aoBindGroup=this._device.createBindGroup({label:"LightAoBG",layout:this._aoBGL,entries:[{binding:0,resource:this._aoView},{binding:1,resource:this._aoSampler},{binding:2,resource:i},{binding:3,resource:this._ssgiSampler}]})}updateCamera(i,l,r,c,s,o,e,h){const t=this._cameraScratch;t.set(l.data,0),t.set(r.data,16),t.set(c.data,32),t.set(s.data,48),t[64]=o.x,t[65]=o.y,t[66]=o.z,t[67]=e,t[68]=h,i.queue.writeBuffer(this.cameraBuffer,0,t.buffer)}updateLight(i,l,r,c,s,o=!0,e=!1,h=.02){const t=this._lightScratch,f=this._lightScratchU;let d=0;t[d++]=l.x,t[d++]=l.y,t[d++]=l.z,t[d++]=c,t[d++]=r.x,t[d++]=r.y,t[d++]=r.z,f[d++]=s.length;for(let n=0;n<4;n++)n<s.length&&t.set(s[n].lightViewProj.data,d),d+=16;for(let n=0;n<4;n++)t[d++]=n<s.length?s[n].splitFar:1e9;f[d]=o?1:0,f[d+1]=e?1:0,t[81]=h;for(let n=0;n<4;n++)t[84+n]=n<s.length?s[n].depthRange:1;for(let n=0;n<4;n++)t[88+n]=n<s.length?s[n].texelWorldSize:1;i.queue.writeBuffer(this.lightBuffer,0,t.buffer)}updateCloudShadow(i,l,r,c){const s=this._cloudShadowScratch;s[0]=l,s[1]=r,s[2]=c,i.queue.writeBuffer(this.lightBuffer,312,s.buffer)}execute(i,l){const r=i.beginRenderPass({label:"DeferredLightingPass",colorAttachments:[{view:this.hdrView,loadOp:"load",storeOp:"store"}]});r.setPipeline(this._pipeline),r.setBindGroup(0,this._sceneBindGroup),r.setBindGroup(1,this._gbufferBindGroup),r.setBindGroup(2,this._aoBindGroup),r.setBindGroup(3,this._iblBindGroup),r.draw(3),r.end()}destroy(){var i,l,r,c;this.hdrTexture.destroy(),this.cameraBuffer.destroy(),this.lightBuffer.destroy(),(i=this._defaultCloudShadow)==null||i.destroy(),(l=this._defaultSsgi)==null||l.destroy(),(r=this._defaultIblCube)==null||r.destroy(),(c=this._defaultBrdfLut)==null||c.destroy()}}export{P as D,S as H};
