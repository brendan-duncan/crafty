...
function eventActionsWgsl(events, trigger) {
    if (!events) {
        return '';
    }
    return events
 ...
 * on uniforms.
 */
export function buildSpawnShader(config) {
...
export function hasBlockCollision(config) {
 ...
 * is present.
 */
export function buildUpdateShader(config) {
