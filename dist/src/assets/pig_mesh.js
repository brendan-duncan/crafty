 ...
 */
export function createPigBodyMesh(device, scale = 1.0) {
    const verts = [];
    const indices = [];
    const s = scale;
 ...
 * @param scale  - Uniform scale; 1.0 = adult, ~0.55 = baby.
 */
export function createPigHeadMesh(device, scale = 1.0) {
    const verts = [];
    const indices = [];
    const s = scale;
 ...
 * @param scale  - Uniform scale; 1.0 = adult, ~0.55 = baby.
 */
export function createPigSnoutMesh(device, scale = 1.0) {
    const verts = [];
    const indices = [];
    const s = scale;
