 ...
 */
export function createDuckBodyMesh(device, scale = 1.0) {
    const verts = [];
    const indices = [];
    const s = scale;
 ...
 * @returns A Mesh with position, normal, uv, and tangent attributes.
 */
export function createDuckHeadMesh(device, scale = 1.0) {
    const verts = [];
    const indices = [];
    const s = scale;
 ...
 * @returns A Mesh with position, normal, uv, and tangent attributes.
 */
export function createDuckBillMesh(device, scale = 1.0) {
    const verts = [];
    const indices = [];
    const s = scale;
