...
export class RenderContext {
    ...
    createDefaultCubemap() {
        ...
        for (let i = 0; i < 6; i++) {
            this.queue.writeTexture({ texture: tex, origin: { x: 0, y: 0, z: i } }, data, { bytesPerRow: 8 }, { width: 1, height: 1 });
        }
        return tex;
    }
    /**
    ...
    createDefaultBrdfLUT() {
        ...
        const data = new Uint16Array([0x3800, 0x3800, 0x3800, 0x3C00]);
        this.queue.writeTexture({ texture: tex }, data, { bytesPerRow: 8 }, { width: 1, height: 1 });
        return tex;
    }
}
