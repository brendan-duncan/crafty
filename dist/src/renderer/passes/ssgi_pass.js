...
export class SSGIPass extends RenderPass {
    ...
    _scratchU32 = new Uint32Array(this._scratch.buffer);
    _width;
    _height;
    constructor(uniformBuffer, noiseTexture, rawTexture, rawView, historyTexture, resultTexture, resultView, ssgiPipeline, temporalPipeline, ssgiBG0, ssgiBG1, tempBG0, tempBG1, settings, width, height) {
        super();
     ...
     */
    static create(ctx, gbuffer, prevRadianceView, settings = DEFAULT_SSGI) {
        ...
        device.queue.writeTexture({ texture: noiseTex }, generateNoise(), { bytesPerRow: 4 * 4, rowsPerImage: 4 }, { width: 4, height: 4 });
        ...
        return new SSGIPass(uniformBuffer, noiseTex, rawTexture, rawView, historyTexture, resultTexture, resultView, ssgiPipeline, temporalPipeline, ssgiBG0, ssgiBG1, tempBG0, tempBG1, settings, width, height);
    }
    /**
     ...
     */
    updateCamera(ctx, view, proj, invProj, invViewProj, prevViewProj, camPos) {
    ...
    execute(encoder, _ctx) {
        ...
        encoder.copyTextureToTexture({ texture: this._resultTexture }, { texture: this._historyTexture }, { width: this._width, height: this._height });
    }
