...
export class CloudPass extends RenderPass {
    ...
    _cameraScratch = new Float32Array(CLOUD_CAMERA_UNIFORM_SIZE / 4);
    _lightScratch = new Float32Array(CLOUD_LIGHT_UNIFORM_SIZE / 4);
    _settingsScratch = new Float32Array(CLOUD_UNIFORM_SIZE / 4);
