...
export class LightingPass extends RenderPass {
    ...
    static create(ctx, gbuffer, shadowPass, aoView, cloudShadowView, iblTextures) {
        ...
        return new LightingPass(hdrTexture, hdrView, pipeline, sceneBindGroup, gbufferBindGroup, aoBindGroup, iblBindGroup, cameraBuffer, lightBuffer, cloudShadowView ? null : defaultCloudShadow, defaultSsgi, iblTextures ? null : defaultIblCube, iblTextures ? null : defaultBrdfLut, device, aoBGL, aoView, aoSampler, ssgiSampler);
    }
    /**
