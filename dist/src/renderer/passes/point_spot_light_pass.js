...
export class PointSpotLightPass extends RenderPass {
    ...
    _cameraData = new Float32Array(CAMERA_SIZE / 4);
    _lightCountsArr = new Uint32Array(2);
    _pointBuf = new ArrayBuffer(MAX_POINT_LIGHTS * POINT_STRIDE);
    _pointF32 = new Float32Array(this._pointBuf);
    _pointI32 = new Int32Array(this._pointBuf);
    _spotBuf = new ArrayBuffer(MAX_SPOT_LIGHTS * SPOT_STRIDE);
    _spotF32 = new Float32Array(this._spotBuf);
    _spotI32 = new Int32Array(this._spotBuf);
    constructor(pipeline, cameraBG, gbufferBG, lightBG, shadowBG, cameraBuffer, lightCountsBuffer, pointBuffer, spotBuffer, hdrView) {
        super();
     ...
     */
    static create(ctx, gbuffer, shadowPass, hdrView) {
        const { device } = ctx;
        ...
        return new PointSpotLightPass(pipeline, cameraBG, gbufferBG, lightBG, shadowBG, cameraBuffer, lightCountsBuffer, pointBuffer, spotBuffer, hdrView);
    }
    /**
     ...
     */
    updateLights(ctx, pointLights, spotLights) {
        // Light counts
        ...
        ctx.queue.writeBuffer(this._lightCountsBuffer, 0, counts.buffer);
