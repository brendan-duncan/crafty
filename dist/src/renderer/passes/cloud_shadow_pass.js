...
export class CloudShadowPass extends RenderPass {
    ...
    _noiseBG;
    _frameCount = 0;
    constructor(shadowTexture, shadowView, pipeline, uniformBuffer, uniformBG, noiseBG) {
        super();
    ...
    _data = new Float32Array(UNIFORM_SIZE / 4);
    /**
     ...
     */
    update(ctx, settings, worldOrigin, worldExtent) {
        ...
        ctx.queue.writeBuffer(this._uniformBuffer, 0, this._data.buffer);
    }
    /**
