function lerpN(a, ai, b, bi, t, n, out, oi) {
    for (let k = 0; k < n; k++) {
        out[oi + k] = a[ai + k] + (b[bi + k] - a[ai + k]) * t;
    }
}
function slerpQuat(a, ai, b, bi, t, out, oi) {
 ...
 */
export function sampleClip(clip, time, translations, rotations, scales) {
