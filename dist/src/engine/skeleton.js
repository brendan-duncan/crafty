...
export class Skeleton {
     ...
     */
    constructor(parentIndices, invBindMats, restTranslations, restRotations, restScales, rootTransform) {
     ...
     */
    computeJointMatrices(translations, rotations, scales, out) {
