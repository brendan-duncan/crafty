...
export class Mat4 {
    ...
    get(col, row) { return this.data[col * 4 + row]; }
    /** Writes a value at the given column and row. */
    set(col, row, v) { this.data[col * 4 + row] = v; }
    ...
    transformVec4(v) {
        const d = this.data;
        return new Vec4(d[0] * v.x + d[4] * v.y + d[8] * v.z + d[12] * v.w, d[1] * v.x + d[5] * v.y + d[9] * v.z + d[13] * v.w, d[2] * v.x + d[6] * v.y + d[10] * v.z + d[14] * v.w, d[3] * v.x + d[7] * v.y + d[11] * v.z + d[15] * v.w);
    }
    ...
    normalMatrix() {
        ...
        out[0] = b01 * det;
        out[4] = (-a22 * a01 + a02 * a21) * det;
        out[8] = (a12 * a01 - a02 * a11) * det;
        out[1] = b11 * det;
        out[5] = (a22 * a00 - a02 * a20) * det;
        out[9] = (-a12 * a00 + a02 * a10) * det;
        out[2] = b21 * det;
        out[6] = (-a21 * a00 + a01 * a20) * det;
    ...
    static fromQuaternion(qx, qy, qz, qw) {
