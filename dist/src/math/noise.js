...
function _fastfloor(a) {
    const ai = a | 0;
    return a < ai ? ai - 1 : ai;
}
function _grad(gi, x, y, z) {
    const i = gi * 3;
...
function _noise3Internal(x, y, z, xWrap, yWrap, zWrap, seed) {
 ...
 */
export function perlinNoise3(x, y, z, xWrap = 0, yWrap = 0, zWrap = 0) {
 ...
 */
export function perlinNoise3Seed(x, y, z, xWrap, yWrap, zWrap, seed) {
 ...
 */
export function perlinRidgeNoise3(x, y, z, lacunarity, gain, offset, octaves) {
    let frequency = 1.0;
    let prev = 1.0;
    let amplitude = 0.5;
    let sum = 0.0;
 ...
 * @param octaves - number of octaves to sum
 */
export function perlinFbmNoise3(x, y, z, lacunarity, gain, octaves) {
    let frequency = 1.0;
    let amplitude = 1.0;
    let sum = 0.0;
    for (let i = 0; i < octaves; i++) {
 ...
 * @param octaves - number of octaves to sum
 */
export function perlinTurbulenceNoise3(x, y, z, lacunarity, gain, octaves) {
    let frequency = 1.0;
    let amplitude = 1.0;
    let sum = 0.0;
    for (let i = 0; i < octaves; i++) {
 ...
 */
export function perlinNoise3WrapNonpow2(x, y, z, xWrap, yWrap, zWrap, seed) {
