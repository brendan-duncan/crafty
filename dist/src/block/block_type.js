...
(function (BlockType) {
    ...
    BlockType[BlockType["SAND"] = 2] = "SAND";
    BlockType[BlockType["STONE"] = 3] = "STONE";
    BlockType[BlockType["DIRT"] = 4] = "DIRT";
    BlockType[BlockType["TRUNK"] = 5] = "TRUNK";
    BlockType[BlockType["TREELEAVES"] = 6] = "TREELEAVES";
    BlockType[BlockType["WATER"] = 7] = "WATER";
    BlockType[BlockType["GLASS"] = 8] = "GLASS";
    BlockType[BlockType["FLOWER"] = 9] = "FLOWER";
    BlockType[BlockType["GLOWSTONE"] = 10] = "GLOWSTONE";
    BlockType[BlockType["MAGMA"] = 11] = "MAGMA";
    BlockType[BlockType["OBSIDIAN"] = 12] = "OBSIDIAN";
    BlockType[BlockType["DIAMOND"] = 13] = "DIAMOND";
    BlockType[BlockType["IRON"] = 14] = "IRON";
    BlockType[BlockType["SPECULAR"] = 15] = "SPECULAR";
    BlockType[BlockType["CACTUS"] = 16] = "CACTUS";
    BlockType[BlockType["SNOW"] = 17] = "SNOW";
    BlockType[BlockType["GRASS_SNOW"] = 18] = "GRASS_SNOW";
    BlockType[BlockType["SPRUCE_PLANKS"] = 19] = "SPRUCE_PLANKS";
    BlockType[BlockType["GRASS_PROP"] = 20] = "GRASS_PROP";
    BlockType[BlockType["TORCH"] = 21] = "TORCH";
    BlockType[BlockType["DEAD_BUSH"] = 22] = "DEAD_BUSH";
    BlockType[BlockType["SNOWYLEAVES"] = 23] = "SNOWYLEAVES";
    BlockType[BlockType["AMETHYST"] = 24] = "AMETHYST";
    BlockType[BlockType["MAX"] = 25] = "MAX";
})(BlockType || (BlockType = {}));
/**
...
export const blockTextureOffsetData = [
    //NONE
    new BlockTextureOffsetData(BlockType.NONE, new Vec2(0, 0), new Vec2(0, 0), new Vec2(0, 0)),
    //GRASS
    new BlockTextureOffsetData(BlockType.GRASS, new Vec2(1, 0), new Vec2(3, 0), new Vec2(2, 0)),
    //SAND
    new BlockTextureOffsetData(BlockType.SAND, new Vec2(4, 0), new Vec2(4, 0), new Vec2(4, 0)),
    //STONE
    new BlockTextureOffsetData(BlockType.STONE, new Vec2(5, 0), new Vec2(5, 0), new Vec2(5, 0)),
    //DIRT
    new BlockTextureOffsetData(BlockType.DIRT, new Vec2(6, 0), new Vec2(6, 0), new Vec2(6, 0)),
    //TRUNK
    new BlockTextureOffsetData(BlockType.TRUNK, new Vec2(7, 0), new Vec2(8, 0), new Vec2(8, 0)),
    //TREE LEAVES
    new BlockTextureOffsetData(BlockType.TREELEAVES, new Vec2(9, 0), new Vec2(9, 0), new Vec2(9, 0)),
    //WATER
    new BlockTextureOffsetData(BlockType.WATER, new Vec2(2, 29), new Vec2(2, 29), new Vec2(2, 29)),
    //GLASS
    new BlockTextureOffsetData(BlockType.GLASS, new Vec2(10, 0), new Vec2(10, 0), new Vec2(10, 0)),
    //FLOWER
    new BlockTextureOffsetData(BlockType.FLOWER, new Vec2(23, 0), new Vec2(23, 0), new Vec2(23, 0)),
    //GLOWSTONE
    new BlockTextureOffsetData(BlockType.GLOWSTONE, new Vec2(11, 0), new Vec2(11, 0), new Vec2(11, 0)),
    //MAGMA
    new BlockTextureOffsetData(BlockType.MAGMA, new Vec2(12, 0), new Vec2(12, 0), new Vec2(12, 0)),
    //OBSIDIAN
    new BlockTextureOffsetData(BlockType.OBSIDIAN, new Vec2(13, 0), new Vec2(13, 0), new Vec2(13, 0)),
    //DIAMOND
    new BlockTextureOffsetData(BlockType.DIAMOND, new Vec2(14, 0), new Vec2(14, 0), new Vec2(14, 0)),
    //IRON
    new BlockTextureOffsetData(BlockType.IRON, new Vec2(15, 0), new Vec2(15, 0), new Vec2(15, 0)),
    //SPECULAR
    new BlockTextureOffsetData(BlockType.SPECULAR, new Vec2(0, 24), new Vec2(0, 24), new Vec2(0, 24)),
    //CACTUS
    new BlockTextureOffsetData(BlockType.CACTUS, new Vec2(17, 0), new Vec2(18, 0), new Vec2(16, 0)),
    //SNOW
    new BlockTextureOffsetData(BlockType.SNOW, new Vec2(19, 0), new Vec2(19, 0), new Vec2(19, 0)),
    //SNOW
    new BlockTextureOffsetData(BlockType.GRASS_SNOW, new Vec2(20, 0), new Vec2(3, 0), new Vec2(21, 0)),
    //SPRUCE PLANKS
    new BlockTextureOffsetData(BlockType.SPRUCE_PLANKS, new Vec2(22, 0), new Vec2(22, 0), new Vec2(22, 0)),
    //GRASS PROP
    new BlockTextureOffsetData(BlockType.GRASS_PROP, new Vec2(1, 1), new Vec2(1, 1), new Vec2(1, 1)),
    //TORCH
    new BlockTextureOffsetData(BlockType.TORCH, new Vec2(2, 1), new Vec2(2, 1), new Vec2(2, 1)),
    //DEAD BUSH
    new BlockTextureOffsetData(BlockType.DEAD_BUSH, new Vec2(3, 1), new Vec2(3, 1), new Vec2(3, 1)),
    //SNOWY LEAVES
    new BlockTextureOffsetData(BlockType.SNOWYLEAVES, new Vec2(4, 1), new Vec2(9, 0), new Vec2(21, 0)),
    //SNOWY LEAVES
    new BlockTextureOffsetData(BlockType.AMETHYST, new Vec2(5, 1), new Vec2(5, 1), new Vec2(5, 1)),
    //MAX
    new BlockTextureOffsetData(BlockType.MAX, new Vec2(0, 0), new Vec2(0, 0), new Vec2(0, 0)),
];
...
(function (MaterialType) {
    ...
    MaterialType[MaterialType["SEMI_TRANSPARENT"] = 1] = "SEMI_TRANSPARENT";
    MaterialType[MaterialType["WATER"] = 2] = "WATER";
    MaterialType[MaterialType["PROP"] = 3] = "PROP";
...
export class BlockMaterialData {
     ...
     */
    constructor(blockType, materialType, emitsLight, collidable) {
...
export const blockMaterialData = [
...
export class BlockLightData {
     ...
     */
    constructor(bt, c, ai, si, r, atten) {
        this.blockType = bt;
        this.color = c;
...
export const blockLightData = [
    //GLOWSTONE
    new BlockLightData(BlockType.GLOWSTONE, new Vec3(0.98, 0.85, 0.45), 24.8, 0.2, 6.42, 0.20),
    //MAGMA
    new BlockLightData(BlockType.MAGMA, new Vec3(0.95, 0.06, 0.12), 32.0, 12.4, 8.72, 0.20),
    //OBSIDIAN 
    new BlockLightData(BlockType.OBSIDIAN, new Vec3(0.51, 0.03, 0.89), 12.0, 0.4, 9.22, 0.20),
    //TORCH
    new BlockLightData(BlockType.TORCH, new Vec3(0.95, 0.56, 0.01), 4.0, 0.4, 3.22, 1.20),
];
 ...
 */
export function isBlockWater(blockType) {
 ...
 * @param blockType - block to test
 */
export function isBlockOpaque(blockType) {
 ...
 * @param blockType - block to test
 */
export function isBlockSemiTransparent(blockType) {
 ...
 * @param blockType - block to test
 */
export function isBlockCollidable(blockType) {
 ...
 * @param blockType - block to test
 */
export function isBlockEmittingLight(blockType) {
 ...
 * @param blockType - block to test
 */
export function isBlockProp(blockType) {
 ...
 */
export function getBlockTypeAABB(blockType, dest) {
    let width = 1;
    let height = 1;
    let length = 1;
 ...
 */
export function getBlockLightingData(block_type) {
 ...
 */
export function generateBlockInfoUniformBuffer(device) {
