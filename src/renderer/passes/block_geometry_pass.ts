...
export class BlockGeometryPass extends RenderPass {
   ...
   * cached frustum planes used for chunk culling. Uniform uses the TAA-jittered
   * VP (so vertices get sub-pixel motion); frustum planes use the un-jittered
   * VP (sub-pixel jitter is irrelevant for chunk-level culling).
   */
