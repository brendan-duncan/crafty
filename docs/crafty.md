...
- [Chapter 3: WebGPU Fundamentals](chapters/03-webgpu-fundamentals.md)
  ...
  - [3.7 GPUShaderModule and WGSL](chapters/03-webgpu-fundamentals.md#37-gpushadermodule-and-wgsl)
    - [Preprocessor and Shader Blocks](chapters/03-webgpu-fundamentals.md#preprocessor-and-shader-blocks)
    - [The Preprocessor](chapters/03-webgpu-fundamentals.md#the-preprocessor)
  ...
  - [3.10 Render Passes](chapters/03-webgpu-fundamentals.md#310-render-passes)
    ...
    - [Viewport and Scissor](chapters/03-webgpu-fundamentals.md#viewport-and-scissor)
...
- [Chapter 8: Shadow Mapping](chapters/08-shadow-mapping.md)
  ...
  - [8.2 Cascade Shadow Maps (CSM)](chapters/08-shadow-mapping.md#82-cascade-shadow-maps-csm)
    ...
    - [Cascade Partitioning](chapters/08-shadow-mapping.md#cascade-partitioning)
...
- [Chapter 11: Terrain and Voxel World](chapters/11-terrain.md)
  ...
  - [11.4 Chunk Meshing](chapters/11-terrain.md#114-chunk-meshing)
    - [Face Culling](chapters/11-terrain.md#face-culling)
    - [The Padded Block Grid](chapters/11-terrain.md#the-padded-block-grid)
    - [Vertex Layout](chapters/11-terrain.md#vertex-layout)
    - [Mesh Categories](chapters/11-terrain.md#mesh-categories)
    - [Prop Billboard Rendering](chapters/11-terrain.md#prop-billboard-rendering)
    - [Greedy Merge](chapters/11-terrain.md#greedy-merge)
  - [11.5 Greedy Meshing](chapters/11-terrain.md#115-greedy-meshing)
  ...
  - [11.6 Level-of-Detail (LOD)](chapters/11-terrain.md#116-level-of-detail-lod)
  - [11.7 Block Interaction](chapters/11-terrain.md#117-block-interaction)
    - [Ray Casting](chapters/11-terrain.md#ray-casting)
    - [Block Placement](chapters/11-terrain.md#block-placement)
    - [Instant Breaks](chapters/11-terrain.md#instant-breaks)
    - [Chunk Dirtying](chapters/11-terrain.md#chunk-dirtying)
    - [Block Breaking Progression](chapters/11-terrain.md#block-breaking-progression)
      - [Break Time](chapters/11-terrain.md#break-time)
      - [Per-Frame Accumulation](chapters/11-terrain.md#per-frame-accumulation)
      - [Crack Overlay Rendering](chapters/11-terrain.md#crack-overlay-rendering)
    - [Particle Emission](chapters/11-terrain.md#particle-emission)
      - [Chip Particles on Crack Stage Advance](chapters/11-terrain.md#chip-particles-on-crack-stage-advance)
      - [Break Particles on Destruction](chapters/11-terrain.md#break-particles-on-destruction)
    - [Particle Configuration](chapters/11-terrain.md#particle-configuration)
    - [Audio](chapters/11-terrain.md#audio)
      - [Surface-to-Sound Mapping](chapters/11-terrain.md#surface-to-sound-mapping)
      - [Dig Sound Playback](chapters/11-terrain.md#dig-sound-playback)
      - [Spatial Audio Pipeline](chapters/11-terrain.md#spatial-audio-pipeline)
      - [Audio Asset Inventory](chapters/11-terrain.md#audio-asset-inventory)
      - [Audio Initialization](chapters/11-terrain.md#audio-initialization)
  - [11.8 Illuminated Blocks and Point Lights](chapters/11-terrain.md#118-illuminated-blocks-and-point-lights)
    - [Emissive Blocks (G-Buffer)](chapters/11-terrain.md#emissive-blocks-g-buffer)
    - [Point Light Blocks](chapters/11-terrain.md#point-light-blocks)
    - [Flicker Animation](chapters/11-terrain.md#flicker-animation)
    - [GPU Light Loop](chapters/11-terrain.md#gpu-light-loop)
  - [11.9 Erosion Simulation](chapters/11-terrain.md#119-erosion-simulation)
  - [11.10 Water Propagation](chapters/11-terrain.md#1110-water-propagation)
    - [Flow Rules](chapters/11-terrain.md#flow-rules)
    - [Performance Optimizations](chapters/11-terrain.md#performance-optimizations)
  - [11.11 Water Rendering](chapters/11-terrain.md#1111-water-rendering)
  ...
  - [11.12 Screen-Space Reflections (SSR)](chapters/11-terrain.md#1112-screen-space-reflections-ssr)
  ...
  - [11.13 Village Generation](chapters/11-terrain.md#1113-village-generation)
  ...
  - [11.14 Summary](chapters/11-terrain.md#1114-summary)
